...
<form>
 <div style="background-color:white;">    
  ...
  <tr>
    <td width="20%"><img src="<%=contextPath%>/icons/complogo.jpg" width="140" height="100"  alt=""/></td>
    <td width="60%"><table width="100%" border="0">
      <tr>
        <td  align="center"><font size="2.5" style="color:#0086b3;">&nbsp;&nbsp;<b><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></b></font> </td>
      </tr>
      <tr>
        <td  align="center"><font size="2">النخيل لتركيب معدات الأمن والسلامة</font></td>
      </tr>
      <tr>
    ...
    <td width="20%"><table width="100%" border="0">
      ...
      <tr>
        <td><b>Location :</b>&nbsp;<label id="lbllocation" name="lbllocation" ><s:property value="lbllocation"/></label></td>
      </tr>
      <tr>
        <td><b>TRN :&nbsp;<label id="lbltrno" name="lbltrno"><s:property value="lbltrno"/></label></b></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr >
    ...
    <td colspan="2"><h1><b>Tax Invoice</b></h1></td>
  ...
  <tr>
   ...
   <tr> <td width="27%" rowspan="2"><b>&nbsp;&nbsp;&nbsp;<label id="lblcompaddress" style="color:#8b8878;" name="lblcompaddress"><s:property value="lblcompaddress"/></label></b></td>
    ...
    <tr>
    <td width="15%" align="center">&nbsp;&nbsp;<label id="l"  style="color:#8b8878;" name="l"><s:property value="l"/></label></td>
  ...
  <td></td>
  <td align="leftt" width="15%"><b> CREDIT INVOICE NUMBER </b></td>
    <td>&nbsp;:<label id="lblinvno" name="lblinvno"><s:property value="lblinvno"/></
  </tr>
  <tr>
