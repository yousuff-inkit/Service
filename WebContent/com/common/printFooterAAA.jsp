...
<div style="background-color:white;position:absolute;left:0;bottom:20px;z-index:5;width:100%;"> 
<table width="100%">

<tr><td width="100%" colspan="4"><img src="<%=contextPath%>/icons/aitsfooter1.jpg" width="100%" height="110" align="bottom"  alt=""/></td></tr>
