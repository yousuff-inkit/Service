...
<%-- <table width="100%" class="normaltable"  border="1">
  ...
  <tr >
    ...
    <font style="color:#73C7FA;">_________________________________________________________________________________________________</font></td>
    <td colspan="2"width="50%" align="center"><b><font size="3" Style="color:#8b8878;font-family:Helvetica; font-weight: 750;letter-spacing: 4px;"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font></b></td>
  </tr>
  <tr>
    <td width="10%" align="center"><font size="2.5" style="color:#73C7FA;">&nbsp;&nbsp;<b><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></b></font> </td>
    <td width="25%" rowspan="2"><b><label id="lblcompaddress" style="color:#8b8878;" name="lblcompaddress"><s:property value="lblcompaddress"/></label></b></td>
    <td width="30%" align="center">&nbsp;&nbsp;<label id="lblcompemail"  style="color:#8b8878;" name="lblcompemail"><s:property value="lblcompemail"/></label></td>
    <td width="26%" align="right"><b>DATE :</b></td>
    <td width="15%">&nbsp;<label id="lbldate" name="lbldate"><s:property value="lbldate"/></label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td style="color:#8b8878;" align="center">&nbsp;&nbsp;TRN NO :&nbsp;<label id="lblcmptrn_no" name="lblcmptrn_no"><s:property value="lblcmptrn_no"/></label></td>
