...
<%@page import="com.project.execution.ServiceSale3dcom.ClsServiceSaleDAO3d" %>



	
<%
		ClsServiceSaleDAO3d viewDAO=new ClsServiceSaleDAO3d();
                ...
                datafields: [
                        	...
                        	{name : 'deldate', type: 'date'   },
     						...
     						{name :'mobno',type:'String'},
      						...
      						{name : 'delnote', type: 'string'   },
      						{name : 'appdate', type: 'date'   },
									...
									{ text: 'delterm', datafield: 'delterm', width: '8%',hidden:true },
									 { text: 'payterm',  datafield: 'payterm', width: '5%' ,hidden:true},
										...
										{ text: 'Description', datafield: 'desc1', width: '25%' },
										 ...
										 { text: 'appno', datafield: 'appno', width: '5%',hidden:true },
										 { text: 'delnote', datafield: 'delnote', width: '5%',hidden:true },
										 { text: 'Date', datafield: 'appdate', width: '9%',cellsformat:'dd.MM.yyyy' ,hidden:true },
    ...
    $('#mainsearshgrid').on('rowdoubleclick', function (event) {
       var rowindex1 = event.args.rowindex;
             ...
             $('#deliverydate').val($("#mainsearshgrid").jqxGrid('getcellvalue', rowindex1, "deldate")) ;
                ...
                $('#appdate').val($("#mainsearshgrid").jqxGrid('getcellvalue', rowindex1, "appdate")) ;
                ...
                document.getElementById("appno").value = $('#mainsearshgrid').jqxGrid('getcellvalue', rowindex1, "appno");
                document.getElementById("delnote").value = $('#mainsearshgrid').jqxGrid('getcellvalue', rowindex1, "delnote");
