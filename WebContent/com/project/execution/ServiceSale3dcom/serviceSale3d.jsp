	...
	$(document).ready(function () {
	    ...
	    $("#appdate").jqxDateTimeInput({  width: '109px', height: '20px', formatString:"dd.MM.yyyy"});
 ...
 */			
			...
			function funSearchLoad(){
				...
				function funReadOnly(){
					...
					$('#appdate').jqxDateTimeInput({ disabled: true});
				...
				function funRemoveReadOnly(){         
					...
					$('#appdate').jqxDateTimeInput({ disabled: false});
					   ...
					   function setValues() {
						  /*  if(document.getElementById("interstate").checked=true){
						   ...
						   if($('#hidnipurchasedate').val()){
							...
							if($('#hidappdate').val()){
								$("#appdate").jqxDateTimeInput('val', $('#hidappdate').val());
							}
	...
	function funPrintBtn(){
	   var dtype=$('#formdetailcode').val();
		...
		if( url.indexOf('savesrvsale3d') >= 0){
			reurl=url.split("savesrvsale3d");
		}else {
			reurl=url.split("serviceSale3d.jsp");
		}
		if (($("#mode").val() == "view") && $("#masterdoc_no").val()!="" && $("#hidbnk").val()==1) {
			...
			var win= window.open(reurl[0]+"PRINTServiceSale3d?docno="+document.getElementById("masterdoc_no").value+"&brhid="+brhid+"&dtype="+dtype+"&header=1&bankdocno=0","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=yes,toolbar=yes");
			win.focus();
   ...
   function PrintContent(url) {
	...
	<form id="frmNipurchase" action="savesrvsale3d" method="post" autocomplete="off">
	...
	<!--  <td width="13%">&nbsp;</td> -->
	 ...
	 <td>&nbsp;<div id="interdiv" hidden="true"><input type="checkbox" name="interstate" id="interstate" value="interstate"  value='<s:property value="interstate"/>' onclick="$(this).attr('value', this.checked ? 1 : 0);" >Interstate</div></td>
	    <td align="right" colspan="5" width="5%" >Del Terms
	    <input type="text" name="delterms" id="delterms" value='<s:property value="delterms"/>' style="width:70%;"></td>
	 <td align="left"  colspan="3" width="5%">Delivery Note
	   <input type="text" name="delnote" id="delnote" value='<s:property value="delnote"/>' style="width:74%;"></td>  
	     
	  </tr> 
	  <tr>
	  <td align="right" width="4%" >App Date</td>
	  <td align="left" width="6%" ><div id="appdate" name="appdate" value='<s:property value="appdate"/>'></div>
	  <input type="hidden" name="hidappdate" id="hidappdate" value='<s:property value="hidappdate"/>'></td>
	  <td align="right" width="5%" >&nbsp;</td>
	  <td align="right"  colspan="5" width="5%">Pay Terms
	    <input type="text" name="payterms" id="payterms" value='<s:property value="payterms"/>' style="width:70%;"></td>
	  <td align="left"  colspan="3" width="5%">Pay Appln No
	    <input type="text" name="appno" id="appno" value='<s:property value="appno"/>' style="width:74%;"></td>  
	    </tr>
	    <tr>
