	...
	x.send();
 	...
 	function printlogo() {
 		if (($("#mode").val() == "view") && $("#masterdoc_no").val()!="") {
			...
			var win= window.open(reurl[0]+"PRINTServiceSale3d?docno="+document.getElementById("masterdoc_no").value+"&brhid="+brhid+"&dtype="+dtype+"&header="+header+"&bankdocno="+bankdocno,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=yes,toolbar=yes");
			win.focus();
		} 
		else {
