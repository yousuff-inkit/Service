    ...
    <form id="frmjobcontract" action="saveJobcontract" method="post" autocomplete="off">
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Job Contract Summary</span>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label id="lblfrmperiod" class="lbl-right" style="width:125px;">Warranty Period From</label>
                    <div style="width: 125px;">
                        <div id="wstdate" name="wstdate" value='<s:property value="wstdate" />'></div>
                    </div>
                    
                    <label id="lbltoperiod" class="lbl-right" style="width:40px; margin-left:15px;">To</label>
                    <div style="width: 125px;">
