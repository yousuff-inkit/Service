...
<% String contextPath=request.getContextPath();%>
 ...
 String enddate = request.getParameter("enddate")==null?"0":request.getParameter("enddate");  
   String amount1 = request.getParameter("amount")==null || request.getParameter("amount").equals("")?"0":request.getParameter("amount");
 String instno1 = request.getParameter("instno")==null || request.getParameter("instno").equals("")?"0":request.getParameter("instno");  
