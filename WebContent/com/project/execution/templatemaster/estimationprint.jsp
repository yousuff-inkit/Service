...
<table width="100%"  > 
  ...
  <td width="8%" align="right">Customer</td>
    <td width="30%" align="left" colspan="3">: <label id="customer" name="customer"><s:property value="customer"/></label> </td>
    ...
    <tr>
    <td></td>
    <td colspan="4"> <label id="customeraddress" name="customeraddress"><s:property value="customeraddress"/></label>
    </td> 
   ...
   <tr>
    ...
    <td align="left">: <label id="lbltype" name="lbltype"><s:property value="lbltype"/></label></td> 
    ...
    <tr>
        <td  align="right">Revision No</td>
    <td align="left">: <label id="revisionno" name="revisionno"><s:property value="revisionno"/></label></td> 
