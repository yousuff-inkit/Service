 	  ...
 	  function funPrint(id) {
				...
				var docno=$('#docno').val();
		  		...
		  		//alert("=reurl[0]==="+reurl[0]);
						  ...
						  var win= window.open(reurl[0]+"printQuotationnewtax11?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&id="+id+"&hedderstat="+hedderstat+"&header=1"+"&reviseno="+reviseno+"&totalstat="+totalstat,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
...
<table width="100%">
  <tr>
    ...
    <input type="hidden" id="hedderstat" name="hedderstat" value="1" /></td>
    
    </tr>
    <tr>
    <td align="right" width="50%"><input type="radio" id="rdbntotalshow" name="rdbntot" onchange="funtotshowcheck();" value="Show Total" checked="checked">With Total</td>
