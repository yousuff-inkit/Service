     ...
     var unitsearch= '<%=DAO.unitSearch(session) %>';
		$(document).ready(function () { 	
          ...
          $('#unitsearch').on('celldoubleclick', function (event) {
                ...
                if(checkid==1){
                	$('#amcGrid').jqxGrid('setcellvalue', uomrow, 'unit',$('#unitsearch').jqxGrid('getcellvalue', rowindex1, "unit"));
                    $('#amcGrid').jqxGrid('setcellvalue', uomrow, 'unitid',$('#unitsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
