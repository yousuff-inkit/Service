...
String Cl_names = request.getParameter("Cl_names")==null?"0":request.getParameter("Cl_names");
 ...
 String revisionno = request.getParameter("revisionno")==null?"0":request.getParameter("revisionno");   
%> 
 ...
 var searchdata;   
   ...
   searchdata='<%=DAO.searchMaster(session,msdocno,Cl_names,sereftype,surdate,cntrtype,id,Cl_site,Cl_area,Cl_amount,refno,revisionno)%>';
  ...
  $(document).ready(function () { 	
     ...
     $("#subsearch").jqxGrid(
     {
         ...
         columns: [
				...
				{ text: 'latestrevno', datafield: 'latestrevno', width: '10%',hidden:true },
     ...
     $('#subsearch').on('celldoubleclick', function (event) {
         ...
         document.getElementById("hidlatestrevno").value=$('#subsearch').jqxGrid('getcellvalue', rowindex1, "latestrevno");
         document.getElementById("txtnotes").value=$('#subsearch').jqxGrid('getcellvalue', rowindex1, "notes");  
