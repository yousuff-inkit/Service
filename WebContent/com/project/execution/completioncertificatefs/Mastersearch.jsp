...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
	  $("#invsdate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy",value:null}); 
	}); 

 	function invloadSearch1() {
 		
 		var invsdate=document.getElementById("invsdate").value;
	...
	getdata1(Cl_names,msdocno,contno,invsdate,invtype);
 

	}
	function getdata1(Cl_names,msdocno,contno,invsdate,invtype){
		
var id=1;
		
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&contno='+contno+'&invsdate='+invsdate+'&invtype='+invtype+'&id='+id);
...
<table width="100%" >
  ...
  <option value="SJOB">SJOB</option>
        ...
        <tr>
        <td>Date </td>
    <td align="left" ><div id="invsdate" name="invsdate"  value='<s:property value="invsdate"/>'></div>
