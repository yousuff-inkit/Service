...
<% 
 ...
 try{
	...
	if(insval>0){
		String str1Sql=("update cm_compcert set invtrno="+jvtrno+",pytval="+cval+", totinv="+ctotinv+", inv="+tobeinvoiced+", invdt='"+invdate+"',invdesc='"+invdescp+"', rententionamt="+retnamt+" where doc_no="+ccdocno+" ");
