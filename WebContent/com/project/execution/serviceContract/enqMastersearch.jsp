...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate,clientid,dtype,formcode){
		 ...
		 $("#refreshdivmas").load('enqsubMastersearch.jsp?Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&clientid='+clientid+'&dtype='+dtype+'&formcode='+formcode+'&id='+1);
