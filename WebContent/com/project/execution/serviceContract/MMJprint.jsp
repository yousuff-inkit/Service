...
<tr><td align="center" style="font-size:15px;"><b>MMJ Security and safety equipment fixing LLC.</</b></td></tr>

<tr ><td align="center" style="height:30px;">&nbsp;</td></tr>
<tr><td align="center" style="font-size:15px;"> U.A.E.</td></tr>


<tr ><td align="center" style="height:30px;">&nbsp;</td></tr>
<tr><td align="center" style="font-size:15px;">(Being the First party and herein after called MMJ Security and safety equipment fixing LLC)</td></tr>
...
<tr ><td align="center" style="height:50px;">&nbsp;</td></tr>
<tr><td align="center" style="font-size:15px;">MMJ Security and safety equipment fixing LLC Contract Ref no: F7Q<label name="contractrefno" id="contractrefno" ><s:property value="contractrefno"/></label>/<label name="contractdocno" id="contractdocno" ><s:property value="contractdocno"/></label> </td></tr>
</table>
...
<tr><td><b>MMJ Security and safety equipment fixing LLC</b> agrees to carry out periodic maintenance of the fire detection/ protection systems as per attached schedule. The equipment is owned by the client and already installed in the premises. The maintenance contract is subject to the following terms and conditions:-</td></tr>

<tr ><td align="center" style="height:30px;">&nbsp;</td></tr>
<tr><td><b><u>2. PERIODIC VISITS:</u></b></td></tr>

<tr><td><b>MMJ Security and safety equipment fixing LLC </b> Engineers will visit the above site and check the below mentioned devices and equipment’s:</td></tr>
...
<tr><td>When notified by the Client of a defect in the equipment/system, MMJ Security and safety equipment fixing LLC will arrange for the visit of technical team to investigate and remedy such defect.</td></tr>
...
<tr><td><b>MMJ Security and safety equipment fixing LLC</b> shall notify the Client the date and time of their visit to the site to enable the Client representative to be present in the site during the visit.  </td></tr>
...
<tr><td>Any fire incidents resulting from non-approval of mandatory rectification which leaves the site unprotected will not be the liability or responsibility of MMJ Security and safety equipment fixing LLC.
<br>
...
<tr>
<td align="center" style="font-size:15px;" width="50%">MMJ Security and safety equipment fixing LLC.</td> 
