...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		var id="1";
		getdata(productsname,brandsname,gridprdname,gridunit,gridscategory,gridssubcategory,id);
	}
	function getdata(productsname,brandsname,gridprdname,gridunit,gridscategory,gridssubcategory,id){
				 $("#refreshProductDiv").load('productSearch.jsp?productsname='+productsname.replace(/ /g, "%20")+'&brandsname='+brandsname.replace(/ /g, "%20")+"&id="+id+"&gridprdname="+gridprdname.replace(/ /g, "%20")+"&gridunit="+gridunit+"&gridcategory="+gridscategory.replace(/ /g, "%20")+"&gridssubcategory="+gridssubcategory.replace(/ /g, "%20"));
		}
