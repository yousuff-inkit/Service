...
<table width="100%">
  <tr>
    ...
    <td colspan="2">: <label id="txtclient" name="txtclient"><s:property value="txtclient"/></label></td>
  ...
  <tr>
    ...
    <td>: <label id="lblcltrnno" name="lblcltrnno" ><s:property value="lblcltrnno"/></label></td>
    <td width="16%"></td>
  ...
  <tr>
    ...
    <td colspan="2">: <label id="refno" name="refno" ><s:property value="refno"/></label>&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="left">Date </td>
    <td>: <label name="date" id="date" ><s:property value="date"/></label></td>
  </tr>
  <tr>
    <td align="left">Telephone No </td>
    <td colspan="2">: <label id="cltelno" name="cltelno" ><s:property value="cltelno"/></label></td>
  ...
  <tr>
    ...
    <td colspan="4">: <label name="txtclientdet" id="txtclientdet" ><s:property value="txtclientdet"/></label></td>
  </tr>
  <%-- <tr>
