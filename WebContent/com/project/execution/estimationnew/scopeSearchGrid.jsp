...
<script type="text/javascript">
     ...
     $(document).ready(function () { 	
          ...
          $('#scopeSearchGridId').on('rowdoubleclick', function (event) {
                ...
                $('#materialGrid').jqxGrid('setcellvalue', uomrow, 'scope',$('#scopeSearchGridId').jqxGrid('getcellvalue', rowindex1, "scode"));
                $('#materialGrid').jqxGrid('setcellvalue', uomrow, 'scopeid',$('#scopeSearchGridId').jqxGrid('getcellvalue', rowindex1, "doc_no"));
                $('#materialGrid').jqxGrid('setcellvalue', uomrow, 'scopeproduct',$('#scopeSearchGridId').jqxGrid('getcellvalue', rowindex1, "product"));
