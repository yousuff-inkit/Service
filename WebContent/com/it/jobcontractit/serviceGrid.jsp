...
<% String contextPath=request.getContextPath();%>
 ...
 <%--    if(gridload=="2" && trno>0){
    	servdata = '<%=DAO.serLabGridLoad(session,trno) %>';
         ...
         var num = 0; 
            ...
            $("#serviceGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Service.Type', datafield: 'stype', width: '16%',editable:false,hidden:true },
					{ text: 'stypeid', datafield: 'stypeid', width: '10%',hidden:true},
					{text: 'Description',datafield:'desc1'},
					{ text: 'Remarks', datafield: 'item', width: '27%'},
