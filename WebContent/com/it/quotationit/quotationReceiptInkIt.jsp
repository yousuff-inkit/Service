...
<table width="100%" style="border-collapse:collapse;">
 ...
 <tr Style="background-color:#d8d8d8">
    <td align="center" style="width:7%;"><strong>SI No</strong></td>
    ...
    <td align="right" style="width:5%;"><strong>Qty</strong></td> 
     <td align="right" style="width:5%;"><strong>Unit Price</strong></td>
    <td align="right" style="width:5%;"><strong>Total</strong></td> 
    <td align="right" style="width:10%;"><strong>Mark Up %</strong></td> 
    <td align="right" style="width:10%;"><strong>Value</strong></td>
    <td align="right" style="width:10%;"><strong>Total Amount</strong></td>
  </tr>
  <s:set var="temp" value="1"></s:set>
  

 
 <s:iterator var="stat1" status="arr" value='#request.QOTLISTINKIT' >
