				...
				var docno=$('#docno').val();
		  		...
		  		if(cmprhnstat==""){
		  			...
		  			return false;
						  ...
						  var win= window.open(reurl[0]+"printQuotationnewtaxstar?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&id="+id+"&hedderstat="+hedderstat+"&header=1"+"&reviseno="+reviseno+"&totalstat="+totalstat+"&brandstat="+brandstat+"&cmprhnstat="+cmprhnstat,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
						  win.focus();  
...
<table width="100%">
  <tr>
	...
	<tr>
		 ...
		 <td align="center"  ><input type="button" name="btnvoucherhead1" id="btnamcamt" class="myButton" value="Print(With UnitPrice)"  onclick="funPrint(1);"></td>
