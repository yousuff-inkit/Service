 	  ...
 	  function funPrint(id) {
				...
				//var slcval=$('#cmbfreq').val();
		  		...
		  		//alert("unitprice"+unitpricestat);
						  ...
						  var win= window.open(reurl[0]+"printQuotationnewtaxstar?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&id="+id+"&hedderstat="+hedderstat+"&header=1"+"&reviseno="+reviseno+"&totalstat="+totalstat+"&brandstat="+brandstat+"&freq="+cmbfreq,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
