...
<script type="text/javascript">
	...
	function loadServicesSearchGrid() {
			...
			getServicesDetails(services,items,contractno,contractType,check);
	}
		
	function getServicesDetails(services,items,contractno,contractType,check) {
		 $("#refreshCallRegisterServiceSearchDetailsDiv").load("callRegisterServiceSearchGrid.jsp?services="+services.replace(/ /g, "%20")+'&items='+items.replace(/ /g, "%20")+'&contractno='+contractno+'&contractType='+contractType+'&check='+check);
	}
