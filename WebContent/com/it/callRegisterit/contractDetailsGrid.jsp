...
<script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            $("#contractDetailsGridID").jqxGrid(
            {
                ...
                columns: [
						  { text: 'No.', sortable: false, filterable: false, editable: false,
							...
							{ text: 'Ref. TRNo.', datafield: 'costid', hidden: true, width: '%' },
            ...
            $('#contractDetailsGridID').on('rowdoubleclick', function (event) {
	              ...
	              $("#callRegisterPendingDiv").load("callRegisterPendingGrid.jsp?contractno="+$('#contractDetailsGridID').jqxGrid('getcellvalue', rowindex1, "costid")+"&contracttype="+$("#cmbcontracttype").val());
					
	              
	              $('#txtsite').val('');$('#txtsiteid').val('0');
