...
<h1 ALIGN="center"><u>JOB SHEET CREG</u></h1>
...
<table align="center" width="85%" border="3" cellpadding="5"  >
         ...
         <td width="38%">&nbsp;<label id="lbldtype" name="lbldtype" ><s:property value="lbldtype"/></label></td>
         ...
         <td width="38%">&nbsp;<label id="lblarea" name="lblarea" ><s:property value="lblarea"/></label></td>
...
<table id="client" width="85%" class="tablereceipt" align="center">
  ...
  <tr height="28" style="background-color: #D8D8D8;" class="tablereceipt" align="center">
   ...
   <!--  <th class="tablereceipt" width="9%" align="left">Site</th> -->
    <th class="tablereceipt" width="53%" align="left">Complaint</th>
   <!--  <th class="tablereceipt" width="15%" align="left">Remarks</th>
    <th class="tablereceipt" width="9%" align="left">Quantity</th> -->
     <th class="tablereceipt" width="35%" align="left">Description</th>
...
<tbody>
  <%int l=0; %>
  <s:iterator var="stat" value='#request.creggrid' >
  <%l=l+1;%>
...
<tr><br>
<td width="15%"  align="left"  class="tablereceipt" style="padding-bottom:15px;padding-top:15px;"><b>Invoice Details</b></td>
...
<tr>
<td colspan="4" class="tablereceipt"  align="left" style="padding-bottom:25px;"><b>Remarks</b></td>
</tr>
</table>
<br>
