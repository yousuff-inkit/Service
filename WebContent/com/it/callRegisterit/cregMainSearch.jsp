...
<table width="100%">
  ...
  <tr>
    ...
    <td><select id="cmbcontractstype" name="cmbcontractstype" style="width:71%;" value='<s:property value="cmbcontractstype"/>'>
      <option value=''>-- Select --</option><option value='AMC'>AMC</option><option value='SJOB'>SJOB</option><option value='STC'>STC</option></select></td><td width="7%" align="right">Contract</td>
