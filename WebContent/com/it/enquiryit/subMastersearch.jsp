  ...
  $(document).ready(function () { 	
     ...
     $("#subEnqirySearch").jqxGrid(
     {
         ...
         columns: [
				...
				{ text: 'Cldocno', datafield: 'cldocno', width: '20%' },
     ...
     $('#subEnqirySearch').on('rowdoubleclick', function (event) 
       ...
       $('#EnquiryDate').val($("#subEnqirySearch").jqxGrid('getcellvalue', rowindex1, "date")) ;
            ...
            //  var rdo=document.getElementById("hidradio").value;
              ...
              document.getElementById("cmbsertype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "servicetype");
              document.getElementById("hidcmbsertype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "sertypeid");
              document.getElementById("cmbenqbtype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "industry");
              document.getElementById("hidcmbenqbtype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "enqbtypeid");
              document.getElementById("cmbtype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "typess");
              document.getElementById("hidcmbcurrency").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "curid");
              getCurrencyIds();
         ...
         //document.getElementById("frmEnquiryfrn").submit();
