...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
	 ...
	 var Cl_site1=document.getElementById("cl_site").value;
 		 ...
 		 var cntrtype="";
 		var Cl_site = Cl_site1;
 		var Cl_area = Cl_area1;
	...
	function getdata1(Cl_names,msdocno,Cl_mobno,enqdate,enqtype,Cl_site,Cl_area,cntrtype){
		 ...
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+Cl_names.replace(/ /g, "%20")+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno.replace(/ /g, "%20")+'&enqdate='+enqdate+'&enqtype='+enqtype+'&cntrtype='+cntrtype+'&Cl_site='+Cl_site.replace(/ /g, "%20")+'&Cl_area='+Cl_area.replace(/ /g, "%20"));
