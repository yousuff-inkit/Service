...
<script type="text/javascript">
        ...
        $(document).ready(function () { 	
            ...
            $('#jqxspecDetGrid').on('rowdoubleclick', function (event) { 
        	    ...
        	    $('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "comodityid",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "doc_no"));
        		$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "services",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "service"));
				$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "discipline",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "discipline"));
				$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "commodity",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "comodity"));
				$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "tradeid",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "tradeid"));
				$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "serviceid",$('#jqxspecDetGrid').jqxGrid('getcellvalue', rowindex1, "serid"));
