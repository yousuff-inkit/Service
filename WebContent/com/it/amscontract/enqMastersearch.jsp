...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	getdata1(brcid,Cl_names,msdocno,Cl_mobno,enqdate,clientid,reftype1);
 
 // alert(Cl_names+"===="+msdocno+"===="+Cl_mobno+"===="+enqdate+"===="+clientid+"===="+cntype+"===="+reftype1);
	}
	function getdata1(brcid,Cl_names,msdocno,Cl_mobno,enqdate,clientid,cntype,reftype1){
		
			var id=1;
	// 	alert(id);
	$("#refreshdivmas").load('enqsubMastersearch.jsp?brcid='+brcid+'&Cl_names='+Cl_names+'&msdocno='+msdocno+'&Cl_mobno='+Cl_mobno+'&enqdate='+enqdate+'&clientid='+clientid+'&id='+id+'&reftype='+reftype1);
