         ...
         //	var url1;
          ...
          /*   $("#Jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#Jqxclientsearch').on('rowdoubleclick', function (event) 
				                ...
				                document.getElementById("txtclientname").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
				                document.getElementById("txtclientdet").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "refname");
				                ...
				                document.getElementById("txtsalesman").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "salname");
				                document.getElementById("txtsalesmandocno").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "salid");
							    $('#cmbcurr').val($('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "curid"));
				                funrate();
				                getTaxper(); 
