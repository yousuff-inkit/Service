 ...
 areadata='<%=DAO.areaSearch(session)%>';
        ...
        $(document).ready(function () { 
			...
			$('#jqxareasearch').on('rowdoubleclick', function (event) { 
				...
				$('#jqxcontractDetails').jqxGrid('setcellvalue', rowIndex, "area",$('#jqxareasearch').jqxGrid('getcellvalue', rowindex1, "area"));
				$('#jqxcontractDetails').jqxGrid('setcellvalue', rowIndex, "areaid",$('#jqxareasearch').jqxGrid('getcellvalue', rowindex1, "areadocno"));
