            ...
            //$("#jqxsteamsearch").jqxGrid('addrow', null, {});
				           ...
				           $('#jqxsteamsearch').on('rowdoubleclick', function (event) 
				              	...
				              	var rowindex1=event.args.rowindex;
				               			...
				               			$('#jqxcontractDetails').jqxGrid('setcellvalue', rowIndex, "serviceteam",$('#jqxsteamsearch').jqxGrid('getcellvalue', rowindex1, "team"));
				               			$('#jqxcontractDetails').jqxGrid('setcellvalue', rowIndex, "steamid",$('#jqxsteamsearch').jqxGrid('getcellvalue', rowindex1, "docno"));
