        ...
        $(document).ready(function () { 
            ...
            $("#jqxmainsearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'pholiday', datafield: 'pholiday',hidden:true },
            ...
            //$("#jqxmainsearch").jqxGrid('addrow', null, {});
		          ...
		          $('#jqxmainsearch').on('rowdoubleclick', function (event) { 
		                 ...
		                 document.getElementById("cmbpholiday").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "pholiday");
		                 document.getElementById("txttaxper").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "taxper");
		                 
		             	var indexVal1 = document.getElementById("masterdoc_no").value;
			       		$("#contractDiv").load('staffingContractGrid.jsp?docno='+indexVal1);
			       		funchkforedit();
