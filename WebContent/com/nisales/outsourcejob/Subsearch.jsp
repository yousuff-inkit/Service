...
var datamain= '<%=ClsCuttingOrderDAO.mainsearch(session,docnoss,accountss,accnamess,datess,aa,descriptions,refnoss,slpono) %>'; 
            ...
            var source =
            {
                ...
                datafields: [
                            ...
                            {name : 'date', type: 'date'   },
     						...
     						{name : 'totqty', type: 'string'   },
     						
     						{name : 'totsize', type: 'string'   },
            ...
            $("#mainsearshgrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Account', datafield: 'account', width: '8%' },
								...
								{ text: 'Total Square Meter', datafield: 'totsize', width: '23%' },
								{ text: 'Total Quantity', datafield: 'totqty', width: '23%' },
						]
            });
        ...
        /* 	 document.getElementById("totqty").value = $('#mainsearshgrid').jqxGrid('getcellvalue',rowindex1, "totqty");
        	 document.getElementById("totsqm").value = $('#mainsearshgrid').jqxGrid('getcellvalue',rowindex1, "totsize");
 */
              $('#window').jqxWindow('close');  
         	 
        	 funSetlabel();
        	  document.getElementById("frmoutsourcejob").submit();
            }); 
