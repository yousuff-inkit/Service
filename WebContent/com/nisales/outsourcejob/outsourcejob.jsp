...
<meta charset="utf-8">
 ...
 $(document).ready(function () {
	 $("#btnCancel").attr('disabled', true ); $("#btnGuideLine").attr('disabled', true );  $("#btnSendmail").attr('disabled', true ); $("#btnClose").attr('disabled', true );$("#btnApproval").attr('disabled', true );
	 		 $("#btnAttach").attr('disabled', true );  $("#btnSave").attr('disabled', false );  $("#btnCreate").attr('disabled', true );
	 $("#btnEdit").attr('disabled', false );	 $("#btnExcel").attr('disabled', true );		 $("#btnDelete").attr('disabled', true );
...
function getsal(event){
 ...
 function funReadOnly(){  
 	 ...
 	 $('#frmoutsourcejob input').attr('readonly', true );
		 
		$('#frmoutsourcejob select').attr('disabled', true);
 ...
 function funRemoveReadOnly(){
	 ...
	 $('#frmoutsourcejob input').attr('readonly', false );
	 
		$('#frmoutsourcejob select').attr('disabled', false);
		...
		$("#fixDate").jqxDateTimeInput({ disabled: false});
		 ...
		 $('#totsqm').attr('readonly', true );
		 $('#totqty').attr('readonly', true );
	 ...
	 var rows = $("#cuttingOrderGridID").jqxGrid('getrows');
	   ...
	   // var myvar = rows[i].tarif; 
	    ...
	    newTextBox.val(rows[i].psrno+"::"+rows[i].unitdocno+" :: "+rows[i].specid+" :: "+rows[i].floor+" :: "
	    		...
	    		+rows[i].polcharge+"::"+rows[i].temp+" :: "+rows[i].amount+" :: "+rows[i].productname+" :: "+rows[i].customername+" :: "+rows[i].cordoc+" :: "+rows[i].corserial+" :: ");  
...
<form id="frmoutsourcejob" action="saveoutj" autocomplete="OFF" method="post" > 
...
<table width="100%"   >
<tr><td width="9%" align="right">Total Square Meter</td>
    <td width="14%"><input type="text" name="totsqm" id="totsqm" tabindex="-1" value='<s:property value="totsqm"/>'></td> 
    <td width="9%" align="right">Total Quantity</td>
    <td width="14%"><input type="text" name="totqty" id="totqty" tabindex="-1" value='<s:property value="totqty"/>'></td> 
