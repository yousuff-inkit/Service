...
<table width="100%" class="normaltable"  >
  ...
  <tr>
   ...
   <tr>
    <td rowspan="2" align="center"><b><font size="5"><label id="lblprintname1" name="lblprintname1"><s:property value="lblprintname1"/>DELIVERY NOTE</label></font></b></td>
...
<fieldset>  
  <table width="100%" border="0" cellpadding="4">
    <tr>
      <td width="30%" align="left" style="font-size: 13px;"><strong>DN NO</strong></td> 
      <td width="70%" style="font-size: 13px;">: <label id="lbldocNO" name="lbldocNO"><s:property value="lbldocNO"/></td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="30%" align="left"><strong>Order NO</strong></td> 
