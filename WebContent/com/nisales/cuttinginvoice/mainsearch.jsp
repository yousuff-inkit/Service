...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () { 
 	...
 	function loadSearchs() {
 		...
 		var slpono=document.getElementById("slpono").value.replace(/ +(?= )/g,'');
 		
	var aa="yes";
		getdata(docnoss,accountss,accnamess,datess,aa,descriptionss,refnoss,slpono);
 

	}
	function getdata(docnoss,accountss,accnamess,datess,aa,descriptionss,refnoss,slpono){
		
		 $("#refreshdivs").load('Subsearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&aa='+aa+'&descriptions='+descriptionss+'&refnoss='+refnoss+'&slpono='+slpono);
  ...
  <tr >
   ...
   <td align="right"  width="14%">Account Name</td>
    ...
    <td align="left"   ><input type="text" name="refnoss" style="width:100%;" id="refnoss" value='<s:property value="refnoss"/>'></td>
      ...
      <td align="right" width="10%">Remarks</td><td  width="30%" colspan="4"><input type="text" name="descriptionss" style="width:90%;" id="descriptionss" value='<s:property value="descriptionss"/>'></td>
    ...
    <tr>
       ...
       <td align="right"  width="14%">LPO NO</td>
    <td align="left" colspan="2" width="30%"><input type="text" name="slpono" style="width:60%;" id="slpono" value='<s:property value="slpono"/>'></td>
