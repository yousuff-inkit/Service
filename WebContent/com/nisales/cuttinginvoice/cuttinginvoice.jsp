...
<form id="frmsave" action="saveinvs" autocomplete="OFF" method="post" > 
...
<td align="center">  <select  id="sqm" onchange="calculatedata();"><option>--select--</option><option>YES</option><option>NO</option></select></td>
 ...
 <tr>
 <td>   <input type="text" id="price"    onblur="funRoundAmt1(this.value,this.id);" onkeypress="javascript:return isNumber1 (event);"  onchange="calculatedata();" style="text-align: right;"></td>
  <td align="center">   <select  type="text" id="bcode"   ></select></td>
 <td>   <input type="text" id="brate"   onblur="funRoundAmt1(this.value,this.id);" onkeypress="javascript:return isNumber1 (event);"  onchange="calculatedata();"  style="text-align: right;"  ></td>
<td>   <input type="text" id="bvalue" tabindex="-1" onblur="funRoundAm1t(this.value,this.id);" onkeypress="javascript:return isNumber1 (event);"    style="text-align: right;"  ></td>
<td align="center">  <select  type="text" id="pcode"   ></select>
<td>   <input type="text" id="prate"   onblur="funRoundAmt1(this.value,this.id);" onkeypress="javascript:return isNumber1 (event);"  onchange="calculatedata();" style="text-align: right;" ></td>
<td>   <input type="text" id="pcharge" tabindex="-1" onblur="funRoundAmt1(this.value,this.id);" onkeypress="javascript:return isNumber1 (event);"  style="text-align: right;"   ></td>
