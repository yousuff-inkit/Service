...
<table width="100%" class="normaltable"  >
  ...
  <tr>
   ...
   <tr>
    <td rowspan="2" align="center"><b><font size="5"><label id="lblprintname1" name="lblprintname1"><s:property value="lblprintname1"/>CUTTING ORDER</label></font></b></td>
...
<fieldset>
  <table width="100%"   cellpadding="2" >
    <tr>
      <td width="15%" align="left" style="font-size: 13px;"><strong>Buyer</strong></td>
      <td colspan="3" style="font-size: 13px;">: <label id="lblBuye" name="lblBuye"><s:property value="lblBuye"/></td>
    </tr> 
   <tr>
...
<fieldset>  
  <table width="100%" border="0" cellpadding="3">
    <tr>
      <td width="30%" align="left" style="font-size: 13px;"><strong>Order NO</strong></td> 
      <td width="70%" style="font-size: 13px;">: <label id="lblOrderNO" name="lblOrderNO"><s:property value="lblOrderNO"/></td>
    </tr>
    <tr>
...
<div>
  ...
  <tr>
    ...
    <th width="15%" align="left">Bevelling Code</th>
    <th width="15%" align="left">Polishing Code</th>
  </tr>
...
<table width="100%" border="1" style="border-collapse: collapse; page-break-inside: avoid;" cellpadding="5">
  <tr>
