...
String name=request.getParameter("name")==null?"0":request.getParameter("name");%>
   ...
   <script type="text/javascript">
        ...
        $(document).ready(function () { 	
        	var master='<%=ClsCuttingOrderDAO.searchcode("2") %>'; 
            ...
            $("#pcodesearchgrid").on('celldoubleclick', function (event) 
         	 ...
         	 var rowno =  document.getElementById("rowindex").value;
    		   ...
    		   $('#cuttingOrderGridID').jqxGrid('setcellvalue', rowno, "polcodename" ,$('#pcodesearchgrid').jqxGrid('getcellvalue', rowindextemp, "code"));
               $('#cuttingOrderGridID').jqxGrid('setcellvalue', rowno, "polcode" ,$('#pcodesearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
