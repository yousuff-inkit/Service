...
/* Custom UI Buttons & Icons matching 24px height */
.modern-ui .myButton {
    height: 24px !important;
...
.modern-ui .icon img { max-width: 14px; max-height: 14px; }
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#btnEdit').attr('disabled', true );$('#btnPrint').attr('disabled', true );
        $('#btnDelete').attr('disabled', true );$('#btnAttach').attr('disabled', true );
        
        /* Modern 24px configuration for DateTimeInput */
        ...
        setTimeout(function () {
            ...
            $("#jqxFixedAssetDepreciationPostingDate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
        }, 0);
    });
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <div style="margin-left:auto; display:flex; gap:5px; align-items:center;">
                ...
                <input type="text" id="docno" name="txtjvno" style="width:125px;" value='<s:property value="txtjvno"/>' tabindex="-1" readonly/>
            </div>
        </div>
    </div>

    <!-- Asset Details Grid Panel -->
    <div class="middle-panel">
