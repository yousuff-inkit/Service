...
$(document).ready(function() {
    ...
    $('#clientwindow').jqxWindow($.extend({}, popupConfig, {width: '50%', height: '58%',  maxHeight: '53%' ,maxWidth: '50%' , title: 'Client Search' ,position: { x: 250, y: 60 }})).jqxWindow('close');
    $('#assetwindow').jqxWindow($.extend({}, popupConfig, {width: '30%', height: '58%',  maxHeight: '58%' ,maxWidth: '50%' , title: 'Asset Search' ,position: { x: 250, y: 60 }})).jqxWindow('close');
    
    /* Configured for modern UI 24px height */
    $("#date, #fromdate, #todate").jqxDateTimeInput({ width: '125px', height: 24, formatString: "dd.MM.yyyy", theme: 'energyblue' });
    setTimeout(function () {
        $("#date, #fromdate, #todate").find("input").css({
            "margin-top": "0px", "line-height": "24px", "font-size": "12px", 
            "font-family": "Arial, sans-serif", "padding": "0 6px", "box-sizing":"border-box"
        });
        $("#date, #fromdate, #todate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
    }, 0);
...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Asset Sales Details</span>
        ...
        <div class="field-row">
            ...
            <input type="text" name="vocno" id="vocno" value='<s:property value="vocno"/>' tabindex="-1" style="width:125px;" readonly />
        </div>

        <div class="field-row">
            <label class="lbl-right" style="width:80px;">Client</label>
            <div class="input-search-container" style="width:125px;">
                <input type="text" name="client" id="client" value='<s:property value="client"/>' placeholder="Press F3" onkeydown="getClient(event);" readonly />
    ...
    <div class="middle-panel" style="padding-bottom:10px;">
        ...
        <div id="assetInvoicediv" class="grid-container" style="border:none; margin:0;">
