...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" name="fgmcode" id="fgmcode" placeholder="Group Code" value='<s:property value="fgmcode"/>' style="width:125px;" />

            <label class="lbl-right" style="width:80px;">Name</label>
            <input type="text" name="fgmname" id="fgmname" placeholder="Group Name" value='<s:property value="fgmname"/>' style="flex:1;" />
        </div>
    </div>

    <!-- Grid Data Panel -->
    <div class="middle-panel" style="padding-bottom:10px;">
        <span class="middle-panel-title">Group List</span>
        <div id="grpgrid" class="grid-container" style="border:none; margin:0;">
