...
$(document).ready(function () {     
    ...
    setTimeout(function () {
        ...
        $("#flmdate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
    }, 0);
...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" id="docno" name="docno" value='<s:property value="docno"/>' readonly tabindex="-1" style="width:125px;" />
        </div>

        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:80px;">Code</label>
            <input type="text" name="flmcode" id="flmcode" placeholder="Location Code" value='<s:property value="flmcode"/>' style="width:125px;" />

            <label class="lbl-right" style="width:80px;">Name</label>
            <input type="text" name="flmname" id="flmname" placeholder="Location Name" value='<s:property value="flmname"/>' style="flex:1;" />
        </div>
    </div>

    <!-- Grid Data Panel -->
    <div class="middle-panel" style="padding-bottom:10px;">
        <span class="middle-panel-title">Location List</span>
        <div id="locgrid" class="grid-container" style="border:none; margin:0;">
