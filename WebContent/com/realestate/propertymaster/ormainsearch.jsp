...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () { 
 	...
 	function loadSearchs() {
 		...
 		var accountss=document.getElementById("accountss").value.replace(' ', '%20');
	...
	function getdata(docnoss,accountss,accnamess,datess,aa,descriptionss,refnoss){
		 ...
		 $("#refreshdivs1").load('oSubsearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&aa='+aa+'&descriptions='+descriptionss+'&refnoss='+refnoss);
...
<table width="100%" >
  <tr >
   ...
   <td align="right"  width="14%">Address</td>
