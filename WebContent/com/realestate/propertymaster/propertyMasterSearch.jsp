...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(docnoss,accountss,accnamess,datess,aa,descriptionss,refnoss){
		 ...
		 $("#refreshdivs11").load('Subsearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&aa='+aa+'&descriptions='+descriptionss+'&refnoss='+refnoss);
