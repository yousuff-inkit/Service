			...
			<table>
				<tr>
					<td><input type="button" name="btntype" class="myButton"
						value="Building"  style="width: 100px;"
						onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/realestate/propertyrelated/propertyrelatedmaster/building.jsp"'></td>
				</tr>
 			<tr>
					<td><input type="button" name="btnbrand" class="myButton"
						value="Property Type" style="width: 100px;"
						onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/realestate/propertyrelated/propertyrelatedmaster/typeMaster.jsp"'></td>
				</tr>
			 		...
			 		<tr>
					<td><input type="button" name="btnbrand" class="myButton"
						value="Unit Type" style="width: 100px;"
						onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/realestate/propertyrelated/propertyrelatedmaster/unittype.jsp"'></td>
				</tr>
