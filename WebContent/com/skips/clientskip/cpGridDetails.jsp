...
// $('#accountWindow').jqxWindow('focus');
       depSearchContent('department.jsp?rowBoundIndex='+rowBoundIndex);
	
    	 }
     	 
function depSearchContent(url) {
	 
	 $.get(url).done(function (data) {
			 //alert(data);
	$('#depinfowindow').jqxWindow('setContent', data);
     ...
     $(document).ready(function () { 	
            ...
            $("#cpDetailsGrid").jqxGrid(
            {
                ...
                columns: [
						...
						{ text: 'Designation',  datafield: 'activity', editable:false,renderer: columnsrenderer,cellsalign: 'center',align: 'center',cellclassname:'column'},
