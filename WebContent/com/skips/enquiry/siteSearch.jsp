 ...
 var gridtextbox='<%=gridtextbox%>';
        $(document).ready(function () { 
			...
			$('#jqxsitesearch').on('rowdoubleclick', function (event)  { 
				              	...
				              	$('#jqxEnquiry').jqxGrid('setcellvalue', rowIndex, "siteid",$('#jqxsitesearch').jqxGrid('getcellvalue', rowindex1, "docno"));
				              	$('#jqxEnquiry').jqxGrid('setcellvalue', rowIndex, "site",$('#jqxsitesearch').jqxGrid('getcellvalue', rowindex1, "site"));
