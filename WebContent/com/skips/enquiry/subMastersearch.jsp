  ...
  $(document).ready(function () { 	
     ...
     var source =
     {
         ...
         datafields: [
                    ...
                    {name : 'enqbtypeid' , type: 'String'},
                    {name : 'sertypeid' , type: 'String'},
                    {name : 'desc1' , type: 'String'},
                    {name : 'grpname', type: 'String'},
                    {name : 'ay_name', type: 'String'},
                    {name : 'activityid', type: 'String'},
                    {name : 'grpcmpid', type: 'String'},
                   	],
     ...
     $("#subEnqirySearch").jqxGrid(
     {
         ...
         columns: [
				...
				{ text: 'Address', datafield: 'com_add1' },
				{ text: 'Email', datafield: 'email', width: '20%',hidden:true },
				{ text: 'Contact PersonID', datafield: 'cpersonid', width: '20%',hidden:true },
				{ text: 'Contact Person', datafield: 'cperson', width: '20%',hidden:true },
				{ text: 'Sal ID', datafield: 'sal_id', width: '20%',hidden:true },
				{ text: 'Salesman', datafield: 'sal_name', width: '20%',hidden:true },
				{ text: 'MOB', datafield: 'mob', width: '10%' },
				{ text: 'Contract Type', datafield: 'contrmode', width: '10%',hidden:true},
				{ text: 'Site', datafield: 'site', width: '10%' },
				{ text: 'Area', datafield: 'area', width: '10%',hidden:true },
				...
				{ text: 'surveyed', datafield: 'surveyed', width: '5%',hidden:true},
				{ text: 'enqstatus', datafield: 'enqstatus', width: '20%',hidden:true },
				{ text: 'qtype', datafield: 'qtype', width: '20%',hidden:true },
				{ text: 'enqbtypeid', datafield: 'enqbtypeid', width: '20%',hidden:true },
				{ text: 'sertypeid', datafield: 'sertypeid', width: '20%',hidden:true },
				{ text: 'Description', datafield: 'desc1', width: '20%',hidden:true },
				{ text: 'Group name', datafield: 'grpname', width: '20%'},
				{ text: 'Designation', datafield: 'ay_name', width: '20%',hidden:true },
				{ text: 'Desig Id', datafield: 'activityid', width: '20%',hidden:true },
				{ text: 'grpcmpid', datafield: 'grpcmpid', width: '20%',hidden:true },
				]
     });
     ...
     $('#subEnqirySearch').on('rowdoubleclick', function (event) 
       ...
       $('#EnquiryDate').val($("#subEnqirySearch").jqxGrid('getcellvalue', rowindex1, "date")) ;
              ...
              //document.getElementById("hidcmbques").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "qtype");
              document.getElementById("hidcmbenqbtype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "enqbtypeid");
              ...
              document.getElementById("txtdesc").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "desc1");
              document.getElementById("grpcmp").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "grpname");
              document.getElementById("txtdesig").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "ay_name");
              document.getElementById("activityid").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "activityid");
              document.getElementById("hidgrpcmpid").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "grpcmpid");  

              var chkcldoc=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
              ...
              document.getElementById("hidcmbsertype").value= $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "sertypeid");
              getenqbuildtype();
             // getServiceType();
              
              var indexVal2 = $('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
