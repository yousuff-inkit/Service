			  ...
			  var clientid=$("#txtcldocno").val();
			   ...
			   if($("#mode").val() == "A" || $("#mode").val() == "E") {
				  ...
				  /*  if($("#cmbcontracttype").val()==''){
				   ...
				   contractSearchContent("contractDetailsSearch.jsp?chk=yes"+"&clientid="+clientid);
			   }
		   }); 
		  $('#txtclientid').dblclick(function(){
			  var date = $('#jqxRentalReceiptDate').val();
...
function getContractDetails(event){
        ...
        if(x==114){
	          ...
	          /*  if($("#cmbcontracttype").val()==''){
			   ...
			   contractSearchContent("contractDetailsSearch.jsp?docno="+document.getElementById("cmbcontracttype").value+"&clientid="+clientid);
        } else{ }
        }
...
<table width="100%">
  ...
  <tr>
    ...
    <option value="1">On Account</option><option value="2">Advance</option><option value="3">Skip Security</option><option value="4">Tripping Security</option></select>
