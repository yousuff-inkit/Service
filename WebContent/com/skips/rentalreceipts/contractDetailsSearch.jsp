...
<% String docnoss=request.getParameter("chk")==null?"0":request.getParameter("chk"); 
...
<script type="text/javascript">
	...
	$(document).ready(function () {});   
  	...
  	function loadContractSearch() {
  		var docss='<%=docnoss%>';
  		var cldocno='<%=clientid%>';
  		//alert("docss=="+docss);
  		//var contracttype=document.getElementById("cmbcontracttype").value;
  		
  		var customerdocno=document.getElementById("txtcldocno").value;
 		...
 		var search=docss;
		getdatas(search,cldocno);
	}
  	
	function getdatas(search,cldocno){

		$("#refContractSearchDiv").load("contractDetailsSearchGrid.jsp?search="+search+"&clientid="+cldocno);
		//$("#refContractSearchDiv").load("contractDetailsSearchGrid.jsp?contracttype="+contracttype);
	}  
