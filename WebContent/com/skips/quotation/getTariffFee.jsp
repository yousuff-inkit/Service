...
<% 
 String skipsize =request.getParameter("skipsize")==null?"0":request.getParameter("skipsize").toString(); 
 String wastetype =request.getParameter("wastetype")==null?"0":request.getParameter("wastetype").toString(); 
