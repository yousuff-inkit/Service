            ...
            //$("#jqxwastesearch").jqxGrid('addrow', null, {});
			          ...
			          $('#jqxwastesearch').on('rowdoubleclick', function (event) 
				              	...
				              	var rowindex1=event.args.rowindex;
				               			$('#jqxQuote').jqxGrid('setcellvalue', rowIndex, "wastetype",$('#jqxwastesearch').jqxGrid('getcellvalue', rowindex1, "wastetype"));
				               			$('#jqxQuote').jqxGrid('setcellvalue', rowIndex, "wastedoc",$('#jqxwastesearch').jqxGrid('getcellvalue', rowindex1, "wastedoc"));
				               			var wastedoc= $('#jqxwastesearch').jqxGrid('getcellvalue', rowindex1, "wastedoc");  
