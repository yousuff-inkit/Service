   ...
   // alert(data);
        $(document).ready(function () { 	
           ...
           $('#jqxSalagentsearch').on('rowdoubleclick', function (event) 
                ...
                document.getElementById("txtsalesman").value=$('#jqxSalagentsearch').jqxGrid('getcellvalue', rowindex1, "sal_name");
                document.getElementById("txtsalesmandocno").value=$('#jqxSalagentsearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
