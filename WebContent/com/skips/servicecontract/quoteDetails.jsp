...
$(document).ready(function () {   	
           ...
           var rendererstring1=function (aggregates){
            ...
            $("#jqxQuote").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Waste Type', datafield: 'wastetype', width: '8%' ,editable:false},	
            ...
            $("#jqxQuote").on('cellendedit', function (event) {    
        	    ...
        	    if(columnDataField=="tippingfee"){ 
        	    	if(tippingmethod=="FIXED"){
        	    		 console.log(cellValue+"=="+oldValue);  
        	 ...
        	 var rows = $("#jqxQuote").jqxGrid('getrows');   
  		     for(var i=0 ; i < rows.length ; i++){
				 ...
				 var wastedoc=rows[i].wastedoc;   
 				 if((skipdoc!="" && skipdoc!="0" && typeof(skipdoc)!="undefined" && typeof(skipdoc)!="NaN" && skipdoc!=null) || (site!="" && site!="0" && typeof(site)!="undefined" && typeof(site)!="NaN" && site!=null)){
 		     ...
 		     for(var i=0 ; i < rows.length ; i++){
				 ...
				 if(site!="" && site!="0" && typeof(site)!="undefined" && typeof(site)!="NaN" && site!=null){
					 ...
					 if(qty==""){
              		 ...
              		 if(typeof(rowno)=="undefined" || typeof(rowno)=="NaN" || rowno=="" || rowno=="0"){        
              			 if(ownership=="CLIENT SKIP"){ 
                 			 security=0.0;
        ...
        function getTotals(){  
       	 ...
       	 if(typeof(site)!="undefined" && typeof(site)!="NaN" && site!="" && site!=null){ 
		         ...
		         //alert(rate+"==="+nooftrips+"==="+totalservcharges+"==="+Math.round(totalservcharges))   
		         document.getElementById('calcshowlbl').innerHTML="Total Charges = "+Math.round(totalcharges*100)/100+"&emsp;&emsp;No of Trips - "+bname+" = "+Math.round(nooftrips)+"&emsp;&emsp;Per Month Charges = "+Math.round(permonthcharges)+"&emsp;&emsp;Total Service Charge - "+bname+" = "+totalservcharges.toFixed(2)+"&emsp;&emsp;Tipping Fee Charges - "+bname+" = "+Math.round(tippingfeecharges)+"&emsp;&emsp;Total Contract Value = "+Math.round(totalcntvalue);
       	 }       
      }
    </script>
    <div id="jqxQuote"></div> 