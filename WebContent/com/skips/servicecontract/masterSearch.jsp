...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () {
 	...
 	function enqloadSearch1() {
 		...
 		var Cl_descss=document.getElementById("Cl_desc").value;
 		//var Cl_desc = Cl_descss.replace(' ', '%20');
 		var id=1;
	   getdata1(Cl_namess, msdocno, enqdate, id, Cl_descss, msenqno);  
	}
	function  getdata1(Cl_namess, msdocno, enqdate, id, Cl_descss, msenqno){       
		 $("#refreshdivmas").load('subMastersearch.jsp?Cl_names='+encodeURIComponent(Cl_namess)+'&remarks='+encodeURIComponent(Cl_descss)+'&msenqno='+msenqno+'&msdocno='+msdocno+'&enqdate='+enqdate+'&id='+id);
		}
	</script>
<body bgcolor="#E0ECF8">
<div id=search>
<table width="100%" >
  <tr>
   ...
   <table>
   <tr>
   <td align="right" width="5%">Docno</td>
    ...
    <td align="left" ><div id="enqdate" name="enqdate"  value='<s:property value="enqdate"/>'></div>
     <td><input type="button" name="enqbtnrasearch" id="enqbtnrasearch" class="myButton" value="Search"  onclick="enqloadSearch1()"></td>
      ...
      <tr>
      <td align="right" width="5%">Enq No</td>
      <td align="left" width="5%"><input type="text" name="msenqno" id="msenqno"  value='<s:property value="msenqno"/>'></td>  
	    <td align="right" >Remarks</td>         
	    <td align="left" width="70%" colspan="3"><input type="text" name="Cl_desc" id="Cl_desc"  style="width:99%;" value='<s:property value="Cl_desc"/>'></td>
	</tr>
    </table>  
    </td>
</tr>
