...
<% ClsRentalRefundDAO DAO = new ClsRentalRefundDAO(); %> 
...
var data4='<%=DAO.contractDetailsSearch(session,search) %>'; 		
        	//alert("data4=="+data4);
...
$("#contractDetailsSearchGridID").on("bindingcomplete", function (event) {
            ...
            $("#contractDetailsSearchGridID").jqxGrid(
            {
                ...
                columns: [      
							{ text: 'Schedule No', datafield: 'scheduleno', width: '10%', editable: false, hidden: true },	
							{ text: 'Contract No', datafield: 'contractdocno', width: '10%', editable: false },
							{ text: 'Contract No', datafield: 'contracttrno' ,hidden: true, editable: false},
							{ text: 'Contract Details', datafield: 'contractdetails', editable: false },
							{ text: 'Site', datafield: 'site', width: '20%', editable: false, hidden: true   },
							{ text: 'Area', datafield: 'area', width: '20%', editable: false , hidden: true  },
