        ...
        $(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name : 'callibration', type: 'string'  },
     						{name : 'type', type: 'string'  },
     						{name : 'qty', type: 'string'   },
     						{name : 'remarks', type: 'string'   },
     						{name : 'sr_no', type: 'int'  },
     						{name : 'temppsrno', type: 'string'  },
     						{name : 'tempspecid', type: 'string'  },
     						{name : 'catid', type: 'string'  },
     						{name : 'scatid', type: 'string'  },
     						{name : 'brndid', type: 'string'  },
            ...
            $("#jqxEnquiry").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Name of Equipment and Accessories', datafield: 'equipmentname', width: '20%' },
							{ text: 'Make', datafield: 'make', width: '11%'},
							{ text: 'Model', datafield: 'model', width: '11%'},
							{ text: 'Range', datafield: 'ranges', width: '11%'},
							{ text: 'Callibration', datafield: 'callibration', width: '11%'},
							{ text: 'Qty', datafield: 'qty', width: '11%'},
							{ text: 'Type', datafield: 'type', width: '11%'},
							{ text: 'Remarks', datafield: 'remarks', width: '43%'},
							{ text: 'psrno', datafield: 'temppsrno',hidden:true},
							{ text: 'specid', datafield: 'tempspecid',hidden:true},
							{ text: 'catid', datafield: 'catid',hidden:true},
							{ text: 'scatid', datafield: 'scatid',hidden:true},
							{ text: 'brandid', datafield: 'brndid',hidden:true}
			              ]
