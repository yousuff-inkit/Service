...
#jqxInput{
  ...
  <script type="text/javascript"> 
            ...
            $(document).ready(function () {
           	 ...
           	 var aa1= '<%=ClsEnquiryDAO.typeSearch(session)%>';
                ...
                $("#jqxInput2").jqxInput({ source: dataAdapter, displayMember: "type", valueMember: "type", width: 240, height: 20});
                      ...
                      if (item) {
                          ...
                          for (var i = 0; i < dataAdapter.records.length; i++) { 
                              if (item.value == dataAdapter.records[i].psrno) {
                                  ...
                                  document.getElementById("jqxInput2").value=dataAdapter.records[i].type;
