 ...
 var qotmasterdata; 
  ...
  $(document).ready(function () { 	
     ...
     var source =
     {
         ...
         datafields: [
                    ...
                    {name : 'cldocno' , type: 'String' },
                 	...
                 	{name : 'cprsmail' , type: 'String' },
                 	{name : 'cprsmob' , type: 'String' },
     ...
     $("#subquotationSearch").jqxGrid(
     {
        ...
        selectionmode: 'singlerow',
         ...
         columns: [
				...
				{ text: 'Contact Person', datafield: 'sal_name', width: '25%' },
     ...
     $('#subquotationSearch').on('celldoubleclick', function (event) {
        ...
        document.getElementById("txtcontact").value=$('#subquotationSearch').jqxGrid('getcellvalue', rowindex1, "cperson");
        document.getElementById("txtemail").value=$('#subquotationSearch').jqxGrid('getcellvalue', rowindex1, "cprsmail");
        document.getElementById("txtmob").value=$('#subquotationSearch').jqxGrid('getcellvalue', rowindex1, "cprsmob");
    	 funSetlabel();
