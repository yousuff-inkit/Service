...
$(document).ready(function() {
    ...
    $('#txtassignemp').dblclick(function() {
        $('#empinfowindow').jqxWindow('open');
        empSearchContent('emp.jsp');
    });
});
...
function empSearchContent(url) {
    $.get(url).done(function(data) {
        $('#empinfowindow').jqxWindow('setContent', data);
    });
}
...
function funreload() {
    ...
    var emp = document.getElementById("txtempid").value;
	...
	$("#serschedulediv").load("serScheduleDetails.jsp?date="+date+"&barchval="+barchval+"&clientid="+clientid+"&area="+area+"&id="+id+"&chkfromdate="+chkfromdate+"&fromdate="+fromdate+"&emp="+emp);
//alert("serScheduleDetails.jsp?date="+date+"&barchval="+barchval+"&clientid="+clientid+"&area="+area+"&id="+id+"&chkfromdate="+chkfromdate+"&fromdate="+fromdate);
...
function funClear() {
  ...
  //  $("#jqxSerCount").jqxGrid('clear');
    ...
    document.getElementById("txtassignemp").value = "";
    ...
    $("#txtassignemp").attr("placeholder", "press F3 for Search");
                     ...
                     <table width="100%" >
                        ...
                        <tr>
                         ...
                         <tr>
                           ...
                           <td ><input style="height:19px;" type="text" name="txtassignemp" id="txtassignemp" value='<s:property value="txtassignemp"/>' onKeyDown="getareas(event);" readonly placeholder="Press F3 to Search">
