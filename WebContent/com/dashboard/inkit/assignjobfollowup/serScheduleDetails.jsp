...
var bttnview='<%=bttnview%>';
 ...
 var exceldata;
  ...
  data= '<%= sd.serviceScheduleGridLoad(session,dtype,date,branch,clientid,id,priority,grp,emp,mem,area,chkfromdate,fromdate,jobid,chktodate) %>';
 ...
 $("#jqxloaddataGrid").on("bindingcomplete", function (event) {
            ...
            $("#jqxloaddataGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'contr',  datafield: 'contr',columntype: 'button', width: '4%' },
             ...
             $('#jqxloaddataGrid').on('rowdoubleclick', function (event) 
            		{ 
		                ...
		                document.getElementById("txtassign").value=$('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "asgnmode");
		              	...
		              	document.getElementById("hidbranch").value=$('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "branch");

		              	if(parseFloat($('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "empid"))>0){
		              		document.getElementById("grpempid").value=$('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "empid")+"::"+$('#jqxloaddataGrid').jqxGrid('getcellvalue', rowindex1, "dbname");
		              	}else{
		                ...
		                $("#assignSubDiv").load("assignSubGrid.jsp?docno="+trno+"&brchid="+brch+"&dtype="+dtype+"&srno="+srno);
