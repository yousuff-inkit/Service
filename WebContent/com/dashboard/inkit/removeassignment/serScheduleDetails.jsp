...
var data;
  ...
  data= '<%= DAO.serviceScheduleGridLoad(session,chkfromdate,fromdate,date,branch,clientid,area,dtype,id) %>';
 		...
 		$("#jqxloaddataGrid").on("bindingcomplete", function (event) {
            ...
            $("#jqxloaddataGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'ASSIGN.GROUP',columntype: 'textbox', datafield: 'empgroup', width: '8%',cellclassname:cellclassname },
					...
					{ text: 'PLANNED DATE', datafield: 'plannedon', width: '8%',cellsformat:'dd.MM.yyyy' ,cellclassname:cellclassname},
					{ text: 'PLANNED TIME', datafield: 'pltime', width: '8%' ,cellclassname:cellclassname},
