...
<td width="20%" >
    ...
    <option value="">--Select--</option><option value="AMC">AMC</option><option value="SJOB">SJOB</option><option value="STC">STC</option><option value="AMS">AMS</option></select></td></tr>  
