	...
	try{
		 ...
		 for(int i=0;i<newarray.size();i++){
		        ...
		        if(configs>0 && cltax==1){        
						...
						upsql="select taxper,round(("+amount+" * taxper)/100,2) as taxamt from cm_staffcontrm where taxper>0 and doc_no="+costcode;  
				...
				if(val>0){  
					     ...
					     sqldata1="update cm_staffcontrd set invdate='"+sqltodate+"' where rowno="+rowno+"";      
