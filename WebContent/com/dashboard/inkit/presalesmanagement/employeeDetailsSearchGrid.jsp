<%@page import="com.dashboard.inkit.presalesmanagement.ClsPresalesmanagementDAO"%>
        ...
        $(document).ready(function () { 	
            ...
            $("#employeeDetailsSearchGridId").jqxGrid(
            {
                ...
                columns: [   
							...
							{ text: 'Cost Per Hour', datafield: 'costperhour' , hidden:true , editable: false, width:'20%',cellsformat:'d2',cellsalign:'right',align:'right'},
            ...
            $('#employeeDetailsSearchGridId').on('rowdoubleclick', function (event) {	
				...
				$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "empid",$('#employeeDetailsSearchGridId').jqxGrid('getcellvalue', rowindex1, "doc_no"));
        		$('#jqxJobDetails').jqxGrid('setcellvalue', rowIndex, "employee",$('#employeeDetailsSearchGridId').jqxGrid('getcellvalue', rowindex1, "name"));	
