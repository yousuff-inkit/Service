...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(clname,mob){
		 ...
		 $("#refreshdiv1").load('searchClient.jsp?clname='+clname+'&mob='+mob+'&id=1');
...
<table width="100%" >
  <tr >
   ...
   <tr>
    ...
    <td align="left" width="70%"><input type="text" name="Cl_name" id="Cl_name"  style="width:70%;height:20px;" value='<s:property value="Cl_name"/>'></td>
    <td align="right"><label style="font:10px Tahoma;">MOB</label></td>
    <td align="left"><input type="text" name="Cl_mob" id="Cl_mob" style="width: 100%;height: 20px;" value='<s:property value="Cl_mob"/>'></td>
