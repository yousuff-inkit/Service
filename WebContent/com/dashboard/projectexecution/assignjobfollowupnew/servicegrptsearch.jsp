...
<% String contextPath=request.getContextPath();%>
 ...
 <% 
 int assgnid=request.getParameter("assgnid")==null || request.getParameter("assgnid").trim().equals("")?0:Integer.parseInt(request.getParameter("assgnid").trim());
 int id=request.getParameter("id")==null || request.getParameter("id").trim().equals("")?0:Integer.parseInt(request.getParameter("id").trim());
 %>

 <script type="text/javascript">
 var assignteam1;
 var assgnid='<%=assgnid%>';
   assignteam1='<%=DAO.assignteam(session,assgnid,id)%>'; 
