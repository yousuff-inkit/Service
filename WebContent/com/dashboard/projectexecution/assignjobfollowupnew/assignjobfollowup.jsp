...
$(document).ready(function () {
   ...
   /*  $('#todate').on('change', function (event) {
     ...
     $('#txtgroup').dblclick(function(){
	     ...
	     teamSearchContent('servicegrptsearch.jsp?assgnid='+assgnid+'&id='+id);
	 });
	   ...
	   function save(){
		  ...
		  function funPrintBtn() {
					...
					var docno=$('#docno').val();
			  		...
			  		var win= window.open(reurl[0]+"printAssignjobnew?docno="+docno+"&brhid="+brhid+"&trno="+trno+"&dtype="+dtype+"&header=1","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
					...
					// alert(barchval);
					  ...
					  if(doccno==''){
					 	    ...
					 	    if ($("#doccno").val()!="" && dtype=="AMC") {
						        ...
						        var win= window.open(reurl[0]+"printassignjobfollowupAMCnew?branch="+barchval+"&docno="+document.getElementById("doccno").value+'&dtype='+$("#dtype").val()+'&srno='+$("#srno").val(),"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
						        ...
						        var win= window.open(reurl[0]+"printassignjobfollowupSjobnew?branch="+barchval+"&docno="+document.getElementById("doccno").value+'&dtype='+$("#dtype").val()+'&srno='+$("#srno").val(),"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
						      ...
						      var win= window.open(reurl[0]+"printAssignCallRegisternew?docno="+document.getElementById("doccno").value+"&brhid="+brhid+"&trno="+$("#calld").val()+"&header=1","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=yes,toolbar=yes");
						        win.focus();
						     }
		  ...
		  function memberAdd(){
			   $("#jqxgrptsearch").jqxGrid('clearfilters',true)
			   var selectedrows = $("#jqxgrptsearch").jqxGrid('selectedrowindexes')   
			   ...
			   for(var i=0;i<selectedrows.length;i++){
				   if(i==0){
					   temp = $("#jqxgrptsearch").jqxGrid('getcellvalue',selectedrows[i],'doc_no')    
					   document.getElementById("txtgroup").value=$('#jqxgrptsearch').jqxGrid('getcellvalue', selectedrows[i], "grpcode");
	         	       document.getElementById("groupid").value=$('#jqxgrptsearch').jqxGrid('getcellvalue', selectedrows[i], "rdocno");
					   document.getElementById("txtgrpmember").value=$('#jqxgrptsearch').jqxGrid('getcellvalue', selectedrows[i], "name");
		               document.getElementById("grpmemberid").value=$('#jqxgrptsearch').jqxGrid('getcellvalue', selectedrows[i], "doc_no");
		               document.getElementById("grpempid").value=$('#jqxgrptsearch').jqxGrid('getcellvalue', selectedrows[i], "empid");
				   }else{
					   temp = temp+","+$("#jqxgrptsearch").jqxGrid('getcellvalue',selectedrows[i],'doc_no')  
				   }  
			   }
 ...
 <label class="branch">From</label></td>
   ...
   <tr>
	...
	<tr>
	      ...
	      <td colspan="2" ><input style="height:19px;" type="text" name="txtgroup" id="txtgroup" value='<s:property value="txtgroup"/>' onKeyDown="getteam(event,2);" readonly placeholder="Press F3 to Search">
