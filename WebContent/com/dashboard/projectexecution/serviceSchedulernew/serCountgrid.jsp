...
<script type="text/javascript"> 
  ...
  $(document).ready(function () {
	schedata= '<%=sd.serCountgrid(session,date,branch,clientid,id,priority,site,area,chkfromdate,fromdate)%>'; 
    ...
    $('#jqxSerCount').on('rowdoubleclick', function (event) 
    		...
    		$("#overlay, #PleaseWait").show();
    		var id=1;
    		$("#serschedulediv").load("serScheduleDetails.jsp?clientid="+clientid+"&date="+date+"&barchval="+barchval+"&dtype="+dtype+"&id="+id+"&isprior="+isprior+"&site="+site+"&area="+area+"&bttnview="+bttnview+'&chkfromdate='+chkfromdate+'&fromdate='+fromdate);
