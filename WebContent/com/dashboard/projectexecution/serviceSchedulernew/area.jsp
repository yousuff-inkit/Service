...
<% String contextPath=request.getContextPath();%>
 ...
 <%int rowIndex=request.getParameter("rowBoundIndex")==null || request.getParameter("rowBoundIndex").trim().equals("")?0:Integer.parseInt(request.getParameter("rowBoundIndex").trim()); %>
