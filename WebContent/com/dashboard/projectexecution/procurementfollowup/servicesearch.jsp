...
<%
ClsProcurementFollowupDAO DAO=new ClsProcurementFollowupDAO();
%>
 <%
					...
					{ text: 'Service Type', datafield: 'stype', width: '75%' }
				           ...
				           $('#jqxstypesearch').on('rowdoubleclick', function (event) 
				              	...
				              	var rowindex1=event.args.rowindex;
				            	 		$('#procurementSubGrid').jqxGrid('setcellvalue', rowIndex, "sertype",$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "stype"));
				               			$('#procurementSubGrid').jqxGrid('setcellvalue', rowIndex, "stypeid",$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "docno"));
