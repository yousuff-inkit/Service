...
<script type="text/javascript">
 		var data5;
 		var data5='<%= DAO.manPowerConsumedGridLoading(session,costtype,costcode,check) %>'; 
        ...
        $(document).ready(function () { 	
            ...
            $("#manPowerConsumedGridId").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Utilized Hrs', datafield: 'utilizedhrs', width: '10%' },
							{ text: 'Cost / Hr', datafield: 'costperhour',cellsformat: 'd2',cellsalign:'right',align:'right', width: '12%' },
							{ text: 'Total', datafield: 'totalvalue',cellsformat: 'd2',cellsalign:'right',align:'right', width: '10%', aggregates: ['sum'], aggregatesrenderer:rendererstring },
