...
function funExportBtn(){
	if(document.getElementById("frmtype").value==1 ||  document.getElementById("frmtype").value=="1") {
		...
		$("#listdiv2").excelexportjs({    
				containerid: "listdiv2", 
				datatype: 'json', 
				dataset: null, 
				gridId: "jqxProcFolGrid", 
				columns: getColumns("jqxProcFolGrid") ,       
				worksheetName:"Material Issue Mater"
		});
		...
		$("#listdiv1").excelexportjs({    
				...
				dataset: null, 
				gridId: "mainlistgrid", 
				columns: getColumns("mainlistgrid") ,       
				worksheetName:"Material Issue Mater"
		});
	...
	$("#sublistdiv").excelexportjs({    
				containerid: "sublistdiv", 
				datatype: 'json', 
				dataset: null, 
				gridId: "prdgrid", 
				columns: getColumns("prdgrid") ,       
				worksheetName:"Material Issue Details"
	});
		   	...
		   	if(r==false)
		   	  {
		   		...
		   		if(selectedrows.length<=0){
		   			$.messager.alert('Message', '  Select the document  ');
		   			return 0;
		   		}
