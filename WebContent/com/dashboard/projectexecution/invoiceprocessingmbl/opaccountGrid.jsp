...
$(document).ready(function(){           
    ...
    {             
        ...
        $("#jqxopaccountGrid").on('bindingcomplete', function(){
        	if(divname=="proforma" || divname=="notrcvd"){   
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','terms');
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','duedate');
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','amount');
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','payterms');
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','payservice');
        		$("#jqxopaccountGrid").jqxGrid('hidecolumn','paydesc');
        	}else{
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','terms');
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','duedate');
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','amount');
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','payterms');
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','payservice');
        		$("#jqxopaccountGrid").jqxGrid('showcolumn','paydesc');
        		$("#jqxopaccountGrid").jqxGrid('setcolumnproperty', 'refname', 'width', 300);    
        	}
        });
