	...
	try{ 
		...
		//System.out.println("strcountdata--->>>"+strcountdata);                           
		 ...
		 while(rs.next()){ 
			...
			gridarray.add(srno+" :: "+1+" :: "+invdesc+" :: "+total+" :: "+total+" :: "+0+" :: "+total+" :: "+taxper+" :: "+taxamt+" :: "+taxtot+" :: "+total+" :: "+costtype+" :: "+costid+" :: "+remarks+" :: "+lineacno+" :: "+0+" :: "); 
		}   
		// System.out.println("val========"+val);
    	val = DAO.insert(sqlStartDate, sqlStartDate, contrtype, contractno+"", "AR", clacno+"", client, "1" , "1", "", "", invdesc, session, "A", total, gridarray, "PINV", request, sqlStartDate, pono, sqlStartDate+"", 0, taxper, masteraction);
    	 //System.out.println("val========"+val);  
    	 if(val>0){
    		 ...
    		 String updat="update cm_srvcontrm set pinvno="+val+" where tr_no="+jobdocno+"";     
