...
<table align="center" width="85%" border="3" cellpadding="5"  >
         ...
         <tr>
         <td colspan="2">
         <label class="branch"><b><u>Work Description</u></b></label><br>
        <br>
...
<table id="client" width="85%" class="tablereceipt" align="center">
  ...
  <tr height="28" style="background-color: #D8D8D8;" class="tablereceipt" align="center">
   ...
   <!--  <th class="tablereceipt" width="15%" align="left">Remarks</th>-->
    <th class="tablereceipt" width="35%" align="left">Service Type</th>
...
<tbody>
  <%int l=0; %>
  <s:iterator var="stat" value='#request.schedulerarray' >
  <%l=l+1;%>
...
<tr>
<td width="15%"  align="left"  class="tablereceipt" style="padding-bottom:25px;">Invoice Details</td>
