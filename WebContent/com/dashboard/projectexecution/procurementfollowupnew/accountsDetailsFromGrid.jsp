...
<script type="text/javascript">
   ...
   var data2= '<%=sd.accountsDetailsFrom(masterdate,accountno,accountname,currency,check) %>'; 
        ...
        $(document).ready(function () { 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
             ...
             //   document.getElementById("errormsg").innerText="";
                document.getElementById("txtvendorid").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
