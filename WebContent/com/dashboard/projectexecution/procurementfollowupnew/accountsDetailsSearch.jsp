...
<table width="100%">
  <tr>
    <td width="10%" align="right"><label style="font:10px Tahoma;">Account No</label></td>
    <td width="30%"><input type="text" name="txtaccountsno" id="txtaccountsno" style="width:85%;" value='<s:property value="txtaccountsno"/>'></td>
    <td width="10%" align="right"><label style="font:10px Tahoma;">Currency</label></td>
  ...
  <tr>
    <td align="right"><label style="font:10px Tahoma;">Account Name</label></td>
