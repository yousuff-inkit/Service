...
<body onload="getBranch();">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="input-group m-t-8">
					<input type="text" class="form-control custom-input input-sm" placeholder="What are you looking upto?!!" onkeyup="funFilterMessages();" id="searchmsg">
				...
				<div class="list-group custom-scrollbar main-data-list m-t-10"  style="max-height:450px;overflow-y: auto; ">
					<a class="list-group-item active">
				    	<h5 class="list-group-item-heading searchitem"><i class="fa fa-user m-r-15"></i>Mohammed Hussain Mohammed</h5>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-mobile m-r-15"></i>919895098950</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-map-marker m-r-15"></i>Area 51</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-briefcase m-r-10"></i>15245 10-10-2019</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-money m-r-10"></i>AED 125485.25</p>
				  	</a>
				  	<a class="list-group-item">
				    	<h5 class="list-group-item-heading searchitem"><i class="fa fa-user m-r-15"></i>Ahmed Mohammed Al Mahri</h5>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-mobile m-r-15"></i>919895098950</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-map-marker m-r-15"></i>Area 51</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-briefcase m-r-10"></i>15245 10-10-2019</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-money m-r-10"></i>AED 125485.25</p>
				  	...
				  	<a class="list-group-item">
				    	<h5 class="list-group-item-heading searchitem"><i class="fa fa-user m-r-15"></i>Hamda Mohammed</h5>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-mobile m-r-15"></i>919895098950</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-map-marker m-r-15"></i>Area 51</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-briefcase m-r-10"></i>15245 10-10-2019</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-money m-r-10"></i>AED 125485.25</p>
				  	...
				  	<a class="list-group-item">
				    	<h5 class="list-group-item-heading searchitem"><i class="fa fa-user m-r-15"></i>Qumra Transport</h5>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-mobile m-r-15"></i>919895098950</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-map-marker m-r-15"></i>Area 51</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-briefcase m-r-10"></i>15245 10-10-2019</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-money m-r-10"></i>AED 125485.25</p>
				  	...
				  	<a class="list-group-item">
				    	<h5 class="list-group-item-heading searchitem"><i class="fa fa-user m-r-15"></i>Abdul Majeed Bin Salam</h5>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-mobile m-r-15"></i>919895098950</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-map-marker m-r-15"></i>Area 51</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-briefcase m-r-10"></i>15245 10-10-2019</p>
				    	<p class="list-group-item-text searchitem"><i class="fa fa-money m-r-10"></i>AED 125485.25</p>
	...
	<script type="text/javascript">
		...
		function funLoadMainData(todate,contracttype){
			var x=new XMLHttpRequest();
			x.onreadystatechange=function(){
				if (x.readyState==4 && x.status==200)
				{
			...
			x.open("GET","loadMainData.jsp?todate="+todate+"&contracttype="+contracttype,true);
			x.send();
		}
		...
		function funLoadDetailData(jobno){
			var contracttype=0;
			if(document.getElementById("optcontracted").checked==true){
				contracttype=1;
			}
			...
			x.onreadystatechange=function(){
				if (x.readyState==4 && x.status==200)
				{
					...
					$.each( rawdata, function( key, value ) {
						...
						if(contracttype==2){
							detailhtmldata+='<div class="panel-heading">'+value.clientname+' - '+value.enqvocno+' - '+value.enqdate+'</div>';	
						}
						else{
							detailhtmldata+='<div class="panel-heading">'+value.clientname+' - '+value.jobno+' - '+value.jobdate+'</div>';
						}
						...
						detailhtmldata+='<td colspan="5">'+value.clientmobile+'</td>';
						detailhtmldata+='</tr>';
						detailhtmldata+='<tr>';
						...
						detailhtmldata+='<td align="right">'+value.amount+'</td>';
						detailhtmldata+='</tr>';
						detailhtmldata+='<tr>';
						...
						detailhtmldata+='<a data-toggle="collapse" href="#collapse1">Job Progress Details</a>';
						detailhtmldata+='</h4>';
						detailhtmldata+='</div>';
						detailhtmldata+='<div id="collapse1" class="panel-collapse collapse">';
						/*detailhtmldata+='<div class="panel-body">';*/
						detailhtmldata+='<table class="table">';
			...
			x.open("GET","loadDetailData.jsp?jobno="+jobno+"&contracttype="+contracttype,true);
			x.send();
		}
