...
%>
       ...
       <script type="text/javascript">
			 ...
			 var prodsearchdata= '<%=DAO.searchProduct(session,productname,brandname,id,gridunit,gridprdname)%>';
		$(document).ready(function () { 	
          ...
          $('#prosearchGrid').on('rowdoubleclick', function (event) {
              ...
              document.getElementById("txtproductid").value= $('#prosearchGrid').jqxGrid('getcellvalue', rowindex2, "psrno");
              document.getElementById("txtproduct").value=$('#prosearchGrid').jqxGrid('getcellvalue', rowindex2, "productname");
