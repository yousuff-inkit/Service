...
Connection conn = null;
	...
	try{
		...
		String srno=request.getParameter("srno")=="" || request.getParameter("srno")==null?"0":request.getParameter("srno");   
		...
		String type="PMT",description="",logdesc="";                
		...
		ClsCommercialReceiptDAO DAO=new ClsCommercialReceiptDAO();                          
			 ...
			 dat=DAO.insert(conn,sqldate,"CMR",paytype,acdocno,cardtype,refno,sqlrefdate,description,0, brhid+"",cldocno,clacno,type,docno,"1",Double.parseDouble(netamt),0.0,0.0,0.0,Double.parseDouble(netamt),"","",0.0,gridarray,session,request);
			 //System.out.println("val--->>>"+dat);
			 if(dat>0){     
   	        	 logdesc="Receipt created - Property Docno#"+docno+" Property Srno#"+srno+" Receipt Srno#"+request.getAttribute("isrno");         
