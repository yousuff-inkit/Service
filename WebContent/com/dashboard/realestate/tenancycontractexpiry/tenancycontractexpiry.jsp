...
x.open("GET","savedata.jsp?docno="+docno+'&description='+description+'&brhid='+brhid,true);
x.send();
}
...
function disitems(val)
{
	 ...
	 $("#btnfollowup").attr('disabled', true );
}
...
function  funcleardata() 
{
	...
	disitems(0);
	$("#searshgrid1").jqxGrid('clear');
	$("#fupGrid").jqxGrid('clear');
}
</script>
</head>
...
<td width="20%" >
   ...
   <tr><td align="right" ><label class="branch">Tenant</label></td><td><input type="hidden" name="cldocno" id="cldocno" value='<s:property value="cldocno"/>'>
	...
	<tr>
	<td colspan="2"><div id='followupdiv'>
	<fieldset>
	<table width="100%">
		<tr>
		<td align="right"><label class="branch">Description</label></td>
		<td><input type="text" id="txtdescription" name="txtdescription" style="height:18px; width:100%;" value='<s:property value="txtdescription"/>'></td>
		</tr>
		<tr>
		<td colspan="2" align="center"><label class="branch"><input type="button" name="btnfollowup" id="btnfollowup" class="myButton" value="Followup" onclick="funupdate()"></label></td>
		</tr>
	</table>
	</fieldset>
	</div></td>
...
<td width="80%">
	<table width="100%"> 
		<tr><td colspan="2"><div id="listdiv"><jsp:include page="mainGrid.jsp"></jsp:include></div></td></tr>
	 	<tr><td colspan="2"><div id="subgriddiv"><jsp:include page="subGrid.jsp"></jsp:include></div></td></tr>
