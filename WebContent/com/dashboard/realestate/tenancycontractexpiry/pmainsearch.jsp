...
<table width="100%" >
  <tr >
   ...
   <table width="100%" >   
   <tr>
    <td align="right" width="6%"><label style="font-size:9px;">Doc No</label></td> 
    <td align="left" width="20%"><input type="text" name="docnosss" id="docnosss"  style="width:90%;height:20px;" value='<s:property value="docnosss"/>'></td>
    <td align="right" width="10%"><label style="font-size:9px;">Owner</label></td>
    <td align="left"  width="20%"><input type="text" name="owner" id="owner" style="width:100%;height:20px;"  value='<s:property value="owner"/>'></td>
    
   
    <input type="hidden" name="pname" style="width:91%;" id="pname" value='<s:property value="pname"/>'> 
   ...
   <%--   <td align="right"  >Mobile</td>
    <td align="left"   ><input type="text" name="refnoss" style="width:100%;" id="refnoss" value='<s:property value="refnoss"/>'></td> --%>
      ...
      <td align="right" width="10%"><label style="font-size:9px;">Remarks</label></td><td  width="30%" colspan="4"><input type="text" name="descriptionss1" style="width:90%;height:20px;" id="descriptionss1" value='<s:property value="descriptionss1"/>'></td>
