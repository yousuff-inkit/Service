...
<body onload="getStatuses();">                        
  <div class="container-fluid">    
       ...
       <div class="primarypanel custompanel" style="margin-left:5px;">
         ...
         <div class="primarypanel custompanel" style="margin-left:5px;">  
             <div id="border1">
                ...
                <button type="button" class="btn btn-default btnStyle" id="btnstatusupdate" data-toggle="tooltip" title="Status Update" data-placement="bottom"><i class="fa fa-file-text " aria-hidden="true"></i></button>
    ...
    <div class="row">      
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">             
        <div id="regdiv" class="borderStyle"><jsp:include page="registrationGrid.jsp"></jsp:include></div>               
      </div>                                  
    </div>
    <!-- Comments Modal-->     
            ...
            <div class="modal-footer"> 
            	<div class="row rowgap">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">   
						<button type="button" class="btn btn-default btnStyle" id="btnupdate" title="Create" data-placement="bottom" onclick="funstatusupdate();"><i class="fa fa-floppy-o " aria-hidden="true"></i></button>
					</div>    
				</div> 
            </div>
          </div>  
...
$(document).ready(function(){        
	     ...
	     $("#fromdate").jqxDateTimeInput({ width: '105px', height: '25px',formatString:"dd.MM.yyyy"});
		 $("#todate").jqxDateTimeInput({ width: '105px', height: '25px',formatString:"dd.MM.yyyy"});
        ...
        $('#btnexcel').click(function(){            
        	 $("#regdiv").excelexportjs({
 				...
 				worksheetName:"Customer Registration"          
 			});   
        });
   ...
   function funload(){   
		   ...
		   if(fromdates>todates){
			   ...
			   $("#overlay, #PleaseWait").show();  
			   $('#regdiv').load("registrationGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id="+1);
		  } 
   }
   function funstatusupdate(){                     
			   ...
			   $.messager.confirm('Message', 'Do you want to update status?', function(r){           
					     	if(r==false)   
					     	  {
					     		return false; 
					     	  }  
					     		...
					     		$("#overlay, #PleaseWait").show();    
					     		saveData(docno,status,remarks);                           
					     	}        
					 });              
			}
	     function saveData(docno,status,remarks){                
	          var x=new XMLHttpRequest();
		      x.onreadystatechange=function(){
		      if (x.readyState==4 && x.status==200){     
		      		var items=x.responseText.trim().split('###');          
		      ...
		      x.open("GET","saveData.jsp?docno="+docno+'&remarks='+encodeURIComponent(remarks)+'&status='+status,true);                                                                                                  
		      x.send();      
	     }   
	     ...
	     function getStatuses() {    
	  			...
	  			x.onreadystatechange = function() {
	  				if (x.readyState == 4 && x.status == 200) {
	  					...
	  					$("select#txtstatus").html(optionsyear);              
	  				} else {
	  				}
	  			}
	     ...
	     function funAttach(){
	 		var brchid="1";                   
	 		var frmname="Customer Registration";
	 		var frmcode="CGR";     
