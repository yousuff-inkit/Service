...
$(document).ready(function () {
    ...
    $("#enqlistgrid").jqxGrid(
    {
        ...
        columns: [   
				 ...
				 { text: 'Current Status', datafield: 'type', width: '10%',cellclassname: cellclassname },
				
				 { text: 'ENQ Status', datafield: 'priority', width: '4%',cellclassname: cellclassname },
				 { text: 'QOT Flwp Status', datafield: 'fstatus', width: '10%',cellclassname: cellclassname },					
				...
				// { text: 'enqtype', datafield: 'enqtype', width: '20%' ,cellclassname: cellclassname },
				 ...
				 { text: 'QOT Value',datafield: 'qotval', width: '6%' ,cellclassname: cellclassname,cellsalign:'right',align:'right',cellsformat:'d2' },
				 { text: 'Job No',datafield: 'jobno', width: '4%' ,cellclassname: cellclassname },
				 { text: 'Job Value',datafield: 'jobval', width: '6%' ,cellclassname: cellclassname,cellsalign:'right',align:'right',cellsformat:'d2' },
				...
				{ text: 'enqtypechk', datafield: 'enqtypechk', width: '20%',hidden:true ,cellclassname: cellclassname },
						]
    ...
    $('#enqlistgrid').on('rowdoubleclick', function (event) { 
   	 ...
   	 var enqtyepchk=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "enqtypechk");
   	 document.getElementById("enqtypechk").value=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "enqtypechk");
   	document.getElementById("qotchkval").value=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "qotval");
   	 //alert("enqtyepchk=="+enqtyepchk);
   	if(parseInt(enqtyepchk)==4){	
   	 $('#btnprocdtocreate').attr("disabled",false);
   	}
   	else{
   	 $('#btnprocdtocreate').attr("disabled",true);
   	}
	
	if(parseInt($('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "jobno"))>0){
	...
	if(parseInt(enqtyepchk)==1 || parseInt(enqtyepchk)==2){
	 $('#btnjobcreate').attr("disabled",false);
   	}
   	else{
    ...
    document.getElementById("jobchkno").value=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "jobno");
    document.getElementById("jobchktrno").value=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "tr_no");
    var enqno=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "doc_no");
    var qottrno=$('#enqlistgrid').jqxGrid('getcellvalue', rowindex1, "qottrno");
    var setval="";
    if(parseInt(enqno)>0 && parseInt(qottrno)==0){
    	setval=enqno;
    	document.getElementById("reftype").value="Enquiry";
    	document.getElementById("refno").value=setval;
    }
    if(parseInt(enqno)>0 && parseInt(qottrno)>0){
    	setval=qottrno;
    	document.getElementById("reftype").value="Quotation";
    	document.getElementById("refno").value=setval;
    }
