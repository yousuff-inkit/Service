...
function funExportBtn(){
	 	   	if(document.getElementById("summ").value=="summ")
		{
	 			...
	 			datatype: 'json',
	 			dataset: null,
	 			gridId: "sumorderlistgrid",
	 			columns: getColumns("sumorderlistgrid") ,   
	 			worksheetName:"Purchase Order List Summary "  
	 		});		
	 	   	 }
	   	else
	   		{
	   	 $("#listdiv").excelexportjs({
				...
				worksheetName:"Purchase Order List Detail "  
			});		   		}
...
function funreload(event)
{
	 ...
	 var removecancelled=0;
	 
	 if($('#chkremovecancelled').is(":checked")){
		 removecancelled=1;
	 }
	   ...
	   $("#overlay, #PleaseWait").show();
		if(document.getElementById("summ").value=="summ")
		{
			$("#listdiv1").load("sumorderlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno+"&removecancelled="+removecancelled);
	
		}else{
			 $("#listdiv").load("orderlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno+"&removecancelled="+removecancelled);
...
<tr>
<td><input type="checkbox" name="chkremovecancelled" id="chkremovecancelled"></td>
<td><label class="branch">Remove Cancelled</label></td>
</tr>
