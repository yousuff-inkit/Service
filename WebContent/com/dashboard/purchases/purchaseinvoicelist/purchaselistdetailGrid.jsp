                  ...
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                   ...
                   /// doc_no, voc_no, date, type, expdeldt, qty, brand, model, color  
                     ...
                     { text: 'Account Name', datafield: 'acname',  width: '12%'  },
           	         ...
           	         { text: 'Unit', datafield: 'unit',  width: '5%' ,aggregates: ['sum1'],aggregatesrenderer:rendererstring1},
           	         { text: 'Total Qty', datafield: 'qty',  width: '6%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
           	         { text: 'Out Qty', datafield: 'out_qty',  width: '6%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
		           	 { text: 'Balance Qty', datafield: 'balqty',  width: '6%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring},
