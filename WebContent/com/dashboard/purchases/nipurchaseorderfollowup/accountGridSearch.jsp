...
<script type="text/javascript">
        ...
        var typedata= '<%=searchDAO.accountGridsearch(type1) %>';
        $(document).ready(function () { 	
            ...
            $('#jqxaccmainSearch').on('rowdoubleclick', function (event) {
            	var rowindex1 =$('#rowindex1').val();
                var rowindex2 = event.args.rowindex;  
              var rows = $('#ordersubgrid').jqxGrid('getrows');
                var rowlength= rows.length;
                if(rowindex1 == rowlength - 1)
                	{  
                $("#ordersubgrid").jqxGrid('addrow', null, {});
                	} 
                	
                	 $('#ordersubgrid').jqxGrid('selectcell', rowindex1, 'accountnw');
              $('#ordersubgrid').jqxGrid('setcellvalue', rowindex1, "accountnw" ,$('#jqxaccmainSearch').jqxGrid('getcellvalue', rowindex2, "account"));
              $('#ordersubgrid').jqxGrid('setcellvalue', rowindex1, "accname" ,$('#jqxaccmainSearch').jqxGrid('getcellvalue', rowindex2, "description"));
              $('#ordersubgrid').jqxGrid('setcellvalue',rowindex1, "headdoc",$('#jqxaccmainSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
              $('#ordersubgrid').jqxGrid('setcellvalue',rowindex1, "grtype",$('#jqxaccmainSearch').jqxGrid('getcellvalue', rowindex2, "grtype"));
