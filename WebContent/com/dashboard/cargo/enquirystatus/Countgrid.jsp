<%@page import="com.dashboard.cargo.enqiurystatus.enquiryStatusDAO" %>
<%
enquiryStatusDAO sd=new enquiryStatusDAO();
%>
...
$(document).ready(function () {
    ...
    $("#jqxCount").jqxGrid(
    {
        ...
        columns: [
						...
						{ text: 'Status', datafield: 'stat' ,aggregates: ['sum1'],aggregatesrenderer:rendererstring1},
    ...
    $('#jqxCount').on('rowdoubleclick', function (event) 
	    ...
	    $("#loadgriddata").load("detailGrid.jsp?rds="+relodestatus+"&froms="+'<%=fromdate%>'+"&tos="+'<%=todate%>'+"&barchval="+'<%=barchval%>'+"&id=1"); 
