...
<%
enquiryStatusDAO DAO=new enquiryStatusDAO();      
String id = request.getParameter("id")==null?"0":request.getParameter("id");	
String rds = request.getParameter("rds")==null?"0":request.getParameter("rds");
...
var id='<%=rds%>';
if(id!="0"){
	griddata='<%=DAO.loadDetData(fromdate, todate, brhid, rds,id)%>';                 
}          
