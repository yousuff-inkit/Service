...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(clname,mob){
		var aa="yes";
		$("#refreshdiv1").load('vendorGrid.jsp?clname='+clname+'&mob='+mob+"&aa="+aa);
		}
...
<table width="100%" >
  <tr >
   ...
   <tr>
    ...
    <td align="left" width="70%"><input type="text" name="Cl_name" id="Cl_name"  style="width:96.5%; height:20;" value='<s:property value="Cl_name"/>'></td>
