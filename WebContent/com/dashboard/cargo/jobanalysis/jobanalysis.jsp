        ...
        <div class="row">   
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="custompanel">           
			      <table>
				      <tr>              
					      <td  align="right" ><input type="checkbox" id="chkinv" ><label class="branch" style="font-size: 13px">&nbsp;&nbsp;Inv Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>  
		        ...
		        <div  class="custompanel addpadding" id="typehide">                     
		               <select class="form-control" name="cmbtype" id="cmbtype" onchange="funload();" style="width:100%;height:32px"><option value="1">Client</option><option value="2">Salesman</option><option value="3">Month</option>
		               <option value="4">Mode</option><option value="5">Submode</option><option value="6">Shipment</option>
		               <option value="7">Job No</option><option value="8">Service Type</option></select>          
                </div>           
       ...
       <div class="row" id="sumhide">
        ...
        <script type="text/javascript">
                ...
                $('#btnexcel').click(function() {
                	 if(document.getElementById("rsum").checked){   
                		 $("#sumdiv").excelexportjs({  
                     		...
                     		worksheetName:"Job Analysis Summary"
                     		});   
	                		...
	                		worksheetName:"Job Analysis Detail"
	                		});          
	   	           	  }else{}
                });
            ...
            function funload(){                   
            	 ...
            	 if(document.getElementById("rsum").checked){       
                      $('#sumdiv').load("summaryGrid.jsp?todate="+todate+"&fromdate="+fromdate+"&type="+type+"&id="+1+"&chkinv="+chkinv); 
	           	  }else if(document.getElementById("rdet").checked){                              
	           		 
	                  $('#detdiv').load("detailGrid.jsp?todate="+todate+"&fromdate="+fromdate+"&id="+1+"&chkinv="+chkinv);          
	           	  }else{}       
            }
