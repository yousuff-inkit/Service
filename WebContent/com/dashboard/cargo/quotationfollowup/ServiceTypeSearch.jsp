...
#jqxInput{
  ...
  <script type="text/javascript"> 
            ...
            $(document).ready(function () {
           	 ...
           	 var aa1='<%=DAO.serviceTypeSearch(mode,smode,ship)%>';
                ...
                $("#jqxInput").jqxInput({ source: dataAdapter, displayMember: "srvtype", valueMember: "doc_no", width: 200, height: 20});
                      ...
                      if (item) {
                          ...
                          for (var i = 0; i < dataAdapter.records.length; i++) { 
                              if (item.value == dataAdapter.records[i].doc_no) {
                            	  ...
                            	  document.getElementById("hidsrvdoc").value=dataAdapter.records[i].doc_no;
                            	  document.getElementById("srvtype").value=dataAdapter.records[i].srvtype;
