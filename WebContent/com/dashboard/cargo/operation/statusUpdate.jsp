...
<%	
	...
	try{
		 ...
		 if(statusid.equalsIgnoreCase("99")){
			    String sql="update cr_assignment  set pstatus=1, cur_status="+statusid+" where doc_no="+adocno+"";
			    aaa= stmt.executeUpdate(sql);
	     }else{
		        String sql="update cr_assignment  set  cur_status="+statusid+" where doc_no="+adocno+"";   
				aaa= stmt.executeUpdate(sql);
		 }
		 
		 String status=""; 
		 String strSql = "select name from cr_cstatus where doc_no="+statusid+"";    
