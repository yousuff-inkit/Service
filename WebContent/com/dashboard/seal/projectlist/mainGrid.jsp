 ...
 var bb='<%=branchval%>';
    ...
    //alert("==================loadSalikData");
        $(document).ready(function () { 	
        	data= '<%= sd.loadGridData(fromdate,todate,rds,branchval,cldocno,id)%>';     
            ...
            $("#jqxloaddataGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Total(Yearly)', datafield: 'totalyr', width: '10%',cellsalign:'right',cellsformat:'d'+amtdec,align:'right'  },
					{ text: ' Total(One Time)',  datafield: 'totalot', width: '8%',cellsalign:'right',cellsformat:'d'+amtdec,align:'right'  }
	              ]   
            });
            if(bb==5)
        	{
