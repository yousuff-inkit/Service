<%@page import="com.dashboard.seal.invoiceprocessing.ClsInvoiceProcessingDAO"%>
...
$(document).ready(function () { 	
   ...
   $("#jqxinvGrid").on('rowdoubleclick',function(event){
	   ...
	   funRoundRate($("#jqxinvGrid").jqxGrid('getcellvalue',rowindex,'rate'),"txtrate");       
	   var todate = $("#todate").val();  
	   $("#detdiv").load("invdetailGrid.jsp?id="+1+"&trno="+trno+"&todate="+todate);      
   });
});  
