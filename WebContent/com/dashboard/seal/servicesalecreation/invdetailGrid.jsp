...
<%ClsServiceSaleCreationDAO viewDAO=new ClsServiceSaleCreationDAO();%>    
<% String docno = request.getParameter("nipurdoc")==null?"":request.getParameter("nipurdoc").trim(); 
...
if(tempdocno>0){ 
	descdatas='<%=viewDAO.reloadnipurchase(docno, id)%>';  
}else{   
     descdatas=[];
     var list =['GL','HR'];
}   
            ...
            $("#nidescdetailsGrid").jqxGrid(
            {
                ...
                columns: [  
						   { text: 'SL#', sortable: false, filterable: false, editable: false,
							...
							{ text: 'Unit Price', datafield: 'unitprice', width: '7%',cellsalign: 'right', align:'right',cellsformat:'d2',editable: true },
							...
							{ text: 'Net Total', datafield: 'nettotal', width: '9%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,editable:false},
							...
							{ text: 'Type', datafield: 'type', width: '4%',hidden:true, cellsalign: 'center',align: 'center',columntype:'dropdownlist',createeditor: function (row, column, editor) {
	                                editor.jqxDropDownList({ autoDropDownHeight: true, source: list });
	                            }
	     					    },  
							{ text: 'Account', datafield: 'account', width: '4%' ,editable: false,cellsalign: 'center', align:'center'},
							{ text: 'Account Name', datafield: 'accname', width: '15%' ,editable: false},
