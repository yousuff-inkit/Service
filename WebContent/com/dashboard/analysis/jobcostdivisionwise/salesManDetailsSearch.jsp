...
<table width="100%" >
  ...
  <td><table width="100%">
	    ...
	    <td align="left" width="49%"><input type="text" name="sal_name" id="sal_name"  style="width:90%;height:20px;" value='<s:property value="sal_name"/>'></td>
	    <td width="7%" align="right"><label style="font:10px Tahoma;">MOB</label></td>
	    <td width="22%" align="left"><input type="text" name="sl_mob" id="sl_mob" style="width:90%;height:20px;" value='<s:property value="sl_mob"/>'></td>
  ...
  <tr>
    <td><div id="refreshdiv1"><jsp:include  page="salesManDetailsSearchGrid.jsp"></jsp:include> </div></td>
  </tr>
</table>
</div>
</body>
