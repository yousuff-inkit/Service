     ...
     function funExportBtn(){
  	  ...
  	  /*  JSONToCSVCon(pendingdataexcel,'Pending Contract',true); */
    	 ...
    	 $("#pcdiv").excelexportjs({
    		 ...
    		 datatype: 'json', 
    		 dataset: null, 
    		 gridId: "jqxpendcontrGrid", 
    		 columns: getColumns("jqxpendcontrGrid") , 
    		 worksheetName:"Pending Contract"
    		 });
...
<td width="40">
	<table width="100%">
		<tr><td>
	           <div id="pcdiv"><jsp:include page="pendingContractDetails.jsp"></jsp:include></div> 
		</td></tr>
