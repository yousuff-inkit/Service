...
<table width="100%" >
  ...
  <td><table width="100%">
	    ...
	    <td align="left" width="49%"><input type="text" name="Cl_name" id="Cl_name"  style="width:90%;height:20px;" value='<s:property value="Cl_name"/>'></td>
	    <td width="7%" align="right"><label style="font:10px Tahoma;">MOB</label></td>
	    <td width="22%" align="left"><input type="text" name="Cl_mob" id="Cl_mob" style="width:90%;height:20px;" value='<s:property value="Cl_mob"/>'></td>
  ...
  <tr>
    <td><div id="refreshdiv1"><jsp:include  page="clientDetailsSearchGrid.jsp"></jsp:include> </div></td>
  </tr>
</table>
</div>
</body>
