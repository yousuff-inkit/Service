...
function loadAccountSearch() {
	...
	function getAccountDetails(accountsno,accountsname,check){
		 $("#refreshAccountDetailsDiv").load("departmentClassificationLinkSearchGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td align="right" style="font-size:9px;">Department</td>
  ...
  <tr>
    <td colspan="3"><div id="refreshAccountDetailsDiv"><jsp:include page="departmentClassificationLinkSearchGrid.jsp"></jsp:include></div></td>
  </tr>
