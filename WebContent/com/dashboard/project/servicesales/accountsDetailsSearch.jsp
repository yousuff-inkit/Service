...
<script type="text/javascript">
	...
	function getAccountDetails(accountsno,accountsname,mob,check,masterdate){
		 ...
		 $("#refreshAccountDetailsDiv").load("accountsDetailsFromGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&mob='+mob+'&check='+check+'&masterdate='+masterdate+'&atype='+document.getElementById("atype").value);
	}
