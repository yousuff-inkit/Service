...
<%@ page import="com.dashboard.marketing.leadfollowuplog.ClsLeadFollowupLogDAO" %>
 <%
...
<script type="text/javascript">
	...
	if(temp1!='NA')
{
		vehdatas= '<%=cfld.subDetails(fromdate,todate,cldocno) %>';
...
$(document).ready(function () {
    ...
    $('#userdetails').on('rowdoubleclick', function (event) 
    		{ 
    		    ...
    		    $("#fleetdiv").load("detailsgrid.jsp?userid="+userid+"&froms="+'<%=fromdate%>'+"&tos="+'<%=todate%>'+"&cldoc="+'<%=cldocno%>');
