...
<table width="55%">
  <tr>
    ...
    <input type="hidden" name="txtgridservicetypeids" id="txtgridservicetypeids" style="width:80%;height:20px;" value='<s:property value="txtgridservicetypeids"/>'>
    <input type="hidden" name="txtgridscopeids" id="txtgridscopeids" style="width:80%;height:20px;" value='<s:property value="txtgridscopeids"/>'>
    <input type="hidden" name="txtgridscopeproducts" id="txtgridscopeproducts" style="width:80%;height:20px;" value='<s:property value="txtgridscopeproducts"/>'></td>
