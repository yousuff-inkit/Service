...
<%	
	...
	try{
		...
		if(contrmode.equalsIgnoreCase("AMC") || contrmode.equalsIgnoreCase("amc")) {
		    strSql = "select doc_no, scopegroup from my_scopegrp where status=3 and doc_no=3";
		} else if(contrmode.equalsIgnoreCase("SJOB") || contrmode.equalsIgnoreCase("sjob")) {
		    strSql = "select doc_no, scopegroup from my_scopegrp where status=3 and doc_no in (1,2)";
		} else {
		    strSql = "select doc_no, scopegroup from my_scopegrp where status=3";
		}
