					...
					{ text: 'Service Type', datafield: 'stype', width: '75%' }
				           ...
				           $('#jqxstypesearch').on('rowdoubleclick', function (event) 
				            		{ 
				            	 		...
				            	 		$('#qutDetSubGrid').jqxGrid('setcellvalue', rowIndex, "sertype",$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "stype"));
				               			$('#qutDetSubGrid').jqxGrid('setcellvalue', rowIndex, "stypeid",$('#jqxstypesearch').jqxGrid('getcellvalue', rowindex1, "docno"));
