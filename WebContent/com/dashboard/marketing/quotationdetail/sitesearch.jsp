					...
					{ text: 'Site', datafield: 'site', width: '75%' }
				           ...
				           $('#jqxsitesearch').on('rowdoubleclick', function (event) 
				              	...
				              	var rowindex1=event.args.rowindex;
				            	 		$('#qutDetSubGrid').jqxGrid('setcellvalue', rowIndex, "sitesrno",$('#jqxsitesearch').jqxGrid('getcellvalue', rowindex1, "sitesrno"));
				               			$('#qutDetSubGrid').jqxGrid('setcellvalue', rowIndex, "site",$('#jqxsitesearch').jqxGrid('getcellvalue', rowindex1, "site"));
