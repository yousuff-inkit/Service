...
ClsCommon ClsCommon=new ClsCommon();
	...
	try{
		...
		{
			 sql="insert into gl_bqot( date, rdocno, rdtype, fdate, remarks, bibpid, brhid, userid) values( now(), "+docno+", '"+rdtype+"', '"+sqlDate+"', '"+remarks+"', "+bibid+", "+branchid+", "+session.getAttribute("USERID").toString()+")";
		 ...
		 if(proname.equalsIgnoreCase("Dropped"))
			{
				sql="update gl_bqot set status=7 where bibpid="+bibid+" and rdocno="+docno+" ";
