...
<%ClsEnqiryListDAO DAO=new ClsEnqiryListDAO(); %>
        ...
        $(document).ready(function () { 
         //	var url1;
            ...
            $('#jqxareasearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("areaid").value=$('#jqxareasearch').jqxGrid('getcellvalue', rowindex2, "areadocno");
                document.getElementById("txtarea").value=$('#jqxareasearch').jqxGrid('getcellvalue', rowindex2, "area");
