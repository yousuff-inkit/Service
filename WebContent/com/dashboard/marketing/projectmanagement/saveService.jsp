...
int dataval=0;
	try{
		...
		if(temp.equalsIgnoreCase("1")){         
			 ...
			 String sqllog="insert into gl_jobactivitylog(doc_no, brhId, dtype, edate, userId,description) values("+vocno+",'"+branch+"','PJM',now(),'"+session.getAttribute("USERID")+"','"+logdesc+"')";                       
