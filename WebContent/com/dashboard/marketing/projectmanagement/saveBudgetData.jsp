...
try{
	...
	for(int i=0;i<aa.length;i++){
	 ...
	 if(aaa>0){ 
		 ...
		 String sqllog="insert into gl_jobactivitylog(doc_no, brhId, dtype, edate, userId,description) values("+vocno+",'"+brhid+"','PJM',now(),'"+session.getAttribute("USERID")+"','"+logdesc+"')";                       
