 ...
 var assignmode;
   ...
   assignmode='<%=DAO.assignmode(session)%>'; 
        ...
        $(document).ready(function () { 
            ...
            $("#jqxassignsearch").jqxInput({ source: dataAdapter, displayMember: "assign", valueMember: "docno", items: 20 ,width: 170, height: 20,placeHolder: "Enter Assign Method"});
    ...
    <input  type="text" id="jqxassignsearch" class="p-l-5 input-sm form-control"/>