...
<tr><td><h3>LOCATION</h3></td></tr></table>
...
<table id="wrhse" width="95%" class="tablereceipt" align="center">
  ...
  <tr height="28" style="background-color: #D8D8D8;" class="tablereceipt" align="center">
    ...
    <th class="tablereceipt" width="50%" align="left">Location</th>
   
  </tr>
</thead>
<tbody>
  <%int i=0; %>
  <s:iterator var="stat" value='#request.printlocationarray' >
  <%i=i+1;%>
	<tr height="25" class=tablereceipt> 
	   <%--  <td class="tablereceipt" width="4%" align="center"><%=i%></td> --%>
