...
<table width="100%" class="normaltable">
  <tr>
    <td width="30%" rowspan="6"><img src="<%=contextPath%>/icons/fire7headder.png" width="250" height="91"  alt=""/></td>
  ...
  <tr>
   <td rowspan="2"  align="left"><b><font size="5"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font></b></td>
