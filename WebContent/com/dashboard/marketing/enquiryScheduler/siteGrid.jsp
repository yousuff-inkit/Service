...
<% String contextPath=request.getContextPath();%>
 <%ClsenquirySchedulerDAO DAO= new ClsenquirySchedulerDAO(); %>
 <%
    	...
    	if(sitedocno>0){
            ...
            $("#siteGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Survey Type', datafield: 'surtype', width: '27%' ,editable:false},
					
					{text: 'Areaid',datafield:'areaid',width:'25%',editable:false,hidden:true},
					{text: 'surveyid',datafield:'surid',width:'2%',editable:false,hidden:true}
					]
            });
