...
<script type="text/javascript">
       ...
       var type='<%=type%>';
	  	...
	  	<%-- 	 dat2='<%=dao.stockLedgerDetail2(session,hidbrand,fromDate,toDate,hidtype,hidcat,hidsubcat,hidproduct,branchid,hidept,load)%>'; --%>  
	  		detaildata='<%=dao.stockLedgerDetail(session,hidbrand,fromDate,toDate,hidtype,hidcat,hidsubcat,hidproduct,branchid,hidept,load)%>';  
	  	} 
		else{
			detaildata;
	}
...
$(document).ready(function () {
 ...
 var rendererstring=function (aggregates){
    ...
    $("#jqxStockLedgerDetailGrid").jqxGrid(
    {
        width: '98%',
        height: 350,
        source: dataAdapter,
...
<div id="jqxStockLedgerDetailGrid"></div>