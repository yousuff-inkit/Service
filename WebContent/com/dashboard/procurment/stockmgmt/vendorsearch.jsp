...
$(document).ready(function () {
   ...
   catdata='<%=DAO.vendorSearch(session)%>';
       ...
       sortable:false,
        columns: [
					...
					{ text: 'CL_DOCNO',datafield:'cldocno',width:'20%',hidden:true},
       				...
       				{ text:'currate',datafield:'currate',width:'5%',hidden:true},
       				{ text:'chkrcm',datafield:'chkrcm',width:'5%',hidden:true}
    ...
    $('#vendorSearch').on('rowdoubleclick', function (event) {
    	...
    	document.getElementById("currate").value = $('#vendorSearch').jqxGrid('getcellvalue', rowindex1, "currate");
    	document.getElementById("chkrcm").value = $('#vendorSearch').jqxGrid('getcellvalue', rowindex1, "chkrcm");
