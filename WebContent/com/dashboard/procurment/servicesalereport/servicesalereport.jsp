...
function funExportBtn(){
	...
	JSONToCSVCon(rdatasex, 'Service Sale Summary Report', true);
	}
	else if (document.getElementById('rdet').checked) {
		JSONToCSVCon(putdatasex, 'Service Sale Detail Report', true);
	}
}
function funreload(event)
{
	 ...
	 var accdocno=$("#accdocno").val(); 
	   ...
	   if(document.getElementById('rsumm').checked) {
	  $("#listdiv").load("servicesaleGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&fromdocno="
			  +fromdocno+"&todocno="+todocno+"&fromamount="+fromamount+"&toamount="+toamount+"&accdocno="+accdocno);
	         }
	   else if (document.getElementById('rdet').checked) {
		   $("#listdetdiv").load("servicesaledetailGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&fromdocno="
					  +fromdocno+"&todocno="+todocno+"&fromamount="+fromamount+"&toamount="+toamount+"&accdocno="+accdocno);
			         }
		   }
	}
...
<!--  <tr><td colspan="2">&nbsp;</td></tr -->
	...
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="servicesaleGrid.jsp"></jsp:include></div></td>
		</tr>
		    <tr><td><div id="listdetdiv">
				 <jsp:include page="servicesaledetailGrid.jsp"></jsp:include> 
				</div></td></tr> 
	</table>
	</td>
</tr>
