...
<%ClstrademarginreportDAO DAO= new ClstrademarginreportDAO();%>
<%
...
$(document).ready(function () {
   ...
   var proddata;
    ...
    $( "#btnproduct" ).click(function() {
    	...
    	var rows = $("#prodSearch1").jqxGrid('selectedrowindexes');
    	...
    	for(var i=0;i<rows.length;i++){
    		var dummy=$('#prodSearch1').jqxGrid('getcellvalue',rows[i],'prodname');
    		var docno=$('#prodSearch1').jqxGrid('getcellvalue',rows[i],'doc_no');
    		document.getElementById("searchdetails").value+="\n"+dummy;
    		document.getElementById("hidproduct").value+="\n"+dummy;
    		if(i==0){
