...
try{
	...
	String aa[]=poarray.split(",");
		for(int i=0;i<aa.length;i++){
		 ...
		 docval=podao.insert(sqlprocessdate, sqlprocessdate, "0", vndacno, 1, 1.0, del, pay, "", prdtotal, 0.0, 0.0, 0.0, nettotaldown, 0.0, ordervalue, 0, session, "A", "PO", request, descarray, masterarray, "PR", rrefno, 0.0, termsarray, shiparray, 0, 0.0, 0.0, 0.0, 0.0, nettax, 1, 0, 0);
if (docval>0){
