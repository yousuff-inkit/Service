...
<%ClsPurchaseOrderProcessDAO DAO= new ClsPurchaseOrderProcessDAO();%>
...
$(document).ready(function () {
   ...
   catdata='<%=DAO.vendorSearch(session)%>';
       ...
       sortable:false,
        columns: [
					...
					{ text: 'CL_DOCNO',datafield:'cldocno',width:'20%',hidden:true},
       				...
       				{ text:'curate',datafield:'rate',width:'10%',hidden:true}
    ...
    $('#vendorSearch').on('rowdoubleclick', function (event) {
    	...
    	document.getElementById("txtvendor").value = $('#vendorSearch').jqxGrid('getcellvalue', rowindex1, "refname");
    	document.getElementById("hidcurates").value = $('#vendorSearch').jqxGrid('getcellvalue', rowindex1, "rate");
