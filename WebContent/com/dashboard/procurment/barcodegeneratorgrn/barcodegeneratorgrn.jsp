...
function funExportBtn(){
 	if(document.getElementById("txttype").value=="grn")
 		
 	{
 		 $("#searchdiv1").excelexportjs({
				containerid: "searchdiv1",   
				datatype: 'json',
				dataset: null,
				gridId: "Searchgrid1",
				columns: getColumns("Searchgrid1") ,   
				worksheetName:"Barcode Generator GRN"  
			}); 
 	}
 	else if(type=='all')
 		{
 		 $("#searchdiv").excelexportjs({
				containerid: "searchdiv",   
				datatype: 'json',
				dataset: null,
				gridId: "Searchgrid",
				columns: getColumns("Searchgrid") ,   
				worksheetName:"Barcode Generator "  
			}); }	
 		 }
	 ...
	 $("#overlay, #PleaseWait").show();
		...
		var type=document.getElementById("txttype").value;     	 
			 ...
			 if (type=="grn") {
		       ...
		       $("#searchdiv1").load("grnGrid.jsp?load=load");
...
function funClearData(){
	 ...
	 document.getElementById("hidjdeno").value="";
	 document.getElementById("hidbhno").value="";
...
function setRemove(){
	...
	if(document.getElementById("hidept").value!=""){
		...
		function funGenerate()
		{
			         ...
			         var reurl=url.split("barcodegeneratorgrn.jsp");
			         
			         
		 
		
			 var win= window.open(reurl[0]+"printBarcodegrn?docno="+document.getElementById("psrno").value+"&cmbtype="+document.getElementById("cmbtype").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
			 win.focus();
...
<option value="">--Select--</option>
    ...
    <option value="product">PRODUCT</option>
	  ...
	  <tr >
	  <td align="centre" >&nbsp;&nbsp;<label class="branch">Type</label></td>
	  <td  align="left"><select name="txttype" id="txttype" style="width:80%;"> 
    <option value="all">All products</option>
    <option value="grn">GRN</option></select></td>
    </tr>
...
<legend><b>Generate</b></legend>
	...
	<tr>	 <td>         <input type="hidden" name="mode" id="mode" value='<s:property value="mode"/>'>
			  ...
			  <input type="hidden" name="hidjdeno" id="hidjdeno">
			  <input type="hidden" name="hidbhno" id="hidbhno">
...
<td width="80%">
	<table width="100%">
		...
		<tr>
		<td>		<div id="searchdiv1"><jsp:include page="grnGrid.jsp"></jsp:include></div> </td>
