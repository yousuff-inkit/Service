...
<script type="text/javascript">
	$(document).ready(function () {
   		...
   		if(id=='1'){
	   		purchaseorderdata='<%=DAO.getPurchaseOrderData(id,uptodate)%>';
		}
    // prepare the data
    	var source =
    	{
        	...
        	datafields: [
                ...
                {name : 'interoutqty',type:'number'},
                {name : 'interbalqty',type:'number'},
    	...
    	$("#purchaseOrderGrid").jqxGrid(
    	{
        	...
        	columns: [
            	...
            	{ text: 'Vendor Doc.No',datafield:'cldocno',width:'10%',hidden:true},
            	...
            	{ text: 'IC Out Qty',datafield:'interoutqty',width:'4%',cellsformat:'d2',align:'right',cellsalign:'right'},
            	{ text: 'IC Bal.Qty',datafield:'interbalqty',width:'4%',cellsformat:'d2',align:'right',cellsalign:'right'},
