...
<script type="text/javascript">
	$(document).ready(function () {
   		var id='<%=id%>';
   		var modaldelnotedata=[];
   		if(id=='1'){
   			modaldelnotedata='<%=DAO.getModalDelNoteData(id,cldocno,detrowno,brhid,date)%>';
		}
    ...
    // prepare the data
    	...
    	$("#modalDelNoteGrid").on('cellendedit', function (event){
    		
    		var dataField = event.args.datafield;
    		var rowBoundIndex = event.args.rowindex;
    		var value = args.value;
    		funmodalDelNoteGridChange(dataField,rowBoundIndex,value);
			
    	});
	});
	
	function funmodalDelNoteGridChange(datafield,rowindex,value){
		var qty=$('#modalDelNoteGrid').jqxGrid('getcellvalue',rowindex,'qty');
		var unitprice=$('#modalDelNoteGrid').jqxGrid('getcellvalue',rowindex,'unitprice');
		var discountpercent=$('#modalDelNoteGrid').jqxGrid('getcellvalue',rowindex,'discountpercent');
		var discountvalue=$('#modalDelNoteGrid').jqxGrid('getcellvalue',rowindex,'discountvalue');
		var taxpercent=$('#modalDelNoteGrid').jqxGrid('getcellvalue',rowindex,'taxpercent');
		...
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'total',total);
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'discountpercent',discountpercent);
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'discountvalue',discountvalue);
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'nettotal',subtotal);
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'taxamount',taxvalue);
		$('#modalDelNoteGrid').jqxGrid('setcellvalue',rowindex,'taxtotal',taxtotal);
	}
</script>
<div id="modalDelNoteGrid"></div>