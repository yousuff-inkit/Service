...
<script type="text/javascript">
	$(document).ready(function () {
   		...
   		var grndata=[];
   		if(id=='1'){
   			grndata='<%=DAO.getGRNData(id,uptodate)%>';
		}
    // prepare the data
    	var source =
    	{
    	...
    	$("#GRNGrid").jqxGrid(
    	{
        	...
        	columns: [
        		...
        		{ text: 'Branch',datafield:'branch',width:'6%'},
            	...
            	{ text: 'Vendor #',datafield:'cldocno',width:'5%',hidden:true},
            	{ text: 'Vendor',datafield:'refname',width:'10%'},
            	...
            	{ text: 'Product',datafield:'product',width:'6%'},
            	{ text: 'Product Name',datafield:'productname',width:'23.6%'},
            	...
            	{ text: 'Unit Price',datafield:'unitprice',width:'6%',cellsformat:'d2',align:'right',cellsalign:'right',hidden:true},
            	{ text: 'Total',datafield:'total',width:'6%',cellsformat:'d2',align:'right',cellsalign:'right',hidden:true},
            	{ text: 'Tax Amount',datafield:'taxamount',width:'6%',cellsformat:'d2',align:'right',cellsalign:'right',hidden:true},
            	{ text: 'Net Total',datafield:'taxtotal',width:'6%',cellsformat:'d2',align:'right',cellsalign:'right',hidden:true}
            ]
		});
	});
</script>
