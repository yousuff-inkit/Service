...
function getclinfo(event){
 ...
 function funreload(event){
	 ...
	 var id=1;
	 $("#serCountgrid").load("countgrid.jsp?id="+id+"&clientid="+clientid+"&portid="+portid+"&fromdate="+fromdate+"&todate="+todate);
	}

 function funExportBtn(){
	  JSONToCSVCon(data,'Fuel Status',true);
 } 
 function funClear(){
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	      ...
	      <tr>
           ...
           <tr>
	          <td colspan="2" ><div id="serCountgrid"><jsp:include page="countgrid.jsp"></jsp:include></div></td>
	       </tr>
              <tr><td colspan="2">&nbsp;</td></tr>
...
<td width="80%">
		<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="fsGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
	</td>
</tr>
