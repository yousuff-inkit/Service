...
<script type="text/javascript">
       ...
       var data1= '<%=DAO.clientDetailsSearch(partyname, chk)%>';  
    	   ...
    	   // prepare the data
            ...
            $("#clientDetailsSearchGridID").jqxGrid(
            {
             ...
             $('#clientDetailsSearchGridID').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtclientname").value = $('#clientDetailsSearchGridID').jqxGrid('getcellvalue', rowindex1, "refname");
