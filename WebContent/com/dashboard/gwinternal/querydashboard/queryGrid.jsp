...
<%ClsQueryDashboardDAO floordao=new ClsQueryDashboardDAO();
...
var floordata=[];
if(id=="1"){
	floordata='<%=floordao.getQueryData(id,comprefid,empdocno,type)%>';
}
        ...
        var source =
        {
            ...
            datafields: [
 						...
 						{name : 'formname',type:'string'},
                      	...
                      	{name : 'maxfollowdate',type:'date'} ,
                      	{name : 'age',type:'string'},
                      	{name : 'indcode',type:'string'},
                      	{name : 'eddate',type:'date'},
                      	{name : 'deptype',type:'string'},

                      	{name : 'deptypeid',type:'string'},
        ...
        $("#queryGrid").jqxGrid(
                {
                    ...
                    columns: [
    					...
    					{ text: 'Last Assigned Date',datafield: 'maxfollowdate', width: '8%',cellclassname: cellclassname,cellsformat:'dd.MM.yyyy HH:mm'},
    					{ text: 'Ind Code',datafield: 'indcode', width: '4%',cellclassname: cellclassname},
    					...
    					{ text: 'Age',datafield: 'age',width:'5%' ,cellclassname: cellclassname},
    					{ text: ' Exp.Delivery Date',datafield: 'eddate', width: '8%',cellclassname: cellclassname,cellsformat:'dd.MM.yyyy'},
    					...
    					{ text: 'Department',datafield: 'deptype', width: '10%',cellclassname: cellclassname},
    					{ text: 'Department Id',datafield: 'deptypeid', width: '10%',cellclassname: cellclassname,hidden:true},
				...
				{ 
					...
					$('#cmbedeptype1').val($('#queryGrid').jqxGrid('getcellvalue',boundIndex,'deptype'));
					$('#eddate1').val($('#queryGrid').jqxGrid('getcellvalue',boundIndex,'eddate'));
