...
try{
	...
	String strgetdept="select doc_no,type from gw_dept ";
			ResultSet rsgetdept=stmt.executeQuery(strgetdept);
			JSONArray deptarray=new JSONArray();
			while(rsgetdept.next()){
				JSONObject objtemp=new JSONObject();
				objtemp.put("docno",rsgetdept.getString("doc_no"));
				objtemp.put("type",rsgetdept.getString("type"));
				deptarray.add(objtemp);
