            ...
            $("#companylistdGridID").jqxGrid(
            {
                ...
                columns: [
                		{ text: 'SL#', sortable: false, filterable: false, editable: false,
                            ...
                            return "<center><div style='margin:5px;'>" + (value + 1) + "</div></center>";}},
						...
						{ text: 'Company Id', datafield: 'comp_id', editable:false, width: '7%'},
						{ text: 'Company', datafield: 'company',editable:false, width:'27%'},
						{ text: 'Comment', datafield: 'comment', editable:false, width: '42%' },
	                    ]
            });
            
            if(temp=="0"){
                $("#companylistdGridID").jqxGrid("addrow", null, {});
            }
