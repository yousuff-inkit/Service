...
{ 
	 ...
	 datas2='<%=searchDAO.reordersearch(barchval,fromdate,todate,type,brandid,catid,subcatid,psrno,load,levelcount)%>';  
	 
	 dat2='<%=searchDAO.reordersearchex(barchval,fromdate,todate,type,brandid,catid,subcatid,psrno,load,levelcount)%>';  
		// alert(enqdata); --%>
...
{name : 'productname', type: 'String'  },
  ...
  {name : 'reorderqty', type: 'number'  },	
    ...
    $("#tobeorderdgrid").jqxGrid(
    {
        ...
        columns: [   	
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
                      groupable: false, draggable: false, resizable: false,cellclassname: cellclassname, pinned: true,
         ...
         /*             { text: 'psrno', datafield: 'psrno',  width: '10%' ,hidden:true,cellclassname: cellclassname},
                     { text: 'Product Id', datafield: 'part_no',  width: '12%' ,editable: false,cellclassname: cellclassname},
                     { text: 'Product Name', datafield: 'productname',  width: '32%',editable: false,cellclassname: cellclassname }, 
                     
                     { text: 'Brand Name', datafield: 'brand',  width: '15%',editable: false,cellclassname: cellclassname }, 
           	   		 { text: 'Type', datafield: 'type',  width: '10%' ,editable: false,cellclassname: cellclassname},
           	   		 { text: 'Stock Qty ', datafield: 'stkqty',  width: '8%' ,editable: false,cellclassname: cellclassname, cellsformat: 'd2'},
           	   		 { text: 'Reorder Level', datafield: 'reorderlevel',  width: '8%' ,editable: false,cellclassname: cellclassname, cellsformat: 'd2'},
           	 		 { text: 'Reoder Qty', datafield: 'reorderqty',  width: '8%' ,editable: false,cellclassname: cellclassname, cellsformat: 'd2'}, */
               	...
               	{ text: 'Stock value', datafield: 'stockprice',  width: '7%' ,editable: false ,cellsformat:'d2',cellclassname: cellclassname},
            	     ...
            	     { text: 'Avg Purchase/Month', datafield: 'averagepurchasepermonth',  width: '8%',cellsformat:'d2' ,editable: false,cellclassname: cellclassname},
               	   ...
               	   { text: 'cellselects', datafield: 'cellselects',  width: '8%'  ,editable: false,cellclassname: cellclassname,hidden:true},
   ...
   if(temp4=='NA')
    	{ 
    	  $("#tobeorderdgrid").jqxGrid('addrow', null, {});
    	}  
   
   
   
   
   $('#tobeorderdgrid').on('rowselect', function (event) {
   	
  
		 $('#btnupdates').attr("disabled", false);
   ...
   $('#tobeorderdgrid').on('rowselect', function (event) {
	   ...
	   $('#tobeorderdgrid').jqxGrid('setcellvalue',rowindex1, "cellselects",1);
  
		 $('#btnupdates').attr("disabled", false);
		 
   });
   
   $('#tobeorderdgrid').on('rowunselect', function (event) {
	   var rowindex1= event.args.rowindex;
	   
	   $('#tobeorderdgrid').jqxGrid('setcellvalue',rowindex1, "cellselects",0);
