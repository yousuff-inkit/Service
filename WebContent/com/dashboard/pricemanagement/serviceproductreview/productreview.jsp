...
function funreload(event)
{
  ...
  function save(){
	...
	x.open("GET","pricesavedata.jsp?psrno="+document.getElementById("psrno").value+'&std_cost='+document.getElementById("std_cost").value+'&fixing='+document.getElementById("fixing").value+"&labourcharge="+document.getElementById("labourcharge").value);
		x.send();
	}
