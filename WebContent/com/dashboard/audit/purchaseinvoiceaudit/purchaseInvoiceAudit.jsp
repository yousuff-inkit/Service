...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="purchaseInvoiceAuditGrid.jsp"></jsp:include></div></td>
		</tr>
		<tr>
			 <td><div id="listDetailDiv"><jsp:include page="purchaseInvoiceAuditGridDetail.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
