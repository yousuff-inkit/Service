...
<% String contextPath=request.getContextPath();%>
 ...
 %>
    ...
    $(document).ready(function () { 
    	chkserviceteam();
   	    if(docno>0){
    		sitedata='<%=DAO.serviceSiteGridLoading(session,docno,dtype)%>';
    	} 
            ...
            $("#siteGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{text: 'Contact Person',datafield:'contper',width:'15%',editable:false},
					{text: 'Contact Tel',datafield:'contmob',width:'10%',editable:false},
					{text: 'Area',datafield:'area',width:'15%',editable:false},
            ...
            $('#siteGrid').on('celldoubleclick', function(event) 
 		     ...
 		     if(datafield=="contper")
	    	   {
 		    	var clientid=document.getElementById("txtselectedcontractclient").value;
