 ...
 <%@page import="com.dashboard.audit.purchaseInvoiceReturn.ClsPurchaseinvoiceRetDAO"%>
 <% ClsPurchaseinvoiceRetDAO searchDAO = new ClsPurchaseinvoiceRetDAO(); 
...
{ 
	 ...
	 datas='<%=searchDAO.purchaseInvoiceReturnGrid(barchval,fromdate,todate)%>'; 
		// alert(enqdata); --%>
} 
else
{ 
...
$(document).ready(function () {
   ...
   var rendererstring=function (aggregates){
    ...
    $('#purchasereturnlist').on('rowdoubleclick', function (event) {
       var rowindex1 = event.args.rowindex;
       $('#audit').attr('disabled',false);
       document.getElementById("docno").value= $('#purchasereturnlist').jqxGrid('getcellvalue', rowindex1, "doc_no");  
	   $("#listDetailDiv").load("purchaseInvoiceReturnGridDetail.jsp?doc_no="+$('#purchasereturnlist').jqxGrid('getcellvalue', rowindex1, "doc_no"));
    });  
