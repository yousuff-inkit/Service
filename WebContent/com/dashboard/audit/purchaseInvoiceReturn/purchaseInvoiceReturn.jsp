...
function funreload(event)
{
	 ...
	 $("#listdiv").load("purchaseInvoiceReturnGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate);
			 ...
			 if(parseInt(items)>=1)
				 {
					...
					// $("#listdiv").load("salesqotfolowupGrid.jsp?docno="+docno);
					 $("#detailpurchasereturnlist").jqxGrid('clear');
					 $('#docno').val("");
					 $('#audit').attr('disabled',true);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="purchaseInvoiceReturnGrid.jsp"></jsp:include></div></td>
		</tr>
		<tr>
			 <td><div id="listDetailDiv"><jsp:include page="purchaseInvoiceReturnGridDetail.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
