...
<script type="text/javascript">
	$(document).ready(function () {}); 
 	...
 	function loadContractSearch() {
		...
		getdata(contractType,contractno);
	}
 	
	function getdata(contractType,contractno){
		 $("#refreshcontractdiv").load('contractDetailsSearchGrid.jsp?contracttype='+contractType+'&contractno='+contractno.replace(/ /g, "%20")+'&id='+1);
	}
