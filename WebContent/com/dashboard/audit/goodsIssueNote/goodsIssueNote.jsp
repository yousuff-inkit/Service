...
function funExportBtn(){
	  $("#listdiv").excelexportjs({
		...
		datatype: 'json', 
		dataset: null, 
		gridId: "goodsissuenote", 
		columns: getColumns("goodsissuenote") , 
		worksheetName:" Goods Issue Note Audit"  
		}); 
      ...
      $("#listDetailDiv").excelexportjs({
		...
		datatype: 'json', 
		dataset: null, 
		gridId: "goodsIssueNoteGrd", 
		columns: getColumns("goodsIssueNoteGrd") ,    
		worksheetName:" Goods Issue Note Audit"
		}); 		
	 }
