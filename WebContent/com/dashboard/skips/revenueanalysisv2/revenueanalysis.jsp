...
$(document).ready(function () {
	...
	$("#todate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy"});
	 ...
	 var lastmonth=new Date(new Date(onemounth).setMonth(onemounth.getMonth()-1));
	    
     $('#fromdate').jqxDateTimeInput('setDate', lastmonth);
     funChangeGroup();
});
        				...
        				<tr><td width="30%"  align="right" ><label class="branch">Group By</label></td>
          				<td>
          				    <select  id="cmbgroupby" name="cmbgroupby" style="width:99%;" onchange="funChangeGroup();">       
			      				...
			      				<option value="CL">Client</option><option value="AT">Actual Trip</option><option value="TF">Tipping Fee</option>    
			      			</select>
        				</td></tr>  
        				<tr><td></td>
          				<td>
