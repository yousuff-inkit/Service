        ...
        $(document).ready(function () { 	
                ...
                datafields: [
                	...
                	{name : 'contracttype', type: 'String'  },
                  	{name : 'sal_name', type: 'String'  },
       	            ...
       	            {name : 'clgroup', type: 'number'  },
       	       	    {name : 'wastetype', type: 'String'  },
                  	{name : 'ownership', type: 'String'  },
                  	{name : 'ownership', type: 'String'  },
                  	{name : 'tipfee', type: 'String'  },
                  	{name : 'nooftrips', type: 'String'  },	
                  	{name : 'srvhrg', type: 'String'  },
            ...
            $("#detailGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Account', datafield: 'acc', width: '21%' },
					{ text: 'Description', datafield: 'account', width: '18%' },
					{ text: 'Group', datafield: 'clgroup', width: '6%' },
					{ text: 'Contract Type', datafield: 'contracttype', width: '5%' },
					{ text: 'Salesman', datafield: 'sal_name', width: '15%' },
					{ text: 'Skip Size', datafield: 'skipsize', width: '11%' },
					{ text: 'Waste Type', datafield: 'wastetype', width: '18%' },
					{ text: 'Ownership', datafield: 'ownership', width: '7%' },
					{ text: 'TippingFee Type', datafield: 'tipfee', width: '6%' },
					{ text: 'No.of.Trips', datafield: 'nooftrips', width: '6%' ,cellsformat:'d2',cellsalign:'right',align:'right', aggregates: ['sum'],aggregatesrenderer:rendererstring},
					{ text: 'Service Charges', datafield: 'srvhrg', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right', aggregates: ['sum'],aggregatesrenderer:rendererstring },
