         ...
         //	var url1;
            ...
            $("#jqxactivitysearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Designation', datafield: 'ay_name'  }
					]
            });
				           $('#jqxactivitysearch').on('rowdoubleclick', function (event) 
				              	...
				              	$('#cntdesg').val($('#jqxactivitysearch').jqxGrid('getcellvalue', rowindex1, "ay_name"));
		               			$('#hidcntdesgid').val($('#jqxactivitysearch').jqxGrid('getcellvalue', rowindex1, "adocno"));
