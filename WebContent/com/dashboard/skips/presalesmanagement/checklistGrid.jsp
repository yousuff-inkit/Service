...
.orangeClass {
    ...
    function ajaxFileUpload(rowno,qotno) {
  	 ...
  	 var formdetailcode="PSM";  
        ...
        (  
            {
                url:'fileUploadPresales.action?formdetailcode='+formdetailcode+'&doc='+document.getElementById("enqdocno").value+'&srno='+rowno+'&cldocno='+$("#cldocno").val()+'&brhid='+$("#brhid1").val()+'&attachdesc='+attachdesc+'&quotno='+qotno+'&qottrno='+$("#qottrno").val(),       
    ...
    function fileDelete(row,qotno){
		...
		x.open("GET","deleteAttach.jsp?docno="+row, true);
		x.send();
    }
