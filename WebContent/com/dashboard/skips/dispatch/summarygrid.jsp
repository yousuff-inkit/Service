    	...
    	ccdata='<%=DAO.SummaryData(session,id,fromdate,todate)%>';  
            ...
            $("#jqxsummarygrid").jqxGrid(
            {
                ...
                columns: [{ text: 'SL#', sortable: false, filterable: false, editable: false,
					...
					{ text: 'Dispatch Date', datafield: 'disdate', width: '5%',cellsformat:'dd.MM.yyyy',editable:false },
					{ text: 'Acknowledged Date', datafield: 'ackdate', width: '5%',cellsformat:'dd.MM.yyyy',editable:false },	
