...
ClsConnection ClsConnection=new ClsConnection();  
	...
	try{
		...
		String strSql = "select dl.slno,concat(dl.slno,' - ',sk.name) skip from sk_srvcontrdel dl left join sk_skipm sk on sk.doc_no=dl.skipid left join sk_srvcontrsch sc on (sc.delid=dl.doc_no and sc.pskipno=dl.skipid) where dl.rdocno='"+contrno+"' and dl.srno='"+srno+"' and dl.skipid!=0 and sc.doc_no is null";
