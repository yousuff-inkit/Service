...
<%@page import="com.dashboard.skips.contractskiptariff.ClsContractSkipTariffDAO" %>
<%
        ClsContractSkipTariffDAO DAO= new ClsContractSkipTariffDAO();        
...
$(document).ready(function () {   	
             var num = 1; 
        		 quotedata='<%=DAO.cstLoad(id,fromdate,todate)%>';               
            // prepare the data
           ...
           var rendererstring1=function (aggregates){
            ...
            $("#jqxContractGrid").jqxGrid(  
            {
                ...
                columns: [
                        	...
                        	{ text: 'Billing Method', datafield: 'billingmethod', width: '7%' ,editable:false},	
							...
							{ text: 'Rate', datafield: 'rate', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname1  },
							{ text: 'Tariff', datafield: 'tariffrate', width: '7%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname2 },
