        ...
        $(document).ready(function () { 
            ...
            $("#vehgrpGrid").jqxGrid(
            {
             ...
             $('#vehgrpGrid').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("hidvehgroupid").value = $('#vehgrpGrid').jqxGrid('getcellvalue', rowindex1, "doc_no");
                document.getElementById("txtvehgroup").value = $('#vehgrpGrid').jqxGrid('getcellvalue', rowindex1, "gname");
