...
function funNotify(validtotal){  
		...
		document.getElementById("frminvprocessing").submit();              
	} 
...
<form id="frminvprocessing" action=saveInvoiceProcessing method="post">         
