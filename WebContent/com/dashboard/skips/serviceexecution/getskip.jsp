...
%>
 ...
 String skiptype=request.getParameter("skiptype")==null?"":request.getParameter("skiptype").trim().toString();  
  String selectedskips=request.getParameter("selectedskips")==null?"":request.getParameter("selectedskips").trim().toString();%>     
 ...
 skiptype='<%=DAO.skipSearch(session,skiptype,selectedskips)%>';     
				           ...
				           $('#jqxskipsearch').on('rowdoubleclick', function (event)    
				            		{ 
				              	        var rowindex1=event.args.rowindex;
				               			$('#jqxschdelGrid').jqxGrid('setcellvalue', rowIndex, "skip",$('#jqxskipsearch').jqxGrid('getcellvalue', rowindex1, "name"));
				               			$('#jqxschdelGrid').jqxGrid('setcellvalue', rowIndex, "skipid",$('#jqxskipsearch').jqxGrid('getcellvalue', rowindex1, "doc_no"));
