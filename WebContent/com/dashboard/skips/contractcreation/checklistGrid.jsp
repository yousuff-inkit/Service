...
.orangeClass {
    ...
    $(document).ready(function () { 
            ...
            $("#jqxChecklistGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Upload', width:'20%', columntype: 'custom',datafield:'upload', cellbeginedit: function (row) {
    ...
    function fileDelete(row,qotno){
		...
		x.open("GET","deletefile.jsp?docno="+row, true);
		x.send();
    }
    function ajaxFileUpload(rowno,qotno) {
  	 ...
  	 var formdetailcode="CNC";    
        $.ajaxFileUpload  
        (  
            {  
                url:'fileUploadPresales.action?formdetailcode='+formdetailcode+'&doc='+document.getElementById("enqdocno").value+'&srno='+rowno+'&cldocno='+$("#cldocno").val()+'&brhid='+$("#brhid1").val()+'&attachdesc='+attachdesc+'&quotno='+qotno,      
