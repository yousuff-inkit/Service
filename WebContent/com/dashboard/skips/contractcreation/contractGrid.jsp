    	 ...
    	 var divname = $("#divname").val();
		   if(divname!=""){  
			   if(divname=="amc"){     
				   ...
				   $("#enqlistgrid").jqxGrid('hidecolumn', 'strtdate');
				   $("#enqlistgrid").jqxGrid('hidecolumn', 'enddate');
    ...
    $("#enqlistgrid").jqxGrid(
    {
        ...
        columns: [   
                  /* { text: 'SL#', sortable: false, filterable: false, editable: false,
                    ...
                    { text: 'Enq Date', datafield: 'date', width: '4%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname },
                    { text: 'Cont. Date', datafield: 'cntdate', width: '5%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname },
                    { text: 'Contract No',datafield: 'condocno', width: '4%' ,cellclassname: cellclassname},
                    { text: 'Qot No',datafield: 'qotno', width: '4%' ,cellclassname: cellclassname },
                    { text: 'Branch',datafield: 'branchname', width: '6%' ,cellclassname: cellclassname },
                    { text: 'Salesman', datafield: 'salm', width: '12%',cellclassname: cellclassname },
                    { text: 'Existing Client/New', datafield: 'clienttype', width: '7%',cellclassname: cellclassname },
                    { text: 'Group Companies', datafield: 'groupcompanies', width: '12%' ,cellclassname: cellclassname }, 
					...
					{ text: 'START Date', datafield: 'strtdate', width: '5%',cellclassname: cellclassname },
					{ text: 'END Date', datafield: 'enddate', width: '5%',cellclassname: cellclassname },
					{ text: 'Skip Size', datafield: 'skipsize', width: '5%',cellclassname: cellclassname },
					...
					{ text: 'Rate per collection', datafield: 'ratee', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname },
					{ text: 'Skip Rent', datafield: 'rent', width: '6%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname },  
					{ text: 'Tipping Fee', datafield: 'tfee', width: '5%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname ,cellsalign:'right',align:'right' },
					{ text: 'Tipping Fee', datafield: 'tfeee', width: '5%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname ,cellsalign:'right',align:'right' },
					{ text: 'Whole value', datafield: 'cntvalue', width: '5%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname ,cellsalign:'right',align:'right'},
					{ text: 'Whole value', datafield: 'qntvalue', width: '5%',cellsformat:'d2',cellsalign:'right',align:'right',cellclassname: cellclassname ,cellsalign:'right',align:'right'},
					...
					{ text: 'Contract Doc Status', datafield: 'cntdocstatus', width: '5%',cellclassname: cellclassname },
					...
					{ text: 'QOT Flwp Date', datafield: 'fdate', width: '5%',cellsformat:'dd.MM.yyyy' ,cellclassname: cellclassname },
				    { text: 'QOT Status', datafield: 'fstatus', width: '5%',cellclassname: cellclassname,hidden:true },
					{ text: 'Age (Hrs)', datafield: 'age', width: '4%' , cellsalign:'right',cellclassname: cellclassname,cellsalign:'right',align:'right' },
					...
					{ text: 'Contact person', datafield: 'cperson', width: '6%',cellclassname: cellclassname },
					{ text: 'Designation', datafield: 'designation', width: '6%',cellclassname: cellclassname },
					...
					{ text: 'qotrevno', datafield: 'qotrevno', width: '20%',hidden:true ,cellclassname: cellclassname },
					{ text: 'Source', datafield: 'source', width: '6%',cellclassname: cellclassname },
					{ text: 'Remarks', datafield: 'remarks', width: '14%',cellclassname: cellclassname },
			 ]
    });
    $('.load-wrapp').hide();
