         ...
         //	var url1;
            ...
            $("#jqxskipsizeSearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Doc No', datafield: 'skiptypeid', width: '20%',hidden :true },
          ...
          //  $("#jqxskipsearch").jqxGrid('addrow', null, {});
				           ...
				           $('#jqxskipsizeSearch').on('rowdoubleclick', function (event) 
				              	...
				              	var rowindex1=event.args.rowindex;
				             	  ...
				             	  document.getElementById("txtskipsizeid").value=$('#jqxskipsizeSearch').jqxGrid('getcellvalue', rowindex1, "skiptypeid");
