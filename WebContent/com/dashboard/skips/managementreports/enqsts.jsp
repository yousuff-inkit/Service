             ...
             var source =
	          {
	              ...
	              datafields: [
								...
								{name : 'salname', type: 'string'  },
	                         	...
	                         	{name : 'monthnamechart', type: 'string'  },
...
//         
 ...
 <div  class="col-xs-12" id="ofrgrid">
    ...
    <td width="10%" align="center"><strong>Value</strong></td>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" ><div id='jqxEnqChart' style="margin-top: 1px; width: 1300px; height: 400px; position: relative;">
    </div></div>
