<%@page import="com.dashboard.skips.advinvoiceproessing.*" %>
                ...
                columns: [     
		                	 { text: 'SL#', sortable: false, filterable: false,cellclassname:cellclassname,            
		                      ...
		                      { text: 'Site', datafield: 'site',width:'8%',cellclassname:cellclassname},   
		                  	  ...
		                  	  { text: 'Trips', datafield: 'totaltrips', width: '4%',cellsformat:'d0',cellsalign:'right',align:'right',cellclassname:cellclassname  },
