...
function funNotify(){  
		...
		document.getElementById("frminvprocessingadv").submit();              
	} 
...
<form id="frminvprocessingadv" action=saveInvoiceProcessingadv method="post">           
			...
			<td width="20%" >
			    <fieldset style="background: #ECF8E0;">
					<table width="100%"  >
				        ...
				        <tr><td colspan="2"><center><input type="hidden" name="btnloadcontracts" id="btnloadcontracts" class="myButton" value="Load" onclick="funLoadContracts();"></center></td></tr>     
						...
						<tr><td colspan="2"><center><input type="button" name="btninvoicesave" id="btninvoicesave" class="myButton" value="Generate" onclick="funGenerate();"></center></td></tr> 
