...
{  
	  ...
	  rdatas='<%=ReportsDAO.nipurchaseorderdetailsReports(barchval,fromdate,todate,fromdocno,todocno,fromamount,toamount,accdocno,type)%>'; 
	  rdatasdetailsex='<%=ReportsDAO.nipurchaseorderdetailsReportsex(barchval,fromdate,todate,fromdocno,todocno,fromamount,toamount,accdocno,type)%>'; 
    ...
    $("#orderlistdetails").jqxGrid(
    {
        ...
        columns: [   
                  { text: 'SL#', sortable: false, filterable: false, editable: false,
					 ...
					 { text:'Issued Qty',datafield:'issuedqty', width:'5%'},
					 ...
					 { text: 'Tax Per', datafield: 'taxper', width: '10%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring  },
					 ...
					 { text: 'Net Tax Amount', datafield: 'nettaxamount', width: '10%',cellsformat:'d2',cellsalign:'right',align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring  },
