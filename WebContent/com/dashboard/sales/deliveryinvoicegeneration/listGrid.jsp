  	...
  	$(document).ready(function () {
  	   ...
  	   var rendererstring=function (aggregates){
  	    ...
  	    var cellclassname =  function (row, column, value, data) {
  	   	  ...
  	   	  var ss= $('#salorderlistgrid').jqxGrid('getcellvalue', row, "clstatus");
  	   		          if(parseInt(ss)>0)
  	   		  		{
  	  ...
  	  */
  	    ...
  	    $('#salorderlistgrid').on('cellclick', function (event) 
  	    		{ 
  	    	 $("#sidelistgrid1").jqxGrid({ disabled: false});
  		   ...
  		   document.getElementById("locationid").value=$('#salorderlistgrid').jqxGrid('getcellvalue', rowindex1, "locdoc");
			   
			 document.getElementById("txtlocation").value=$('#salorderlistgrid').jqxGrid('getcellvalue', rowindex1, "loc_name");
			   
			   
			 document.getElementById("description").value=$('#salorderlistgrid').jqxGrid('getcellvalue', rowindex1, "description");
