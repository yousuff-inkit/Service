...
{  
	...
	function funsavedatats()
	{
	  ...
	  return 0;
	    ...
	    for(var i=0 ; i < selectedrows.length ; i++){
	    	...
	    	vatype=$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[0],'vattype');
	    	clntacno=$("#dellistgrid").jqxGrid('getcellvalue',selectedrows[0],'account');
	...
	function ajaxcall(list,vatype,clntacno)

	{
		...
		x.onreadystatechange=function(){
		  ...
		  x.open("GET","savedata.jsp?list="+list+"&masterdoc_no="+masterdoc_no+"&branchvals="+branchvals+"&date="+$("#date").val()+"&duedate="+$("#duedate").val()+"&refnos="+document.getElementById("refnos").value+"&description="+document.getElementById("description").value.replace(/ /g,"%20")+"&locationid="+document.getElementById("locationid").value+"&list1="+list1+"&clntacno="+clntacno+"&vatype="+vatype); 
		x.send();
	}
