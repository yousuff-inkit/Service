            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
                ...
                columns: [
                            { text: 'Doc No',  datafield: 'doc_no', width: '10%' },
						 	{ text: 'Name', datafield: 'description', width: '60%' },
							{ text: 'MOB', datafield: 'mobile', width: '30%' },
             ...
             $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("acno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                 ...
                 document.getElementById("account").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "description");
