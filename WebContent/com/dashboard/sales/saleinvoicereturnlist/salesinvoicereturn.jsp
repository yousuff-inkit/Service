...
function funExportBtn(){
	//   $("#invretunlist").jqxGrid('exportdata', 'xls', 'Sales Invoice Return List');
	   
	   JSONToCSVCon(datass, 'Sales Invoice Return List', true);
...
function funreload(event)
{
	 ...
	 var acno=$("#acno").val();
	  ...
	  $("#listdiv").load("salesinvoicereturnGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="salesinvoicereturnGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
