...
function funExportBtn(){
	   ...
	   JSONToCSVCon(datasexcel, 'Sales Enquiry Cancel List', true);
...
function funreload(event)
{
	 ...
	 /* var statusselect=$("#statusselect").val(); */
	  ...
	  $("#listdiv").load("salesEnquiryCancelGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="salesEnquiryCancelGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
