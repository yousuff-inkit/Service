    ...
    $("#orderlistgrid").jqxGrid(
    {
        ...
        columns: [   
         		...
         		/* 	 { text: 'Ref No',datafield: 'ref_no', width: '10%' }, */
         		     ...
         		     { text: 'Client Id', datafield: 'account',  width: '5%'  },
                     { text: 'Client Name', datafield: 'acname',  width: '14%'  },
           	   ...
           	   /*       { text: 'Unit', datafield: 'unit',  width: '5%' }, */
		           	 ...
		           	 { text: 'rdocno ', datafield: 'rdocno', width: '6%' ,editable:false, filterable: false,hidden:true},
