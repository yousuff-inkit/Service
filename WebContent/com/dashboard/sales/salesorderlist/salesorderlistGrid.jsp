...
{ 
	 ...
	 datass='<%=searchDAO.orderlistsearchex(barchval,fromdate,todate,statusselect,acno)%>'; 
...
$(document).ready(function () {
   ...
   var rendererstring=function (aggregates){
    ...
    $("#salorderlistgrid").on('celldoubleclick', function (event) 
    		{
    	 var rowindextemp = event.args.rowindex;
    	 
    	 document.getElementById("masterdocno").value=$('#salorderlistgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no");
