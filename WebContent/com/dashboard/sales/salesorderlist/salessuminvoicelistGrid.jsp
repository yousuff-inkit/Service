...
var datas;
 ...
 if(temp4!='NA')
{ 
	 sumdatass='<%=searchDAO.salesordlistsearchsummex(barchval,fromdate,todate,statusselect,acno,psrno,invdocnomaster,hidbrand,hidtype,hidproduct,hidcat,hidsubcat,hidept,load)%>'; 
	 
	 datas='<%=searchDAO.salesordlistsearchsumm(barchval,fromdate,todate,statusselect,acno,psrno,invdocnomaster,hidbrand,hidtype,hidproduct,hidcat,hidsubcat,hidept,load)%>'; 
    ...
    $("#invlist").on('cellclick', function (event) 
   	  ...
   	  var datafield = event.args.datafield;
   	   ...
   	   if(datafield=="butview")
   		   {
    	 funsor($('#invlist').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
   		   }
