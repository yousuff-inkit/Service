        ...
        $(document).ready(function () { 
            ...
            { 
                ...
                columns: [
							 ...
							 { text: ' delQty', datafield: 'delqty', width: '4%',editable:false,cellsformat:'d2' },
							 { text: ' belQty', datafield: 'belqty', width: '4%',editable:false,cellsformat:'d2' },
							 ...
							 { text: ' Vendor', datafield: 'vendor', width: '16%' ,editable:false },
							 ...
							 { text: ' Net', datafield: 'netamount', width: '6%' ,editable:true,cellsformat:'d2',cellsalign: 'right', align:'right'},
            ...
            $("#duedetailsgrid").on('cellvaluechanged', function (event) 
                    {
        			   ...
        			   var total1= $('#duedetailsgrid').jqxGrid('getcellvalue', rowBoundIndex, "rfqprice");
        		    	...
        		    	{   
            		        $('#duedetailsgrid').jqxGrid('setcellvalue', rowBoundIndex, "sqoute",$('#duedetailsgrid').jqxGrid('getcellvalue', rowBoundIndex, "netamount"));
