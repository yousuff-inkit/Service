            ...
            $("#mainsearshgrid").jqxGrid(
            {
             ...
             $('#mainsearshgrid').on('rowdoubleclick', function (event) {
               ...
               var rowindex1=$('#rowindex').val();
                ...
                $('#duedetailsgrid').jqxGrid('setcellvalue', rowindex1, "rfqprice" ,$('#mainsearshgrid').jqxGrid('getcellvalue', rowindex2, "nettotal"));
                
                
                
                $('#duedetailsgrid').jqxGrid('setcellvalue', rowindex1, "margin", 0);
                $('#duedetailsgrid').jqxGrid('setcellvalue', rowindex1, "sqoute" ,$('#mainsearshgrid').jqxGrid('getcellvalue', rowindex2, "nettotal"));
