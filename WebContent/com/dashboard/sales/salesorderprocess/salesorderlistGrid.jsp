...
$(document).ready(function () {
    ...
    $("#enquirylist").jqxGrid(
    {
        ...
        columns: [   
                      ...
                      { text: 'Process ',datafield: 'update', width: '12%',columngroup:'minf'  },
                  ...
                  { text: 'clientid', datafield: 'clientid',  width: '8%',hidden:true },
           	      { text: 'branchvals', datafield: 'branchvals',  width: '8%',hidden:true },
	                     ...
	                     [
                           ...
                           { text: 'Sales Order  Minimum Info', align: 'center', name: 'minf',width: '20%' },
	                       { text: 'Sales Order Process', align: 'center', name: 'or',width: '20%' },
    ...
    $('#enquirylist').on('cellclick', function (event) 
		  ...
		  $("#detaildiv").load("detailgrid.jsp?rdoc="+$('#enquirylist').jqxGrid('getcellvalue', rowindex1, "doc_no")+"&barchval="+$('#enquirylist').jqxGrid('getcellvalue', rowindex1, "branchvals"));
