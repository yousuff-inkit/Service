...
function funExportBtn(){
	  // $("#enquirylist").jqxGrid('exportdata', 'xls', 'Sales Enquiry List');
	   ...
	   JSONToCSVCon(datass, 'Sales Enquiry List', true);
...
function funreload(event)
{
	 ...
	 var statusselect=$("#statusselect").val();
	  ...
	  $("#listdiv").load("enquirylistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect);
