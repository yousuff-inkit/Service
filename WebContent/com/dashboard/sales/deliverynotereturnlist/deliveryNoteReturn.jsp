...
function funExportBtn(){
	//   $("#dlrlistgrid").jqxGrid('exportdata', 'xls', 'Delivery Note Return List');
	

	   JSONToCSVCon(datass, 'Delivery Note Return List', true);
...
function funreload(event)
{
	  ...
	  $("#listdiv").load("deliveryNoteReturnGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="deliveryNoteReturnGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
