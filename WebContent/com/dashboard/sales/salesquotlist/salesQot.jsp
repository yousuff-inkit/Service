...
function funExportBtn(){
	 //  $("#salqotlistgrid").jqxGrid('exportdata', 'xls', 'Sales Quotation List');
	   
	   
	   
	   JSONToCSVCon(datass, 'Sales Quotation List', true);
...
function funreload(event)
{
	 ...
	 var acno=$("#acno").val();
	  ...
	  $("#listdiv").load("salesqotlistGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
...
<td width="20%" >
   ...
   <tr><td colspan="2">&nbsp;</td></tr> 
	...
	<option value="PED">Pending</option>
		 <option value="SQOT">Quotation</option>   
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="listdiv"><jsp:include page="salesqotlistGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
