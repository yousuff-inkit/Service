...
function funExportBtn(){
	 //  $("#dellistgrid").jqxGrid('exportdata', 'xls', 'Delivery Note List');
	   

	   JSONToCSVCon(datass, 'Delivery Note List', true);
...
function funreload(event)
{
	 ...
	 var acno=$("#acno").val();
	  ...
	  $("#listdiv").load("deliverynoteGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&acno="+acno);
