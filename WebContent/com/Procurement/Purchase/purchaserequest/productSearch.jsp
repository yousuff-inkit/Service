...
%>
  ...
  var dates='<%= dates %>';
		...
		$(document).ready(function () { 	
	       	 var url1='../getProduct.jsp?dates='+dates+'&dtype='+dtype;
        ...
        /*     $('#prosearch').on('cellclick', function (event) {
          ...
          $('#prosearch').on('rowdoubleclick', function (event) {
              ...
              $('#sqotprdid').val($('#prosearch').jqxGrid('getcellvalue', rowindex2, "part_no"));
	 		     ...
	 		     $('#unitdocno').val($('#prosearch').jqxGrid('getcellvalue', rowindex2, "munit"));
	 		     $('#specid').val($('#prosearch').jqxGrid('getcellvalue', rowindex2, "specid"));
	 		     $('#method').val($('#prosearch').jqxGrid('getcellvalue', rowindex2, "method"));
	 		     $('#doc_no').val($('#prosearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
