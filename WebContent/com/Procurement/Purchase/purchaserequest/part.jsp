...
<% ClsPurchaserequestDAO searchDAO = new ClsPurchaserequestDAO(); %> 
<%
...
#jqxInput{
  ...
  <script type="text/javascript"> 
            ...
            $(document).ready(function () {
           	 ...
           	 var aa1= '<%=searchDAO.searchProduct(session,cldocno,estdate,productname,brandname,id,gridunit,gridprdname,scope,gridcategory,gridssubcategory)%>';
