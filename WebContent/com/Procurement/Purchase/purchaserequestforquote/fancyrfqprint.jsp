...
<table width="100%">
  ...
  <td><jsp:include page="../../../common/fancyprintHeader.jsp"></jsp:include></td>
    ...
    <td width="21%"   align="left">: <label id="lbldoc" name="lbldoc"><s:property value="lbldoc"/></label></td>
     ...
     <tr>
      ...
      <td   align="left">: <label id="lblrefno" name="lblrefno"><s:property value="lblrefno"/></label></td>
       ...
       <td width="8%"  align="left">TRN No</td>
      <td  align="left" colspan="3">: <label id="lbltrnnumber" name="lbltrnnumber"><s:property value="lbltrnnumber"/></label></td>
...
<table style="border-collapse: collapse; border:1px solid black;" width="100%"  >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    ...
    <td align="left" style="border-collapse: collapse;border:1px solid black;" width="80%"><b>Product Name</b></td>
    <td align="left" style="border-collapse: collapse;border:1px solid black;" width="6%"><b>Unit</b></td>
