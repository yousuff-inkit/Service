  ...
  $('#serviecGrid').on('rowdoubleclick', function (event) {
        	...
        	{ 
    			...
    			document.getElementById("rowindex").value = rowindextemp;  
                     ...
                     document.getElementById("qutval").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "qutval");
                     document.getElementById("stockid").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "stockid");
                     document.getElementById("saveqty").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "saveqty");
                     document.getElementById("pqty").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "pqty");
                     document.getElementById("orderdiscper").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "orderdiscper");
                     document.getElementById("orderamount").value=$('#serviecGrid').jqxGrid('getcellvalue', rowindextempg, "orderamount");
