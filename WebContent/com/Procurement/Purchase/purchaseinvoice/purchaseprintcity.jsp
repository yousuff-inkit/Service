...
<table width="100%"   > 
  <tr>
    ...
    <td align="left" colspan="3">: <label id="lblvendoeaccName" name="lblvendoeaccName"><s:property value="lblvendoeaccName"/></label></td> 
    </tr>
    <tr>
...
<table style="border-collapse: collapse;" width="100%"  >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    ...
    <td align="right" style="border-collapse: collapse;" width="5%"><b>Dis.%</b></td>
     <td align="right" style="border-collapse: collapse;" width="5%"><b>Dis.</b></td>
     <td align="right" style="border-collapse: collapse;" width="7%"><b>Net Amt</b></td>
     <td align="right" style="border-collapse: collapse;" width="7%"><b>Tax</b></td>
      <td align="right" style="border-collapse: collapse;" width="7%"><b>Tax Amt</b></td>  
...
<table style="border-collapse: collapse;" width="100%"     >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;"> 
    <td align="left" style="border-collapse: collapse;" width="5%"><b>Sl No</b></td>
    <td align="left" style="border-collapse: collapse;" width="31%" ><b>Description</b></td>  
    ...
    <td align="right" style="border-collapse: collapse;"  width="8%"><b>Discount</b></td>
     <td align="right" style="border-collapse: collapse;"  width="8%"><b>Tax %</b></td>
      <td align="right" style="border-collapse: collapse;"  width="12%"><b>Tax Amount</b></td>
...
<table style="border-collapse: collapse;" width="100%"   >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    <td align="left" style="border-collapse: collapse;" width="5%"><b>Sl No</b></td>
    <td align="left" style="border-collapse: collapse;" width="29%" ><b>Description</b></td>
        <td align="left" style="border-collapse: collapse;" width="7%" ><b>Account</b></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
   ...
   <tr>
    <td width="80%" align="right" style="font-weight: bold">Total Amount :</td>
    <td width="6%" align="right"><label id="lbltotnetamnt"><s:property value="lbltotnetamnt"/></label></td>
    </tr>
    <tr>
    <td width="80%" align="right" style="font-weight: bold">Discount :</td>
    <td width="6%" align="right"><label id="aitsnetdiscount" name="aitsnetdiscount"><s:property value="aitsnetdiscount" /></label></td>
    </tr>
    <tr>
    ...
    <tr>
    <td width="80%" align="right" style="font-weight: bold">Round Of :</td>
    ...
    <td width="6%" align="right"><label id="lbltotal"><s:property value="lbltotal"/></td> 
     <%--  <td width="6%" align="right"><label id="lblnetamount"><s:property value="lblnetamount"/></td> --%>
    </tr>
    <tr>
    <td width="80%" align="right" style="font-weight: bold">Service Total :</td>
    <td width="6%" align="right"><label id="lblsubtotal" ><s:property value="lblsubtotal"/></label></td>
    </tr>
    <tr>
    <td width="80%" align="right" style="font-weight: bold">Purchase Expense Total :</td>  
    <td width="6%" align="right"><label id="lblexptotal" ><s:property value="lblexptotal"/></label></td>    
    </tr>
    <tr>
    <td width="80%" align="right" style="font-weight: bold">Grand Total :</td>
