...
String docnoss=request.getParameter("docnoss")==null?"0":request.getParameter("docnoss");
 ...
 String cmbbilltype=request.getParameter("cmbbilltype")==null?"0":request.getParameter("cmbbilltype");
...
if(temps='yes')
	{
	var vahReqmaster= '<%=purchaseretDAO.reqSearchMasters(session,docnoss,refnosss,datess,aa,headacccode,cmbbilltype) %>'; 
	}
else
	{
	  vahReqmaster; 
