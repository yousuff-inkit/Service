...
.myButtons:active {
	...
	function searchdata()
	{
       ...
       if(rows[i].chk==true){
    	   if(j==0){
    		   largstDate=rows[i].date;
    	   }else{
    		   largstDate=largstDate>rows[i].date?largstDate:rows[i].date;
    	   }  
           ...
           //alert('ref'+largstDate)
           refdate=largstDate;
           //alert(refdate)

           //$('#refdate').val(largstDate);
           //alert('largstDate : '+largstDate)
		        		 ...
		        		 document.getElementById("sqotprdid").value ="";
						   ...
						   document.getElementById("colbatch").value=""; 
						    document.getElementById("temppsrno").value="";
						     ...
						     document.getElementById("refdate1").value="";
		        		//alert("test")
