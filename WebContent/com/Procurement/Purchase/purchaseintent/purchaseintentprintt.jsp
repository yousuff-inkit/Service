...
<table width="100%"  cellpadding="3" cellspacing="0" >
 ...
 <tr>
 <td width="52%" align="left"><b>P.I NUMBER </b>:
...
<tr>
 ...
 <td width="25%" align="left">: <label id="lblcontact" name="lblcontact"><s:property value="lblcontact"/></label>
</td>
 <td width="8%" align="left"><b>Ship To </b>
 <td width="60%" align="left">: <label id="lblvendoeacc" name="lblvendoeacc"><s:property value="lblvendoeacc"/></label></td>
</tr>
 <tr>
...
<tr>
 <td width="8%" align="left"><b>Phone </b>
...
<tr>
 ...
 <td width="15%" align="left"><b>Phone&nbsp;:</b>&nbsp;025525447 
 <td width="30%" align="left">Fax&nbsp;:&nbsp;025575090
</tr>
 ...
 <tr >
  ...
  <table>
   <tr>  
    ...
    <td align="left" width="100%" ><b>Amount Chargeable (in words) DHS :</b>     <label id="lblordervaluewords"><s:property value="lblordervaluewords"/></label> &nbsp;&nbsp;&nbsp;&nbsp;
         </td>
