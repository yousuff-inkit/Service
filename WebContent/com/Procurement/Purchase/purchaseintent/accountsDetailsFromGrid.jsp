...
<script type="text/javascript">
   ...
   var data2= '<%=purchaseintentDAO.accountsDetailsFrom(masterdate,accountno,accountname,currency,check) %>'; 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
             ...
             $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("accdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
             	...
             	document.getElementById("clientcaid").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "catid");
            	//getCurrencyIds();
