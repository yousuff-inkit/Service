...
%>
       ...
       if(dtype=='PR' || dtype=='SOR' || dtype=='RFQ')
    	   ...
    	   prddata='<%=purchaseintentDAO.searchreqProduct(reqmasterdocno,session,dtype,accdocno,cmbbilltype,dates,cldocno,estdate,productname,brandname,id,gridunit,gridprdname,scope,gridcategory,gridssubcategory)%>';   
    	   
    	   }
       else
    	   {
    	   
    	   prddata='<%=purchaseintentDAO.searchProduct(session,accdocno,cmbbilltype,dates,cldocno,estdate,productname,brandname,id,gridunit,gridprdname,scope,gridcategory,gridssubcategory)%>';
    	   }
