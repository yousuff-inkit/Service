...
var nipurintentmain= '<%=purchaseintentDAO.mainsearch(session,docnoss,accountss,accnamess,datess,aa,descriptions,refnoss) %>'; 
   ...
   /*              document.getElementById("docno").value = $('#mainsearshgrid').jqxGrid('getcellvalue',rowindex1, "voc_no");
        	 ...
        	 $('#acctype').attr('disabled', false);
        	 funSetlabel();
            document.getElementById("purchaseIntent").submit();
            }); 
