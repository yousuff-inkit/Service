...
try{	ClsConnection ClsConnection=new ClsConnection();
	...
	String strSql21 = "select rrefno from my_srvm where  FIND_IN_SET('"+masterdoc_no+"', rrefno) and rdtype='PI'; ";
	...
	String strSql1 = "select  * from  my_apprmaster where dtype='PI' and status=3; ";
