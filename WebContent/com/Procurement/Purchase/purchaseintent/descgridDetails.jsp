 ...
 if(temp>0)
{
	...
	descdata='<%=purchaseintentDAO.reloadserv(purdoc)%>';  
        ...
        $(document).ready(function () { 	
         ...
         //Add row method
                ...
                columns: [
							...
							{ text: 'Quantity', datafield: 'qty1', width: '8%' ,cellsalign: 'left', align:'left',cellsformat:'d2'},
							{ text: 'Unit Price', datafield: 'unitprice1', width: '8%' ,cellsalign: 'right', align:'right', align:'right',cellsformat:'d2'},
							{ text: 'Total', datafield: 'total1', width: '10%' ,editable: false,cellsalign: 'right', align:'right',cellsformat:'d2'},
		    				{ text: 'Discount', datafield: 'discount1', width: '8%',cellsalign: 'right', align:'right',cellsformat:'d2' ,aggregates: ['sum1'],aggregatesrenderer:rendererstring1},
		    				{ text: 'Tax %', datafield: 'srvtaxper', width: '5%',cellsalign: 'right', align:'right',cellsformat:'d2'  },
							{ text: 'Tax Amount', datafield: 'srvtaxamount',editable:false , width: '8%',cellsalign: 'right', align:'right',cellsformat:'d2' ,aggregates: ['sum'],aggregatesrenderer:rendererstring},
		    				{ text: 'Net Amount', datafield: 'nettotal1', width: '10%',cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring ,editable: false},
