        ...
        $(document).ready(function () { 	
                           ...
                           [
                               {
                                   ...
                                   title: { text: 'Labour Hours' },
                                       series: [
                                               { dataField: 'labourhrs', displayText: 'Labour Hours',cellsalign:'right' ,align:'right',cellsformat:'d2',
                                               	labels: {
                                                       visible: true,
             ...
             $("#jqxUtilizationGrid").jqxGrid({
                 ...
                 [
                     ...
                     { text: "Labour Value", width: '40%', datafield: "labourvalue",cellsformat:'d2',renderer: columnrenderer, cellsrenderer: cellsrenderer },
