...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <script type="text/javascript">
	...
	var RESULTDATA6= '<%= sd.getZonSalRept(from,request,branch,amount1,amount2) %>';
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" ><div id='jqxZoneChart' style="margin-top: 1px; width: 500px; height: 300px; position: relative;">
    </div></div>
