...
<%@page import="javax.servlet.http.HttpSession" %>
 ...
 <% String from =request.getParameter("from")==null?"0":request.getParameter("from").toString();
  ...
  String area=request.getParameter("areadoc")==null?"0":request.getParameter("areadoc").toString();
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <script type="text/javascript">
	...
	var RESULTDATA4= '<%= sd.getAreaCount(from,request,branch,area) %>';
        ...
        $(document).ready(function () { 	
                           ...
                           [
                               {
                                   ...
                                   columnsBottomWidthPercent: 50,
                                   title: { text: 'Amount' },
                                   series: [
                                            { dataField: 'curyearcurmonthamount', displayText: 'Current Year Current Month Amount' },
                                            { dataField: 'lastyearcurmonthamount', displayText: 'Last Year Current Month Amount'},
                                               /* { dataField: 'amount', displayText: 'Amount', cellsalign:'right' ,align:'right',cellsformat:'d2',labels: {
                                                   visible: true,
             ...
             //jqxJobChart
             //jqxJobCountGrid
             $('#jqxAreaChart').jqxChart(settings);
             var source1 =
	          {
	              datatype: "json",
	              datafields: [
             ...
             $("#jqxAreaGrid").jqxGrid({
                 ...
                 [
                     ...
                     { text: "Area", width: '20%', datafield: "area" },
             ...
             $("#jqxAreaGrid").on('filter', function () {
                 var rows = $("#jqxAreaGrid").jqxGrid('getrows');
                 var chart = $('#jqxAreaChart').jqxChart('getInstance');
                 chart.source = rows;
                 chart.update();
             });
//         
 ...
 <div align="center">
  ...
  <s:iterator var="stat" value='#request.area' >
<tr>   
<%int i=0; %>
...
<div id="jqxAreaGrid" style="margin-left: 20px;display:none"></div>
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" ><div id='jqxAreaChart' style="margin-top: 1px; width: 500px; height: 300px; position: relative;">
    </div></div>
