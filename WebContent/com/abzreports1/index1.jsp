...
<script type="text/javascript">
      ...
      function funChangeData(){       
    	   $("a[name=tabs]").on("click", function () { 
	            var a = $(this).attr("data-dbname"); 
	            alert(a);    
	          });   
    	  //getPaytype(dbname);getBank(dbname);getPdcsummary(dbname);getOwncategory(dbname);getOwnreceivable(dbname);getDirectprivillege(dbname);getDirectcategory(dbname);
...
<body id="myPage"  data-spy="scroll" data-target=".navbar" data-offset="50" style="background-color: #ffff;"   >
        ...
        <div class="container-fluid"  style="margin-top:5px">
  			<div class="row" align="left" >
  				...
  				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-1">           
			        ...
			        <ul id="addComp">  
			          <!-- <li><a href='#' onClick='funChangeData("abzgroup");'>ABDULLA BIN ZAYED  INVESTMENT GROUP LLC</a> </li> -->  
			          <li><a href="#"  onClick="funChangeData('abzgroup');">ABDULLA BIN ZAYED  INVESTMENT GROUP LLC</a></li> 
			        </ul>                                                      
			     </div>		                                 
  				</div>
