                ...
                var rowindex2 = event.args.rowindex;
                    ...
                    var prdid=$('#prosearch').jqxGrid('getcellvalue', rowindex2, "doc_no");
                     ...
                     //  $('#serviecGrid').jqxGrid('setcellvalue', rowindex1, "qty" ,$('#prosearch').jqxGrid('getcellvalue', rowindex2, "qty"));
                       ...
                       var qutval=$('#prosearch').jqxGrid('getcellvalue', rowindex2, "qutval");	
                       var quty=$('#serviecGrid').jqxGrid('getcellvalue', rowindex1, "qty");
                       if(quty>qutval){
                       		document.getElementById("errormsg").innerText=" Qty value not more than Actual Qty "+qutval;
                           	$('#serviecGrid').jqxGrid('setcellvalue', rowindex1, "qty",qutval);
                       }
