...
$(document).ready(function () {  
    ...
    $('#sitewindow').jqxWindow({ width: '30%', height: '55%',  maxHeight: '75%' ,maxWidth: '50%' , title: 'Site Search' ,position: { x: 400, y: 70 }, theme: 'energyblue', keyboardCloseKey: 27});
    ...
    <form id="frmgir" action="saveActionginsreturn" method="post" autocomplete="off">  
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Goods Issue Return Details</span>
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:80px; margin-left:15px;">Item Code</label>
                    <div class="input-search-container" style="width: 125px;">
                    ...
                    <label class="lbl-right" style="width:80px; margin-left:15px;">Item Name</label>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="clientname" name="clientname" style="width:250px;" value='<s:property value="clientname"/>'/>
                    <input type="hidden" id="cldocno" name="cldocno" value='<s:property value="cldocno"/>'/>
                    
                    <label class="lbl-right" style="width:80px; margin-left:15px;">Site</label>
                    <div class="input-search-container" style="flex:1;">
            ...
            <div class="middle-panel" id="psearch">
                ...
                <div class="field-row" style="margin-bottom:0; justify-content:flex-end;">
                    ...
                    <input type="button" id="setbtn" class="myButton-success" onclick="setgrid()" value="ADD">
                </div>
            </div>
