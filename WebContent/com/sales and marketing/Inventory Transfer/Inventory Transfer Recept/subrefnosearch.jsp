...
String docnoss=request.getParameter("docnoss")==null || request.getParameter("docnoss").equals("")?"0":request.getParameter("docnoss");
 
 String refnosss=request.getParameter("refnosss")==null || request.getParameter("refnosss").equals("")?"0":request.getParameter("refnosss");
 
 String datess=request.getParameter("datess")==null?"0":request.getParameter("datess");
 
 String frmlocid=request.getParameter("frmlocid")==null || request.getParameter("frmlocid").equals("")?"0":request.getParameter("frmlocid");
 
 String tolocid=request.getParameter("tolocid")==null || request.getParameter("tolocid").equals("")?"0":request.getParameter("tolocid");    
