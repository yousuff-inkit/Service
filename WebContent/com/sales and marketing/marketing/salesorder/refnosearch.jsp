	       ...
	       $.messager.confirm('Message', 'Do you want to Import?', function(r){
		        	...
		        	if(r==false)
		      		...
		      		var cmbbilltype=document.getElementById("cmbbilltype").value; 
		       		  $("#salesOrderDiv").load("salesOrderGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+"&chk="+chk+"&from="+from+"&cond=1"+"&cmbbilltype="+cmbbilltype+"&dates="+date+"&clientid="+clientid);	
