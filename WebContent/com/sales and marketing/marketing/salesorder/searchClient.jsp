...
%> 
 ...
 var cldata=[];
if(id=="1"){
	cldata='<%=DAO.searchClient(session,clname,mob,Cl_clientsale,id)%>';	
}
         ...
         //	var url1;
          ...
          /*   $("#Jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#Jqxclientsearch').on('rowdoubleclick', function (event) 
				               ...
				               document.getElementById("hidcmbtaxqot").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "tax");
