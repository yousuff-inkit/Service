...
<table style="border-collapse: collapse;" width="100%"  >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    ...
    <td align="right" style="border-collapse: collapse;" width="8%"><b>Discount%</b></td>
     <td align="right" style="border-collapse: collapse;" width="8%"><b>Discount</b></td>
     <td align="right" style="border-collapse: collapse;" width="11%"><b>Net Total</b></td>
     <td align="right" style="border-collapse: collapse;" width="11%"><b>Tax Amount</b></td>
...
<table style="border-collapse: collapse;" width="100%"  >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    <td align="left" style="border-collapse: collapse;" width="6%"><b>Sl No</b></td>
    <td align="center" style="border-collapse: collapse;" width="6%"><b>Terms</b></td>
    <td align="center" colspan="8" style="border-collapse: collapse;"><b>Description</b></td>
    <!-- <td align="left" style="border-collapse: collapse;"><b>Unit</b></td>
     <td align="center" style="border-collapse: collapse;" width="6%"><b>Qty</b></td>
    <td align="right" style="border-collapse: collapse;" width="10%"><b>Unit price</b></td>
    <td align="right" style="border-collapse: collapse;" width="8%"><b>Total</b></td>
...
<s:iterator var="stat" value='#request.trmdetails' >
<tr>   
<%int i=0; %>
    <s:iterator status="arr" value="#stat.split('::')" var="des">   
    <%
