...
<%int i=0; %>
 ...
 <table width="100%" >
    ...
    <tr><td width="53%">&nbsp;</td>
    <td width="11%" align="left">Total</td><td width="36%">:<label id="lbltotal"><s:property value="lbltotal"/></label></td>
    </tr>
    <tr><td width="53%">&nbsp;</td>
    <td width="11%" align="left">Vat</td><td>:<label id="lblvattotal"><s:property value="lblvattotal"/></label></td>
    </tr>
    <tr><td width="53%">&nbsp;</td>
    <td width="11%" align="left">NetAmount</td><td>:<label id="lblordervalue"><s:property value="lblordervalue"/></label></td>
    </tr>
    <tr><td width="53%">&nbsp;</td>
    <td width="11%" align="left">Amount in words</td><td>:<label id="lblordervaluewords"><s:property value="lblordervaluewords"/></label></td>
    </tr>
