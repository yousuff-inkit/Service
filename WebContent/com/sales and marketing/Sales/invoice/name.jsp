...
#jqxInput1{
  ...
  <script type="text/javascript">
            ...
            $(document).ready(function () {
            	 ...
            	 var dd2='<%=DAO.searchProduct(session,prodsearchtype,rrefno,reftype,cmbprice,clientid,cmbreftype,location,clientcaid,dates,cmbbilltype,productname,brandname,gridunit,gridprdname,gridcategory,gridssubcategory,griddepartment,"1")%>';
