...
<body style="font-size:14px; background-color: white;"  bgcolor="white" onload="hidedata()">
...
<table width="100%">
  ...
  <td><jsp:include page="../../../common/printHeaderSafepro.jsp"></jsp:include></td>
...
<%-- <table width="100%"  > 
 ...
 <table width="100%">
  ...
  <table width="100%" >
  <tr>  <td width="24%" align="left"> ID </td> <td width="76%">:<label id="lblvendoeacc" name="lblvendoeacc"><s:property value="lblvendoeacc"/> </label> </td> </tr>
  <tr>  <td width="24%"  align="left"> Name </td> <td width="76%">:<label id="lblvendoeaccName" name="lblvendoeaccName"><s:property value="lblvendoeaccName"/></label> </td>  </tr>
  <tr>  <td width="24%"  align="left"> TRN NO </td> <td width="76%">:<label id="lblclienttrno" name="lblclienttrno"><s:property value="lblclienttrno"/></label>  </td>  </tr>
  <tr>  <td width="24%"  align="left"> Telephone No </td> <td width="76%">:<label id="lblclienttel" name="lblclienttel"><s:property value="lblclienttel"/></label>  </td>  </tr>
  <tr>  <td width="24%"  align="left"> Mail ID </td> <td width="76%">:<label id="lblclientmail" name="lblclientmail"><s:property value="lblclientmail"/></label>  </td>  </tr>
  ...
  <tr>  <td width="28%"  align="right">Email :</td> <td width="72%"><label id="lblshipemail" name="lblshipemail"><s:property value="lblshipemail"/></label></td>  </tr>
   <tr>  <td width="28%"  align="right">FAX :</td> <td width="72%"><label id="lblshipfax" name="lblshipfax"><s:property value="lblshipfax"/></label></td>  </tr>
    	...
    	<table width="100%" border="0">
    	  <tr>
		    <td width="64%" align="right">Invoice No</td>
		    <td width="36%">: <label id="lblinvno" name="lblinvno"><s:property value="lblinvno"/></label></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		    <td width="64%" align="right">Do No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td width="36%">: <label id="lblrrefno" name="lblrrefno"><s:property value="lblrrefno"/></label></td>
		  </tr>
		  <tr>
...
<%int i=0; %>
 ...
 <table width="100%" >
    ...
    <tr><td width="80%">&nbsp;</td>
    <td width="20%" align="right"><b>Total :</b></td><td align="right"><label id="lbltotal"><s:property value="lbltotal"/></label></td>
    </tr>
    <tr><td width="80%">&nbsp;</td>
    <td width="20%" align="right"><b>Vat 5% :</b></td><td align="right"><label id="lblvattotal"><s:property value="lblvattotal"/></label></td>
    </tr>
    <tr><td width="80%">&nbsp;</td>
    <td width="20%" align="right"><b>NetAmount :</b></td><td align="right"><b><label id="lblordervalue"><s:property value="lblordervalue"/></label></b></td>
    </tr>
    <tr>
