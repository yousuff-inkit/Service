...
<body style="font-size:13px; font-family: Tahoma, Verdana, Segoe, sans-serif;"  bgcolor="white" onload="hidedata()">
...
<%-- <table width="100%"  > 
 ...
 <table width="100%">
  ...
  <tr>  <td width="20%" height="35"  align="left"> Address </td>  <td width="80%">:<label id="lblclientaddress" name="lblclientaddress"><s:property value="lblclientaddress"/></label> </td> </tr>
  ...
  <tr>  <td width="20%"  align="left"> Phone </td> <td width="80%">:<label id="lblclientmob" name="lblclientmob"><s:property value="lblclientmob"/></label>  </td>  </tr>
...
<%int i=0; %>
 ...
 <table width="100%" >
    ...
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="center">Total</td><td>:<label id="lbltotal"><s:property value="lbltotal"/></label></td>
    </tr>
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="center">Vat</td><td>:<label id="lblvattotal"><s:property value="lblvattotal"/></label></td>
    </tr>
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="right">NetAmount</td><td>:<label id="lblordervalue"><s:property value="lblordervalue"/></label></td>
    </tr>
