		        	...
		        	if(r==false)
		        	  {
		        		...
		        		$("#prodsearchtype").val("2");
		       		  ...
		       		  $("#delNoteDiv").load("invoiceGrid.jsp?enqdoc="+ document.getElementById("refmasterdocno").value+'&locationid='+document.getElementById("locationid").value+"&chk="+chk+"&from="+from+"&cond=1"+"&date="+document.getElementById("date").value);	
