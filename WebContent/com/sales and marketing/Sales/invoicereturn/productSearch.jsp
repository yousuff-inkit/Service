            ...
            $("#prosearch").jqxGrid(
            {
                ...
                columns: [
                          ...
                          { text: '', sortable: false, filterable: false, editable: false,
                              ...
                              { text: 'rdocno', datafield: 'balfoc', width: '10%' ,hidden:true },
...
/*         	    var aa=0;
             ...
             /*      	if($('#mode').val()=="E"){
        	  ...
        	  $('#jqxInvoiceReturn').jqxGrid('setcellvalue', rowindex1, "taxper" ,$('#prosearch').jqxGrid('getcellvalue', rowindex2, "taxper"));
        	  ...
        	  $('#jqxInvoiceReturn').jqxGrid('setcellvalue', rowindex1, "foc" ,$('#prosearch').jqxGrid('getcellvalue', rowindex2, "foc"));
        	  $('#jqxInvoiceReturn').jqxGrid('setcellvalue', rowindex1, "balfoc" ,$('#prosearch').jqxGrid('getcellvalue', rowindex2, "balfoc"));
