	   ...
	   var productd=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productid");
	    if(productd!="" && !(productd==null) && !(productd=="undefiend")){
           	    //alert("productchk====="+chk);
           	                      document.getElementById("sqotprdid").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productid");
           	                      document.getElementById("sqotprdname").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productname");
