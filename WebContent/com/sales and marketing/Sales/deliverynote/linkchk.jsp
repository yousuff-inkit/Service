...
try{	ClsConnection ClsConnection=new ClsConnection();
	...
	String strSql2 = "select tr_no from my_delm where    doc_no='"+masterdoc_no+"' ";
	...
	String strsql3="select * from my_deld where (out_qty>0) and tr_no='"+tr_no+"'";
	...
	String strsql4="select stockid from my_prddin where  (out_qty>0 or rsv_qty>0 or del_qty>0  or foc_out>0) and tr_no='"+tr_no+"'";
