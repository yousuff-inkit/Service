...
<script type="text/javascript">
	...
	function loadAccountSearch() {
		...
		var check = 1;
		var aa="yes";
		getAccountDetails(accountsno,accountsname,currs,check,masterdate,aa);
	}
		
	function getAccountDetails(accountsno,accountsname,currs,check,masterdate,aa){

		 $("#refreshAccountDetailsDiv").load("accountsDetailsFromGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&check='+check+'&masterdate='+masterdate+'&type='+'<%=type%>'+"&aa="+aa);
	}
