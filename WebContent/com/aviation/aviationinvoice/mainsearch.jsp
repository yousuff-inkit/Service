...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () { 
 	...
 	function loadSearchs() {
 		...
 		var refnoss=document.getElementById("refnoss").value.replace(' ', '%20');
  ...
  <tr >
   ...
   <tr>
    ...
    <td align="left" width="20%"><input type="text" name="docnoss" id="docnoss"  style="width:90%;" value='<s:property value="docnoss"/>'></td>
     ...
     <input type="hidden" name="accountss" id="accountss" style="width:100%;"  value='<s:property value="accountss"/>'> 
    
   <td align="right"  width="14%">Account Name</td>
    <td align="left" colspan="4" width="30%"><input type="text" name="accnamess" style="width:91%;" id="accnamess" value='<s:property value="accnamess"/>'></td>
