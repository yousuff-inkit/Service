...
<script type="text/javascript">
	...
	function getAccountDetails(accountsno,accountsname,currs,check,masterdate){
		 ...
		 $("#refreshAccountDetailsDiv").load("accountsDetailsFromGrid.jsp?accountno="+accountsno+'&accountname='+accountsname.replace(/ /g, "%20")+'&currency='+currs+'&check='+check+'&masterdate='+masterdate+'&type='+'<%=type%>');
	}
