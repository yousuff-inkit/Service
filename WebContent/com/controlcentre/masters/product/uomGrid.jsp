        ...
        $(document).ready(function () { 
            ...
            $("#jqxUomGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Unit', datafield: 'unit', editable: false, cellsalign: 'center', align: 'center' },
							{ text: 'Unitid', datafield: 'unitid',hidden:true,  width: '12%',cellsalign: 'center', align: 'center' },
							{ text: 'Fr', datafield: 'fr',  width: '11%',cellsformat: 'd4',cellsalign: 'right', align: 'right', 
								cellbeginedit: function (row) {
					               if (row==0)
					                {
					                     return false;
					                }} },	
							{ text: 'Weight', datafield: 'weight', width: '12%',cellsformat: 'd2',cellsalign: 'right', align: 'right' },	
							{ text: 'Volumn', datafield: 'volumn', width: '12%',cellsformat: 'd2',cellsalign: 'right', align: 'right' },
							...
							{ text: 'Docno', datafield: 'docno', width: '12%',cellsalign: 'right', align: 'right', hidden:true},
