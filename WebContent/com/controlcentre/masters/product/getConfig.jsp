...
try{	
	...
	String strSql = "select  field_nme,method from gl_prdconfig where field_nme in('suit','spec')";
	 ...
	 */
	 while(rs.next()) {
			methodname=rs.getString("field_nme");
			
			if(methodname.equalsIgnoreCase("suit"))
				suit=rs.getInt("method");
			
			if(methodname.equalsIgnoreCase("spec"))
				spec=rs.getInt("method");
				i++;
				} 
