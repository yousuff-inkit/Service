...
<script type="text/javascript">
    $(document).ready(function () {      
        ...
        /* Configure modern UI 24px height override for date inputs */
        ...
        setTimeout(function () {
            ...
            $("#staffdate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
        }, 0);
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="padding-bottom:10px;">
        ...
        <div id="staffdiv" class="grid-container" style="border:none; margin:0;">
