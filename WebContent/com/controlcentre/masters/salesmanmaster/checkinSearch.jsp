<%@page import="com.controlcentre.masters.salesmanmaster.checkin.ClsCheckinAction" %>
<%ClsCheckinAction ca=new ClsCheckinAction(); %>
	...
	var data= '<%=ca.searchDetails() %>';
		...
		$(document).ready(function () { 	
            ...
            $('#jqxCheckinSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtaccno").value = $("#jqxCheckinSearch").jqxGrid('getcellvalue', rowindex1, "acc_no");
                document.getElementById("txtaccname").value = $("#jqxCheckinSearch").jqxGrid('getcellvalue', rowindex1, "description");
