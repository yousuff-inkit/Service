<%@page import="com.controlcentre.masters.salesmanmaster.helper.ClsHelperDAO" %>
<%ClsHelperDAO chd=new ClsHelperDAO(); %>
...
<script type="text/javascript">
	  ...
	  $(document).ready(function () {     
		  ...
		  $("#helperdate").jqxDateTimeInput({width : '125px',height : '15px',formatString : "dd.MM.yyyy"});
		  ...
		  document.getElementById("formdet").innerText="Helper(HLR)";
   		  document.getElementById("formdetail").value="Helper";
   		  document.getElementById("formdetailcode").value="HLR";
   		  window.parent.formCode.value="HLR";
		  window.parent.formName.value="Helper";
         ...
         $('#jqxHelperSearch1').on('rowdoubleclick', function (event) 
         		{ 
		            	var rowindex1=event.args.rowindex;
		                document.getElementById("docno").value= $('#jqxHelperSearch1').jqxGrid('getcellvalue', rowindex1, "doc_no"); 
		                document.getElementById("code").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "code");
		                document.getElementById("name").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "name");
		                document.getElementById("mail").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "mail");
		                document.getElementById("mobile").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "mobile");
		                $("#helperdate").jqxDateTimeInput('val', $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "date")); 
		                document.getElementById("txtaccno").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "acno");
		                document.getElementById("txtaccname").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "description");
		                document.getElementById("hidacno").value = $("#jqxHelperSearch1").jqxGrid('getcellvalue', rowindex1, "acdoc");
         		 }); 
	...
	function funSearchLoad(){
		changeContent('helperSearch.jsp'); 
	 }
	 
	function funReadOnly(){
	     $('#frmHelper input').attr('readonly', true );
		 $('#helperdate').jqxDateTimeInput({ disabled: true}); 
			$('#txtaccno').attr('disabled', true);

	}
	
	function funRemoveReadOnly(){
		$('#frmHelper input').attr('readonly', false );
		$('#helperdate').jqxDateTimeInput({ disabled: false}); 
	...
	function setValues() {
		if($('#hidhelperdate').val()){
			$("#helperdate").jqxDateTimeInput('val', $('#hidhelperdate').val());
	    }
	...
	function funExcelBtn(){
	   	 $("#jqxHelperSearch1").jqxGrid('exportdata', 'xls', 'Sales Agents');
	   }
</script>
</head>
<body onLoad="setValues();">
<div id="mainBG" class="homeContent" data-type="background">
<form id="frmHelper" action="saveActionHelper" autocomplete="off" >
...
<table width="100%">
  <tr>
    ...
    <td width="16%"><div id="helperdate" name="helperdate" value='<s:property value="helperdate"/>'></div></td>
...
<input type="hidden" name="hidhelperdate" id="hidhelperdate" value='<s:property value="hidhelperdate"/>'>
