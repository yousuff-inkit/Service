            ...
            $("#dumpGrid").jqxGrid(
            {
             ...
             $('#dumpGrid').on('rowdoubleclick', function (event) {
              ...
              //   txtlocationid
                ...
                document.getElementById("dumpid").value = $('#dumpGrid').jqxGrid('getcellvalue', rowindex1, "doc_no");
                document.getElementById("txtdump").value = $('#dumpGrid').jqxGrid('getcellvalue', rowindex1, "dump");
