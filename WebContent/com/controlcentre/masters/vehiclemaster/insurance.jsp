...
$(document).ready(function () {          
    ...
    $("#insurdate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'}); 
    setTimeout(function () {
        $("#insurdate").find("input").css({
            "margin-top": "0px", "line-height": "24px", "font-size": "12px", 
            "font-family": "Arial, sans-serif", "padding": "0 6px", "box-sizing":"border-box"
        });
        $("#insurdate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
    }, 0);
...
<form id="frmInsurance" action="saveActionInsurance" autocomplete="off">
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div class="input-search-container" style="width:200px;">
                    <input type="text" name="txtaccname" id="txtaccname" value='<s:property value="txtaccname"/>' ondblclick="funSearchdblclick();" onkeydown="getAcc(event);" placeholder="Press F3">
                ...
                <input type="text" name="insurcompany" id="insurcompany" value='<s:property value="insurcompany"/>' style="flex:1;">
            </div>
        </div>
        ...
        <div class="middle-panel" style="padding-bottom:10px;">
            ...
            <div id="jqxInsuranceSearch1" class="grid-container" style="border:none; margin:0;"></div>
        </div>
