...
$(function(){
    $('#frmUnit').validate({
        rules: {
            unit:{ required:true, maxlength:3 }, 
            unitdesc:{ maxlength:25 }
        },
        messages: {
            unit:{ required:" *", maxlength:"max 3 chars" },
            unitdesc:{ maxlength:"max 25 chars" }
        }
    });
});
...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" name="unit" id="unit" value='<s:property value="unit"/>' style="width:125px;">
    ...
    <div class="middle-panel" style="padding-bottom:10px;">
        ...
        <div id="jqxUnitSearch1" class="grid-container" style="border:none; margin:0;"></div>
    </div>
