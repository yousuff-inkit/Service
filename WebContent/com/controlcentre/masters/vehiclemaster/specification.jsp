...
function funRemoveReadOnly(){
    ...
    $('#docno').attr('readonly', true ); // Keeping docno readonly typically after edit enable
}
...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" name="specname" id="specname" value='<s:property value="specname"/>' placeholder="Spec Name" style="width: 250px;" />
            
            <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
            <input type="text" name="docno" id="docno" tabindex="-1" readonly value='<s:property value="docno"/>' style="width:125px;"/>
        </div>
    ...
    <div class="middle-panel" style="padding-bottom:10px;">
        <span class="middle-panel-title">Specifications List</span>
        <div class="grid-container" style="border:none; margin:0;">
