...
$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        $("#projectDate").find(".jqx-action-button").css({"top": "0px", "height": "24px"});
    }, 0);
    
    var popupConfig = {theme: 'energyblue', showCloseButton: true, keyboardCloseKey: 27};
    $('#clientDetailsWindow').jqxWindow($.extend({}, popupConfig, {width: '51%', height: '58%',  maxHeight: '70%' ,maxWidth: '51%' , title: 'Client Search',position: { x: 300, y: 87 }})).jqxWindow('close');
...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:80px;">Client Name</label>
            ...
            <label class="lbl-right" style="width:80px; margin-left:auto;">Project Name</label>
            <input type="text" name="txtprojectname" id="txtprojectname" style="flex:1;" value='<s:property value="txtprojectname"/>'>
        </div>
    </div>
    ...
    <div class="middle-panel" style="padding-bottom:10px;">
        ...
        <div id="jqxProjectSearch1" class="grid-container" style="border:none; margin:0;"></div> 
    </div>
