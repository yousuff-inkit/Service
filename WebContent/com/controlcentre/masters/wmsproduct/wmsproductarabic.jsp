...
<body onload="setValues();getpmconfig();">
	<div id="mainBG" class="homeContent" data-type="background">
 		<!-- <form id="frmWmsproduct" action="saveWmsproduct" method="post"  namespace="/"
method="POST" enctype="multipart/form-data">
			autocomplete="off">   -->
	  <s:form action="saveWmsproduct1" id="frmWmsproduct"  method="post"  namespace="/com/controlcentre/masters/wmsproduct"  autocomplete="OFF"  >   
