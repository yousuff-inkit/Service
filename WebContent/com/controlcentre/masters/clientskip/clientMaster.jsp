	  ...
	  function getclintvldconfig(){
		...
		function Setviewmode(cldocno){   
			...
			if (x.readyState==4 && x.status==200){
				 	...
				 	document.getElementById("txtcode").value=items[0];
		            document.getElementById("txtclient_name").value=items[1];
		            document.getElementById("cmbgroupcmp").value=items[3];
		            document.getElementById("groupcmpid").value=items[3];
		     ...
		     x.open("GET","setViewMode.jsp?masterdoc="+cldocno,true); 
		     x.send();
	    }
</script>
