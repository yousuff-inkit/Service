...
<div class="section-title">Currency Details</div>
...
<div class="form-row">
    ...
    <input type="text"
           ...
           style="width:80px;"
           onblur="checkCurrency(this.value);">

    <label>Name</label>
    <input type="text"
           id="txtcodename"
           name="txtcodename"
           value='<s:property value="txtcodename"/>'
           style="width:200px;">
</div>
...
<div class="form-row single">
    ...
    <input type="text"
           id="txtcountry"
           name="txtcountry"
           value='<s:property value="txtcountry"/>'
           style="width:200px;">
</div>
...
<div class="form-row single">
    ...
    <input type="text"
           id="txtfraction"
           name="txtfraction"
           value='<s:property value="txtfraction"/>'
           style="width:120px;">
</div>
...
<div class="form-row single">
    ...
    <input type="text"
           id="txtdecimal"
           name="txtdecimal"
           value='<s:property value="txtdecimal"/>'
           style="width:120px;">
</div>
