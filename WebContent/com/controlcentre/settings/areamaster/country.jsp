      ...
      $(document).ready(function () {          
          ...
          $("#jqxCountrySearch1").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Country Code',columntype: 'textbox', filtertype: 'input', datafield: 'country_code', width: '15%' },
                    { text: 'Region id', datafield: 'reg_id' } ,
                    { text: 'Region',columntype: 'textbox', filtertype: 'input', datafield: 'region', width: '25%' }
                ]
          });
	  ...
	  $(function(){
	        $('#frmCountry').validate({
	            rules: {
	                ...
	                country:{ required:true, maxlength:45 }
	            },
	            messages: {
	                region:{ required:" *" },
	                country:{ required:" *", maxlength:"max 45 chars" }
	            }
	        });
      });
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <select name="region" id="region" style="width:250px;"></select>
                </div>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <label class="lbl-right" style="width:100px; margin-left:15px;">Country Code</label>
                    <input type="text" name="contry_code" id="contry_code" style="width:100px;" value='<s:property value="contry_code"/>'>
                </div>
            </div>
