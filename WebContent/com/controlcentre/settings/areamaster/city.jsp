      ...
      $(document).ready(function () {          
          ...
          $("#jqxCitySearch1").jqxGrid({
              ...
              columns: [
                  ...
                  { text: 'Country',columntype: 'textbox', filtertype: 'input', datafield: 'country', width: '15%' },
	  ...
	  $(function(){
	        $('#frmCity').validate({
	            rules: {
		            ...
		            city:{ required:true, maxlength:45 }
		        },
		        messages: {
		            region:{ required:" *" },
		            country:{ required:" *" },
		            city:{ required:" *", maxlength:"max 65 chars" }
	            }
	        });
      });
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="text" name="city" id="city" style="flex:1;" value='<s:property value="city"/>'>
                    
                    <label class="lbl-right" style="width:80px; margin-left:15px;">State Code</label>
                    <input type="text" name="city_code" id="city_code" style="width:100px;" value='<s:property value="city_code"/>'>
                </div>
            </div>
