	  ...
	  function setValues(){
		  ...
		  if($('#hidjqxChequeDate').val()){
		   ...
		   funSetlabel();
			 ...
			 if(indexVal>0){
	         $("#jqxIbBankPaymentGrid").load("ibBankPaymentGrid.jsp?txtibbankpaydocno2="+indexVal);
			 }
	         
	         var indexVal1 = document.getElementById("txttodocno").value;
	         var indexVal2 = document.getElementById("txttotrno").value;
	         if(indexVal1>0){
	         $("#bankApplyInvoicing1").load("applyIbBankInvoicingGrid.jsp?txttoaccid1="+indexVal1+"&txttotrno1="+indexVal2); 
	         }
		}
