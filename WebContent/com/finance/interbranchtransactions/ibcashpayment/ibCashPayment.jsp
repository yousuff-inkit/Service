	 ...
	 function funFocus()
	  ...
	  function setValues(){
		  ...
		  funSetlabel();
			 ...
			 if(indexVal>0){
	         $("#jqxIBCashPaymentGrid").load("ibCashPaymentGrid.jsp?txtcashpaydocno2="+indexVal);
			 }
	         var indexVal1 = document.getElementById("txttodocno").value;
	         var indexVal2 = document.getElementById("txttotrno").value;
	         if(indexVal1>0){
	         $("#jqxIbCashApplyInvoicing1").load("applyIbCashInvoicingGrid.jsp?txttoaccid1="+indexVal1+"&txttotrno1="+indexVal2); 
	         }
		}
