	  ...
	  function setValues(){
		  ...
		  if($('#hidmaindate').val()){
		   ...
		   funSetlabel();
			 ...
			 if(indexVal>0){
	         $("#jqxIbBankReceiptGrid").load("ibBankReceiptGrid.jsp?txtibbankreceiptdocno2="+indexVal);
			 }
	         
	         var indexVal1 = document.getElementById("txttodocno").value;
	         var indexVal2 = document.getElementById("txttotrno").value;
	         if(indexVal1>0){
	         $("#bankApplyInvoicing1").load("applyIbBankReceiptInvoicingGrid.jsp?txttoaccid1="+indexVal1+"&txttotrno1="+indexVal2); 
	         }
		}
