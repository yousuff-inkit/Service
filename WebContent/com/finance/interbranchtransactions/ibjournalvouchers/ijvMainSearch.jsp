...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		getdata(docNo,dates,descriptions,refNo,amounts);

	}
 	
	function getdata(docNo,dates,descriptions,refNo,amounts){
		 $("#refreshdiv").load('ijvMainSearchGrid.jsp?docNo='+docNo+'&dates='+dates+'&descriptions='+descriptions.replace(/ /g, "%20")+'&refNo='+refNo+'&amounts='+amounts);
		}
