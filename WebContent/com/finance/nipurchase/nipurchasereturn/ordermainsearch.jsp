...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	function getdata(docnoss,accountss,accnamess,datess,reftypess,aa,description){
		 ...
		 $("#refreshdivs1").load('subsearch.jsp?docnoss='+docnoss+'&accountss='+accountss+'&accnamess='+accnamess+'&datess='+datess+'&reftypess='+reftypess+'&aa='+aa+'&description='+description);
...
<table width="100%" >
  ...
  <!-- <table width="100%"> -->
    ...
    <td align="right" width="10%"  >Description</td><td  width="20%"><input type="text" name="description" style="width:90%;" id="description" value='<s:property value="description"/>'>
     <td  width="20%"><select  hidden="true"name="reftypess" id="reftypess" style="width:58%;"  value='<s:property value="reftypess"/>' >
  
   </select> 
   	&nbsp;&nbsp;<input type="button" name="searchs" id="searchs" class="myButton" value="Search"  onclick="loadSearchs1()"> 
    </td></tr>
    </table>
  </td>
