...
<%
      ...
      String masterdoc_no=request.getParameter("masterdoc_no")==null ||  request.getParameter("masterdoc_no").equals("") ?"0":request.getParameter("masterdoc_no");
...
try{	ClsConnection ClsConnection=new ClsConnection();
 ...
 if(dtype.equalsIgnoreCase("NPO"))
 {
	...
	String sqlssd="select * from my_mcpbd where postdocno="+masterdoc_no+"";
	//System.out.println("postdocno======"+sqlssd);
