        ...
        $(document).ready(function () { 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Accountsssss Name', datafield: 'description', width: '80%' },
							{ text: 'Rate', datafield: 'rate', cellsformat:'d'+curdec ,width: '10%',hidden:true },
						]
            });
...
/*         $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
            ...
            $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
            	...
            	//document.getElementById("currate").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "rate");
            	 funRoundRate( $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "rate"), "currate");   
