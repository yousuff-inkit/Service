        ...
        $(document).ready(function () { 
            ...
            $("#jqxProductSearch").jqxGrid(
            {
             ...
             $('#jqxProductSearch').on('rowdoubleclick', function (event) {
               ...
               $('#descdetailsGrid').jqxGrid('setcellvalue', rowindex1, "unitid" ,$('#jqxProductSearch').jqxGrid('getcellvalue', rowindex2, "munit"));
               $('#descdetailsGrid').jqxGrid('setcellvalue', rowindex1, "unit" ,$('#jqxProductSearch').jqxGrid('getcellvalue', rowindex2, "unit"));
