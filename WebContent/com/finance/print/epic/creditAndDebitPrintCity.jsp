...
<jsp:include page="../../../common/printHeaderCity.jsp"></jsp:include>
</div>
...
<table width="100%">
  <tr>
    ...
    <td width="61%">: <label id="lblaccountname" name="lblaccountname"><s:property value="lblaccountname"/></label></td>
    <td width="7%" align="right">Voucher No</td>
    <td width="11%">: <label id="lbldocumentno" name="lbldocumentno"><s:property value="lbldocumentno"/></label></td>
    
  </tr>
  <tr>
    <td width="12%" align="left">Description</td>
    <td colspan="2">: <label id="lbldescription" name="lbldescription"><s:property value="lbldescription"/></label></td>
    <td width="7%" align="right">Voucher Date</td>
    <td width="11%">: <label id="lbldate" name="lbldate"><s:property value="lbldate"/></label></td>
  </tr>
   <tr>
   <td width="12%" align="left">Amount in words </td>
   ...
   <td width="11%">: <label id="lblnetamount" name="lblnetamount"><s:property value="lblnetamount"/></label></td>
  </tr>
  <tr>
  
   <td width="12%" align="left">TRN NO </td>
   <td colspan="2">: <label id="lblclientrno" name="lblclientrno"><s:property value="lblclientrno"/></label></td>
   </tr>
  ...
  <s:else>
  <tr>
   <td width="12%" align="left">Agreement Vehicle </td>
   <td colspan="2">: <label id="lblvehicleinfo" name="lblvehicleinfo"><s:property value="lblvehicleinfo"/></label></td>
   <td width="7%" align="right">Agreement </td>
   <td width="11%">: <label id="lblagreement" name="lblagreement"><s:property value="lblagreement"/></label></td>
  </tr>
  </s:else>
</table><br/>
</fieldset>
