...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		getdata(docNo,date,accId,accName,amount,description);
	}
	function getdata(docNo,date,accId,accName,amount,description){
		 $("#refreshdiv").load('cnoMainSearchGrid.jsp?docNo='+docNo+'&date='+date+'&accId='+accId+'&accName='+accName.replace(/ /g, "%20")+'&amount='+amount+'&description='+description.replace(/ /g, "%20"));
		}
