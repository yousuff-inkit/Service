			 ...
			 function funFocus(){
			  ...
			  function setValues(){
				  ...
				  funSetlabel();
					 ...
					 if(indexVal>0){
			         $("#jqxCreditNoteGrid").load("creditNoteGrid.jsp?txtcreditnotedocno2="+indexVal);
					 }
				}
...
<form id="frmCreditNote" action="saveCreditNote" method="post" autocomplete="off">
    ...
    <div class='modern-ui hidden-scrollbar' style="padding: 10px 16px;">
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtcreditnotedocno" value='<s:property value="txtcreditnotedocno"/>' tabindex="-1" readonly style="width:120px;"/>
            ...
            <div class="field-row">
                ...
                <select id="cmbtype" name="cmbtype" style="width:80px; flex-shrink:0;" onchange="clearClientInfo();" value='<s:property value="cmbtype"/>'>
                    <option value="AP">AP</option>
                    <option value="AR">AR</option>
                </select>
                <input type="hidden" id="hidcmbtype" name="hidcmbtype" value='<s:property value="hidcmbtype"/>'/>
                
                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: 15px;">Account</label>
            ...
            <div class="field-row">
                ...
                <select id="cmbcurrency" name="cmbcurrency" value='<s:property value="cmbcurrency"/>' onload="getRatevalue(this.value,$('#jqxCreditNoteDate').val());" onchange="getRatevalue(this.value,$('#jqxCreditNoteDate').val());" style="width:150px; flex-shrink:0;">
                    <option></option>
                </select>
                ...
                <input type="text" id="txtrate" name="txtrate" value='<s:property value="txtrate"/>' tabindex="-1" style="width:100px; flex-shrink:0; text-align: right;"/>
            </div>

            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                <input type="text" id="txtamount" name="txtamount" value='<s:property value="txtamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getCrTotal();" style="width:150px; flex-shrink:0; text-align: right;"/>
                
                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: 15px;">Base Amt</label>
                <input type="text" id="txtbaseamount" name="txtbaseamount" value='<s:property value="txtbaseamount"/>' tabindex="-1" readonly style="width:100px; flex-shrink:0; text-align: right;"/>
            </div>
