        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtcashpaydocno" value='<s:property value="txtcashpaydocno"/>' tabindex="-1" style="width:120px;"/>
                    <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();">Value Change</button>
                </div>
            </div>
        </div>

        <!-- Dual Panel: Cash & Payment To -->
        <div style="display: flex; gap: 15px; margin-bottom: 15px;">
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <select id="cmbfromcurrency" name="cmbfromcurrency" value='<s:property value="cmbfromcurrency"/>' onload="getRate(this.value,$('#jqxCashPaymentDate').val());" onchange="getRate(this.value,$('#jqxCashPaymentDate').val());" style="width:120px; flex-shrink:0;">
                        <option></option>
                    </select>
