	 ...
	 function funFocus()
	  ...
	  function setValues(){
		  ...
		  funSetlabel();
			 ...
			 if(indexVal>0){
	         $("#jqxBankReceiptGrid").load("bankReceiptGrid.jsp?txtbankreceiptdocno2="+indexVal);
			 }
	         
	         var indexVal1 = document.getElementById("txttodocno").value;
	         var indexVal2 = document.getElementById("txttotrno").value;
	         if(indexVal1>0){
	         $("#bankApplyInvoicing1").load("applyBankReceiptInvoicingGrid.jsp?txttoaccid1="+indexVal1+"&txttotrno1="+indexVal2); 
	         }
		}
...
#frmBankReceipt input[type="checkbox"] {
    width: 15px;
    height: 15px;
    accent-color: #007bff;
    cursor: pointer;
...
#frmBankReceipt input:disabled[type="checkbox"] {
    cursor: not-allowed;
    opacity: 0.6;
}
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtbankreceiptdocno" value='<s:property value="txtbankreceiptdocno"/>' tabindex="-1" style="width:120px;"/>
                    <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();">Value Change</button>
                </div>
            </div>
        </div>

        <!-- Dual Panel: Bank & Payment From -->
        <div style="display: flex; gap: 15px; margin-bottom: 15px;">
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <select id="cmbfromcurrency" name="cmbfromcurrency" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxBankReceiptDate').val());" style="width:120px; flex-shrink:0;">
                        <option></option>
                    </select>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtchequeno" name="txtchequeno" value='<s:property value="txtchequeno"/>' style="width:110px; flex-shrink:0;"/>
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txttoamount" name="txttoamount" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getCrTotal();getAmount();" style="width:120px; flex-shrink:0; text-align: right;"/>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="justify-content: flex-end; margin-bottom: 0;">
                ...
                <input type="text" id="txtapplyinvoiceapply" name="txtapplyinvoiceapply" value='<s:property value="txtapplyinvoiceapply"/>' tabindex="-1" style="width:100px; flex-shrink:0; text-align: right;"/>

                <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 15px;">Balance</label>
                <input type="text" id="txtapplyinvoicebalance" name="txtapplyinvoicebalance" value='<s:property value="txtapplyinvoicebalance"/>' tabindex="-1" style="width:100px; flex-shrink:0; text-align: right;"/>
            </div>
        </div>
