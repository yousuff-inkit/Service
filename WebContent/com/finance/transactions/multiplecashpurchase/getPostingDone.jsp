			 ...
			 while(rs.next()) {
			   ...
			   if(tax>0){
				...
				value=viewDAO.insert(fdate, fdate, "DIR", 0, "AP", clacno, refname, "1", "1", "", "", newdesc, session, 
						"A", vndtotal, gridarray, "CPU", request, sqlinvdate, invno,invdate, 1,  0.0, vndtotal ,1);  
