...
#frmUnclearedChequePayment input[type="text"],
#frmUnclearedChequePayment select,
.textbox {
...
#frmUnclearedChequePayment input[type="text"]:focus,
#frmUnclearedChequePayment select:focus,
.textbox:focus {
    border-color: #007bff;
}

#frmUnclearedChequePayment input[readonly],
#frmUnclearedChequePayment input:disabled,
#frmUnclearedChequePayment select:disabled,
.textbox[readonly] {
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtunclearedchequepaydocno" value='<s:property value="txtunclearedchequepaydocno"/>' tabindex="-1" style="width:120px;"/>
                    <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();">Value Change</button>
                </div>
            </div>
        </div>

        <!-- Dual Panel: Bank & Payment To -->
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <div class="input-search-container" style="width:120px; flex-shrink:0;">
                        ...
                        <svg class="magnifier-icon" onclick="var date = $('#jqxUnclearedChequePaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                    <input type="text" id="txtfromaccname" name="txtfromaccname" value='<s:property value="txtfromaccname"/>' tabindex="-1" style="flex:1; min-width:0; margin-left: 8px;"/>
                ...
                <div class="field-row">
                    ...
                    <select id="cmbfromcurrency" name="cmbfromcurrency" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxUnclearedChequePaymentDate').val());" style="width:120px; flex-shrink:0;">
                        <option></option>
                    </select>
                    ...
                    <input type="text" id="txtfromrate" name="txtfromrate" value='<s:property value="txtfromrate"/>' tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Cheque No.</label>
                    <input type="text" id="txtchequeno" name="txtchequeno" onchange="funchequedate();" value='<s:property value="txtchequeno"/>' style="width:120px; flex-shrink:0;"/>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txtchequename" name="txtchequename" value='<s:property value="txtchequename"/>' style="flex:1; min-width:0;"/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txtfromamount" name="txtfromamount" value='<s:property value="txtfromamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getCrTotal();" style="width:120px; flex-shrink:0; text-align: right;"/>

                    <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: 15px;">Base Amt</label>
                    <input type="text" id="txtfrombaseamount" name="txtfrombaseamount" value='<s:property value="txtfrombaseamount"/>' tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <div class="input-search-container" style="width:120px; flex-shrink:0; margin-left: 8px;">
                        ...
                        <svg class="magnifier-icon" onclick="var date = $('#jqxUnclearedChequePaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+date);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>

                    <input type="text" id="txttoaccname" name="txttoaccname" value='<s:property value="txttoaccname"/>' tabindex="-1" style="flex:1; min-width:0; margin-left: 8px;"/>
                    <input type="hidden" id="txttodocno" name="txttodocno" value='<s:property value="txttodocno"/>'/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Currency</label>
                    <select id="cmbtocurrency" name="cmbtocurrency" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxUnclearedChequePaymentDate').val());" style="width:120px; flex-shrink:0;">
                        <option></option>
                    </select>
                    ...
                    <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 15px;">Rate</label>
                    <input type="text" id="txttorate" name="txttorate" value='<s:property value="txttorate"/>' tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>

                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txttoamount" name="txttoamount" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getDrTotal();" style="width:120px; flex-shrink:0; text-align: right;"/>

                    <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: 15px;">Base Amt</label>
                    <input type="text" id="txttobaseamount" name="txttobaseamount" value='<s:property value="txttobaseamount"/>' tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>
            </div>
        </div>
