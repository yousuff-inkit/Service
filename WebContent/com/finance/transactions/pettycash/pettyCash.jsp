        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width:150px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="if($('#mode').val()!='view'){ var date = $('#jqxPettyCashDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+date); $('#txtforsearch').val(2); }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtrate" name="txtrate" value='<s:property value="txtrate"/>' onblur="funRoundRate(this.value,this.id);" tabindex="-1" style="width:100px; flex-shrink:0; text-align: right;"/>
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                <input type="text" id="txtamount" name="txtamount" value='<s:property value="txtamount"/>' readonly onblur="funRoundAmt(this.value,this.id);" tabindex="-1" style="width:150px; flex-shrink:0; text-align: right;"/>
