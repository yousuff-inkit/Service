    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtbankpaydocno" value='<s:property value="txtbankpaydocno"/>' tabindex="-1" readonly style="width:120px;"/>
                    <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();">Value Change</button>
                </div>
            </div>
        </div>

        <!-- Dual Panel: Bank Info & Payment To -->
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <div class="input-search-container" style="width:120px; flex-shrink:0;">
                        ...
                        <svg class="magnifier-icon" onclick="if($('#mode').val()!='view'){ var date = $('#jqxBankPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+date); }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                ...
                <div class="field-row">
                    ...
                    <select id="cmbfromcurrency" name="cmbfromcurrency" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxBankPaymentDate').val());" style="width:120px; flex-shrink:0;">
                        <option></option>
                    </select>
                    ...
                    <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 10px;">Rate</label>
                    <input type="text" id="txtfromrate" name="txtfromrate" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:70px; flex-shrink:0; margin-top:2px;">
                        <input type="checkbox" id="chckpdc" name="chckpdc" style="vertical-align: middle; margin: 0 4px 0 0;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxBankPaymentDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));"> PDC
                    </label>
                    ...
                    <input type="text" id="txtchequeno" name="txtchequeno" onblur="getChequeNoAlreadyExists(this.value,$('#txtfromdocno').val(),$('#mode').val(),$('#docno').val());" value='<s:property value="txtchequeno"/>' style="width:80px; flex-shrink:0;"/>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:70px; flex-shrink:0;">Chq Name</label>
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 10px;">Base Amt</label>
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <div class="input-search-container" style="width:120px; flex-shrink:0; margin-left: 8px;">
                        ...
                        <svg class="magnifier-icon" onclick="if($('#mode').val()!='view'){ var date = $('#jqxBankPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+date); }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                ...
                <div class="field-row">
                    ...
                    <input type="text" id="txttorate" name="txttorate" value='<s:property value="txttorate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountTo();getDrTotal();" tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txttoamount" name="txttoamount" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getDrTotal();getAmount();" style="width:120px; flex-shrink:0; text-align: right;"/>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="justify-content: flex-end; margin-bottom: 0;">
                ...
                <input type="text" id="txtdrtotal" name="txtdrtotal" value='<s:property value="txtdrtotal"/>' tabindex="-1" readonly style="width:120px; flex-shrink:0; text-align: right;"/>
                
                <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 15px;">Cr. Total</label>
                <input type="text" id="txtcrtotal" name="txtcrtotal" value='<s:property value="txtcrtotal"/>' tabindex="-1" readonly style="width:120px; flex-shrink:0; text-align: right;"/>
            </div>
        </div>
