...
<title>GatewayERP(i)</title>
	...
	function getdata(docNo,date,accId,accName,amount,description){
		 $("#refreshdiv").load('dnoMainSearchGrid.jsp?docNo='+docNo+'&date='+date+'&accId='+accId+'&accName='+accName.replace(/ /g, "%20")+'&amount='+amount+'&description='+description.replace(/ /g, "%20"));
		}
