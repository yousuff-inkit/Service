			 ...
			 function funFocus(){
			  ...
			  function funNotify(){	
				  /* Validation */
					...
					currencyto=document.getElementById("cmbcurrency").value;
					 acnoto=document.getElementById("txtaccid").value;
			  ...
			  function setValues(){
				  ...
				  funSetlabel();
					 ...
					 if(indexVal>0){
			         $("#jqxDebitNoteGrid").load("debitNoteGrid.jsp?txtdebitnotedocno2="+indexVal);
					 }
				}
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <button class="myButton" type="button" id="btnvaluechange" name="btnvaluechange" onclick="funwarningopen();" style="margin-left: 8px;">Value Change</button>

                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: auto;">Doc No.</label>
                <input type="text" id="docno" name="txtdebitnotedocno" value='<s:property value="txtdebitnotedocno"/>' tabindex="-1" style="width:120px; flex-shrink:0;"/>
            </div>

            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Type</label>
                <select id="cmbtype" name="cmbtype" onchange="clearClientInfo();" value='<s:property value="cmbtype"/>' style="width:80px; flex-shrink:0;">
                ...
                <input type="text" id="txtaccname" name="txtaccname" value='<s:property value="txtaccname"/>' tabindex="-1" style="flex:1; min-width:0; margin-left: 8px;"/>
            ...
            <div class="field-row">
                ...
                <select id="cmbcurrency" name="cmbcurrency" value='<s:property value="cmbcurrency"/>' onload="getRatevalue(this.value,$('#jqxDebitNoteDate').val());" onchange="getRatevalue(this.value,$('#jqxDebitNoteDate').val());" style="width:120px; flex-shrink:0;">
                    <option></option>
                </select>
                ...
                <input type="text" id="txtrate" name="txtrate" value='<s:property value="txtrate"/>' tabindex="-1" style="width:120px; flex-shrink:0; text-align: right;"/>
            </div>

            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                <input type="text" id="txtamount" name="txtamount" value='<s:property value="txtamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getDrTotal();" style="width:120px; flex-shrink:0; text-align: right;"/>

                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left: 15px;">Base Amt</label>
                <input type="text" id="txtbaseamount" name="txtbaseamount" value='<s:property value="txtbaseamount"/>' tabindex="-1" style="width:120px; flex-shrink:0; text-align: right;"/>
            </div>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="justify-content: flex-end; margin-bottom: 0;">
                ...
                <input type="text" id="txtdrtotal" name="txtdrtotal" value='<s:property value="txtdrtotal"/>' tabindex="-1" style="width:120px; flex-shrink:0; text-align: right;"/>
