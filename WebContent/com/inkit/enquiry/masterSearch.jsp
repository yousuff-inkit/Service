...
<script type="text/javascript">
	...
	$(document).ready(function () {}); 
 	...
 	function mainloadSearch() {
 		...
 		getdata(sclname,smob,dno,RefNo,id);

	}
 	
	function getdata(sclname,smob,dno,RefNo,id){
		 $("#srefreshdiv").load('submainSearch.jsp?sclname='+sclname.replace(/ /g, "%20")+'&smob='+smob.replace(/ /g, "%20")+'&dno='+dno+'&RefNo='+RefNo.replace(/ /g, "%20")+'&id='+id);
	} 
