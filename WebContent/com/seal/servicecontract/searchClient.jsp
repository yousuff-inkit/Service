        ...
        $(document).ready(function () { 
            ...
            $("#Jqxclientsearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'MOB', datafield: 'per_mob', width: '15%' ,hidden:true},
					 ...
					 { text: 'curid', datafield: 'curid', width: '20%',hidden:true },
					]
            });
          /*   $("#Jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#Jqxclientsearch').on('rowdoubleclick', function (event) 
				               ...
				               document.getElementById("currencyid").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "curid");
				               document.getElementById("hidcmbcurrencyid").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "curid");
				               getRates(); 
