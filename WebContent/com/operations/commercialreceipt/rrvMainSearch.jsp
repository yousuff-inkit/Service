...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		...
		getdata(accountName,srNo,date,total,refNo,clientmobile);
	}
	function getdata(accountName,srNo,date,total,refNo,clientmobile){
		 $("#refreshdiv").load('rrvMainSearchGrid.jsp?accountName='+accountName.replace(/ /g, "%20")+'&srNo='+srNo+'&date='+date+'&total='+total+'&refNo='+refNo+'&mobile='+clientmobile);
		}
...
<table width="100%">
  <tr>
    ...
    <td width="19%"><input type="text" name="txtaccountname" id="txtaccountname" autocomplete="off" style="width:85%" value='<s:property value="txtaccountname"/>'></td>
    <td width="8%" align="right">Mobile</td>
    <td width="25%"><input type="text" name="clientmobileno" id="clientmobileno" style="width:80%;" value='<s:property value="clientmobileno"/>'>
