  ...
  $(document).ready(function () { 	
     ...
     $("#subEnqirySearch").jqxGrid(
     {
         ...
         columns: [
				...
				{ text: 'subcatgory', datafield: 'subcategory', width: '20%',hidden:true },		
				{ text: 'Salesman', datafield: 'sal_id', width: '20%',hidden:true },		
				{ text: 'Salesman Docno', datafield: 'sal_name', width: '20%',hidden:true },		
     ...
     $('#subEnqirySearch').on('rowdoubleclick', function (event) 
 	 ...
 	 var cldocnval=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "enqtype");
       ...
       $('#EnquiryDate').val($("#subEnqirySearch").jqxGrid('getcellvalue', rowindex1, "date")) ;
              ...
              document.getElementById("txtcat").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "category");
              document.getElementById("txtsubcat").value=$('#subEnqirySearch').jqxGrid('getcellvalue', rowindex1, "subcategory");
