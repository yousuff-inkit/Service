         ...
         //	var url1;
            ...
            $("#Jqxclientsearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'MOB', datafield: 'per_mob', width: '15%' ,hidden:true},
					 ...
					 { text: 'Category', datafield: 'catname', width: '20%',hidden:true },
					 { text: 'Subcategory', datafield: 'subcatname', width: '20%',hidden:true },
          ...
          /*   $("#Jqxclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#Jqxclientsearch').on('rowdoubleclick', function (event) 
							   ...
							   document.getElementById("txtcat").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "catname");
							   document.getElementById("txtsubcat").value=$('#Jqxclientsearch').jqxGrid('getcellvalue', rowindex1, "subcatname");
