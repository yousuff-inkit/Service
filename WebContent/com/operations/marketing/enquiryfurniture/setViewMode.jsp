...
ClsCommon ClsCommon=new ClsCommon();
	...
	try{
		...
		String 	telno="",doc_no="",voc_no="",date="",remarks="",cldocno="",name="",com_add1="",mob="",email="",enqtype="",sourceid="",source="",
				cperson="",cpersonid="",contrmode="",sjobtype="",surveyed="",sal_id="",sal_name="";
	...
	//	String branchid=session.getAttribute("BRANCHID").toString();
		...
		String str1Sql=("select telno,m.doc_no,voc_no,m.date,remarks,m.cldocno,name,com_add1,coalesce(ct.mob,'') mob,coalesce(ct.email,'') email,enqtype,sourceid,coalesce(txtname,'') as source,"
				+ "m.cperson,cpersonid,contrmode,sm.sal_name,sm.sal_id,m.sjobtype,m.surveyed from gl_enqm m left join cm_enqsource s on(m.sourceid=s.doc_no) "
...
mob+"###"+email+"###"+enqtype+"###"+sourceid+"###"+source+"###"+cperson+"###"+cpersonid+"###"+contrmode+"###"+sjobtype+"###"+surveyed+"###"+sal_id+"###"+sal_name);
