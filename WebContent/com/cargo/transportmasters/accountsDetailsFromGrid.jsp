...
<%
ClsServiceTypeDAO viewDAO=new ClsServiceTypeDAO();
...
String den=request.getParameter("den")==null || request.getParameter("den")=="" ?"0":request.getParameter("den").trim();
%>
<script type="text/javascript">
var nipur;
<%-- alert("den==="+'<%=den%>'); --%> 
var chkden='<%=den%>'; 
	nipur= '<%=viewDAO.accountsDetailsTo(den) %>';
        ...
        $(document).ready(function () { 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
             ...
             $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
            	...
            	//alert("====chkden===="+chkden);
                 if(chkden==110){
            		 document.getElementById("inaccdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                     document.getElementById("inaccid").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "account");
                	 document.getElementById("inaccname").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "description");
            	 }
            	 if(chkden==115){
            		 document.getElementById("exaccdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                     document.getElementById("exaccid").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "account");
                	 document.getElementById("exaccname").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "description");
            	 }
