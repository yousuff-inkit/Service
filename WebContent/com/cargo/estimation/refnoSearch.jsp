...
.myButtons:active {
	...
	function getdatas(docnoss,datess,aa,client){
		 $("#refsearch").load('subrefnosearch.jsp?docnoss='+docnoss+'&datess='+datess+'&aa='+aa+'&client='+client);
	}  
</script>
<body bgcolor="#E0ECF8">
<div id=search>
<table width="100%" >
  ...
  <table width="100%" >
     ...
     <td width="29%"><input type="text" name="client" id="client"  style="width:90%;" value='<s:property value="client"/>'></td>
