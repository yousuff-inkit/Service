        ...
        $(document).ready(function () { 	
            ...
            $("#bcodesearchgrid").on('celldoubleclick', function (event) 
         	 ...
         	 var rowno =  document.getElementById("rowindex").value;
    		   ...
    		   $('#prdGridID').jqxGrid('setcellvalue', rowno, "bevcodename" ,$('#bcodesearchgrid').jqxGrid('getcellvalue', rowindextemp, "code"));
               $('#prdGridID').jqxGrid('setcellvalue', rowno, "bevcode" ,$('#bcodesearchgrid').jqxGrid('getcellvalue', rowindextemp, "doc_no"));
