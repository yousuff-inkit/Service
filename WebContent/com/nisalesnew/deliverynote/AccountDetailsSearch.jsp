...
<script type="text/javascript">
	...
	function getClientAccountDetails(clientaccountno,clientaccountname,clientmobile,curr,accounttype,code,debitcredit,date,checked){
		 $("#refreshClientAccountDiv").load("AccountDetailsSearchGrid.jsp?accountno="+clientaccountno+'&accountname='+clientaccountname.replace(/ /g, "%20")+'&mobile='+clientmobile+'&currency='+curr+'&atype='+accounttype+'&dtype='+code+'&debitcredit='+debitcredit+'&date='+date+'&check='+checked);
	}
...
<table width="100%" >
  <tr>
    ...
    <td width="20%"><input type="text" name="accountsno" id="accountsno" style="width:70%;" value='<s:property value="accountsno"/>'></td>
