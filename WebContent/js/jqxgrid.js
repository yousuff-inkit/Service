                ...
                this.addHandler(this.gridmenu, "keydown", function (F) {
                    if (F.keyCode == 27) {
                        ...
                        if (F.keyCode == 13 && r.filterable) {
                            if (r._buildfilter) {
                                var E =
                                    b(b.find("#filter1" + r.element.id))
                                        .jqxDropDownList("container")
                                        .css("display") == "block";
                                var D =
                                    b(b.find("#filter2" + r.element.id))
                                        .jqxDropDownList("container")
                                        .css("display") == "block";
                                var B =
                                    b(b.find("#filter3" + r.element.id))
                                        .jqxDropDownList("container")
                                        .css("display") == "block";
                ...
                if (I != null) {
                    var K = b(
                        '<div class="iconscontainer" style="height: ' +
                            ...
                            g +
                            'px; float: right; display: none; width: 16px;"><div class="' +
                            u.toTP("jqx-grid-column-sortascbutton") +
                            " " +
                            u.toTP("jqx-icon-arrow-up") +
        ...
        _rendercolumnheader: function (h, i, e, d) {
            ...
            if (this.enableellipsis) {
                return (
                    ...
                    i +
                    "; margin-left: 4px; margin-right: 2px; margin-bottom: " +
                    g +
                    "; margin-top: " +
                    g +
