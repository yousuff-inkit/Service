...
public class ClsRentalReceiptsAction extends ActionSupport{
	...
	private String lblbrhid,cmbcontracttype,txtcontractno,txtcontracttrno,txtcontractdetails,hidcmbcontracttype;
	...
	try{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			String agreement=getTxtcontractno();
			if(agreement==null){
				agreement="";
			}
			...
			int val=rentalReceiptsDAO.insert(conn,rentalReceiptsDate,getFormdetailcode(),getCmbpaytype(),getTxtdocno(),getCmbcardtype(),getTxtrefno(),referenceDate,getTxtdescription(),getHidchckib(),
					getCmbbranch(),getTxtcldocno(),getTxtacno(),getCmbcontracttype(),agreement,getCmbpayedas(),getTxtamount(),getTxtdiscount(),getTxtaddcharges(),getTxtamounts(),
			...
			if(val>0.0){
				...
				setChkstatus("1");
				conn.close();
				rentalReceiptsBean = (ClsRentalReceiptsBean)request.getAttribute("rrBean");  
				//System.out.println("rentalReceiptsBean===="+rentalReceiptsBean);   
			...
			boolean Status=rentalReceiptsDAO.edit(conn,getTxtrentalreceiptdocno(),getFormdetailcode(),rentalReceiptsDate,getTxttranno(),getTxtdoctype(),getTxtsrno(),getCmbpaytype(),getTxtdocno(),
					getCmbcardtype(),getTxtrefno(),referenceDate,getTxtdescription(),getHidchckib(),getCmbbranch(),getTxtcldocno(),getTxtacno(),getCmbcontracttype(),getTxtcontractno(),
		...
		boolean Status=rentalReceiptsDAO.delete(conn,getTxtrentalreceiptdocno(),getFormdetailcode(),getTxtsrno(),getTxttranno(),getTxtdoctype(),getTxtacno(),getCmbpayedas(),getCmbcontracttype(),getTxtcontractno(),session);
		if(Status){
				setTxtrentalreceiptdocno(getTxtrentalreceiptdocno());
				setTxttranno(getTxttranno());
				setTxtsrno(getTxtsrno());
			...
			return "fail";
				...
				setHidcmbcontracttype(rentalReceiptsBean.getHidcmbcontracttype());
				setTxtcontractno(rentalReceiptsBean.getTxtcontractno());
	...
	public String printAction() throws ParseException, SQLException{
		...
		setUrl(ClsCommon.getPrintPath("CRT"));
