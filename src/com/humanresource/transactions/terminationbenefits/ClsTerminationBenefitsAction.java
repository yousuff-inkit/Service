	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
			...
			/*Journal Voucher Grid Ends*/
						...
						int val=terminationBenefitsPostingDAO.insert(getFormdetailcode(),getBrchName(),terminationBenfitDate,getTxtdeprtotal(),employeedetailsarray,journalvouchersarray,session,request,mode);
						if(val>0.0){
							setTxtjvno(val);
