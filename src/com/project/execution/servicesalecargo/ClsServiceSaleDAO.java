...
import com.project.execution.servicesalecargo.ClsServiceSaleBean;
...
public class ClsServiceSaleDAO  {
	...
	ClsServiceSaleBean servicesalecargoBean = new ClsServiceSaleBean();
...
//			 				System.out.println("+sql1 status++--"+ss);
	...
	String sqlss10="delete from my_jvtran where dramount=0 and tr_no='"+tranno+"'";
		...
		return docno;
			 ...
			 servicesalecargoBean.setValidmsg(validmsg);
			 request.setAttribute("pintbean", servicesalecargoBean);
