...
public class ClsQuotationBean {
	...
	private String contractvocno,lblusersales,lblpreparedby,emiratedocno,apprmobno,appremail,apprdesgnation,comprefns,hidlatestrevno,txtnotes;      
    ...
    public String getAmclen() {
        return amclen;
    }
    public void setAmclen(String amclen) {
        this.amclen = amclen;
    }
