...
import com.dashboard.inkit.assignjobfollowup.AssignJobFollowupBean;
import com.dashboard.inkit.assignjobfollowup.AssignJobFollowupDAO;
...
public class AssignJobFollowupAction {
	...
	private String lblname,lblsite,lblcntprsn,lblcontact,lblamc,lbldocnno,lbljobdat,lbldocno,lblarea,lbldescription,lbldtype;
	...
	public String printAction1() throws ParseException, SQLException{
		...
		AssignJobFollowupBean=AssignJobFollowupDAO.getPrintk(request,docno,dtype,srno,branch);
	...
	*/
	...
	public String printActionCreg() throws ParseException, SQLException{
		...
		System.out.println("+++++++++++++++++inside print action "+branch+header+docno+trno);
		AssignJobFollowupBean=AssignJobFollowupDAO.getPrint(request,docno,branch,header,trno);
		
		//System.out.println("+++++++++++++++++"+branch+header+docno+trno);
		...
		setLblsite(AssignJobFollowupBean.getLblsite());
		setLbldocnno(AssignJobFollowupBean.getLbldocnno());
		setLbldtype(AssignJobFollowupBean.getLbldtype());
		setLblschno(AssignJobFollowupBean.getLblschno());
		setLblarea(AssignJobFollowupBean.getLblarea());
		setLblclientlpo(AssignJobFollowupBean.getLblclientlpo());
		setLbldescription(AssignJobFollowupBean.getLbldescription());
