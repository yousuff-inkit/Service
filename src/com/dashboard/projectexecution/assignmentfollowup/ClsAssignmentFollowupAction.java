...
public class ClsAssignmentFollowupAction {

	ClsAssignmentFollowupDAO AssignJobFollowupStatusDAO= new ClsAssignmentFollowupDAO();
	ClsAssignmentFollowupBean AssignJobFollowupStatusBean;
	...
	public String printAction1() throws ParseException, SQLException{
		...
		AssignJobFollowupStatusBean=AssignJobFollowupStatusDAO.getPrint(request,docno,dtype,srno,branch);
		
		setLblclname(AssignJobFollowupStatusBean.getLblclname());
		setLblsite(AssignJobFollowupStatusBean.getLblsite());
		setLblcompname(AssignJobFollowupStatusBean.getLblcompname());
		setLblcompaddress(AssignJobFollowupStatusBean.getLblcompaddress());
		setLblcomptel(AssignJobFollowupStatusBean.getLblcomptel());
		setLblcompfax(AssignJobFollowupStatusBean.getLblcompfax());
		setLblbranch(AssignJobFollowupStatusBean.getLblbranch());
		setLbllocation(AssignJobFollowupStatusBean.getLbllocation());
		setLblprintname("JOB SHEET");
		setFirstarray(AssignJobFollowupStatusBean.getFirstarray());
		setLblcntprsn(AssignJobFollowupStatusBean.getLblcntprsn());
		setLblcontact(AssignJobFollowupStatusBean.getLblcontact());
		setLblamc(AssignJobFollowupStatusBean.getLblamc());
		setLbldocnno(AssignJobFollowupStatusBean.getLbldocnno());
		setLbljobdat(AssignJobFollowupStatusBean.getLbljobdat());
		setLblstype(AssignJobFollowupStatusBean.getLblstype());
		/*setLblcompaddress(AssignJobFollowupStatusBean.getLblcompaddress());
		setLblprintname(AssignJobFollowupStatusBean.getLblprintname());
		setLblprintname1(AssignJobFollowupStatusBean.getLblprintname1());
		setLblcomptel(AssignJobFollowupStatusBean.getLblcomptel());
		setLblcompfax(AssignJobFollowupStatusBean.getLblcompfax());
		setLblbranch(AssignJobFollowupStatusBean.getLblbranch());
		setLbllocation(AssignJobFollowupStatusBean.getLbllocation());
		setLblname(AssignJobFollowupStatusBean.getLblname());
		setLblacno(AssignJobFollowupStatusBean.getLblacno());
		setLbladdress(AssignJobFollowupStatusBean.getLbladdress());
		setLblmobno(AssignJobFollowupStatusBean.getLblmobno());
		setLblcodeno(AssignJobFollowupStatusBean.getLblcodeno());
