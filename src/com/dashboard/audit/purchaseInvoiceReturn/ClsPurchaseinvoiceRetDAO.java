package com.dashboard.audit.purchaseInvoiceReturn;
...
public class ClsPurchaseinvoiceRetDAO {
	
	ClsConnection ClsConnection=new ClsConnection();
	ClsCommon ClsCommon=new ClsCommon();
	
	public   JSONArray purchaseInvoiceReturnGrid(String branch,String fromdate,String todate) throws SQLException {
		...
		try {
            	...
            	System.out.println("------purchaseInvoiceReturnGrid-----"+sql);	
	...
	public   JSONArray purchaseInvoiceReturnDetailGrid(String docno) throws SQLException {
		...
		try {
            	...
            	System.out.println("------purchaseInvoiceReturnDetailGrid-----"+sql);	
            		ResultSet resultSet = stmtVeh.executeQuery(sql);
            		 RESULTDATA=ClsCommon.convertToJSON(resultSet);
     				stmtVeh.close();
