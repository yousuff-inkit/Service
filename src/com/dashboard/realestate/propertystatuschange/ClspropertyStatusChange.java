package com.dashboard.realestate.propertystatuschange;
...
public class ClspropertyStatusChange  { 
	...
	public JSONArray propertyStatusChange(String branch,String fromdate,String todate,String check) throws SQLException {
		...
		try {
				...
				sql="select j.voc_no,j.doc_no,j.name prop_name,o.primary_owner  prop_owner,j.address,j.landmark,j.area,j.desc1 description from rl_propertymaster j"
						+" left join rl_propertryowner o on o.doc_no=j.owid where j.status=3 and j.active=1 and j.cnt_no=0  "+sql+" group by j.doc_no ";
