package com.dashboard.realestate.tenancycontractexpiry;
...
import net.sf.json.JSONArray;
	...
	public class ClsTenancyContractExpiryDAO {
		...
		public JSONArray fupGridLoad(HttpSession session,String docno) throws SQLException{
			...
			try {
				...
				sql="select date,description from gl_contrexp where rdocno="+docno+"";

				System.out.println("===fupsql===="+sql);
		...
		public   JSONArray listsearch(String branch,String fromdate,String todate,String aa,String cldocno,String prdocno) throws SQLException {
	        ...
	        java.sql.Date sqltodate = null;
	     	if(!(todate.equalsIgnoreCase("undefined"))&&!(todate.equalsIgnoreCase(""))&&!(todate.equalsIgnoreCase("0")))
	     	{
	     		...
	     		sqltest+=" and m.date<='"+sqltodate+"' and m.period_to<'"+sqltodate+"' ";
			...
			try {
				...
				conn = ClsConnection.getMyConnection();
					...
					String sql=" select m.voc_no ,m.doc_no,m.brhid, m.date,m.ttype , m.cldocno,a.refname,pm.name pname,cc.amount,pc.pamount, "
							...
							+" left join my_acbook a on a.acno=m.acno  where m.status=3 and m.clstatus=0  "+sqltest+" group by m.doc_no  ";
		...
		public   JSONArray listsearchexcel(String branch,String fromdate,String todate,String aa,String cldocno,String prdocno) throws SQLException {
