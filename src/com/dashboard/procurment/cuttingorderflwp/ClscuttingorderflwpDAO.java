package com.dashboard.procurment.cuttingorderflwp;
...
public class ClscuttingorderflwpDAO {
	...
	public   JSONArray nipurchaseReports(String fromdate,String todate,String client,String type,int id) throws SQLException {
        ...
        java.sql.Date sqltodate = null;
     	...
     	if(!(client.equalsIgnoreCase(null)) && !(client.equalsIgnoreCase("")) && !(client.equalsIgnoreCase("undefined")) && !(client.equalsIgnoreCase("NaN"))){
           ...
           String sqlsal="";
           sqlsal="select d.sr_no srno,m.doc_no docno,d.rowno,m.costtype,m.costcode,m.sal_id,bb.code bevcodename,pp.code polcodename,d.floor, d.flat flatids, d.Width, d.height, d.qty quantity,  d.sqm as totsqm, d.totsize, d.price,   d.bcode bevcode, d.brate bevrate,"
           		    + " d.bvalue bevvalue, d.pcode polcode, d.prate polrate, d.pcharge polcharge, d.temp,d.specno  specid ,m.voc_no invno,m.date invdate,"
           		    + "br.branchname,h.description customername,d.sr_no,d.psrno,d.prdId prodoc, u.unit, d.unitid unitdocno,"
      	            ...
      	            +" left join my_salm s on m.sal_id=s.doc_no left join my_unitm u on d.unitid=u.doc_no left join my_ccentre c on c.costcode=m.costcode and m.costtype=1"
      	            ...
      	            +" left join my_corcode pp on pp.doc_no=d.pcode and pp.dtype='PLC' left join my_corcode bb on bb.doc_no=d.bcode and bb.dtype='BLC' "
      	            +sqljoin+" where m.status=3 and d.outsourcejob=0"+sqltest+" ";
          /* if(id==1){
