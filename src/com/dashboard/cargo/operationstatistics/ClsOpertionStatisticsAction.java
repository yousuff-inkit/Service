...
public class ClsOpertionStatisticsAction {
	...
	public String printAction() throws ParseException, SQLException{           
	    ...
	    HttpServletResponse response = ServletActionContext.getResponse();
			 ...
			 try {	
			        ...
			        JasperDesign design = JRXmlLoader.load(request.getSession().getServletContext().getRealPath("com/dashboard/cargo/operationstatistics/costsheetprint.jrxml"));     
