...
import com.common.ClsCommon;
	...
	public class ClsSkipmasterAction {

		ClsSkipmasterDAO skipmasterDAO= new ClsSkipmasterDAO();
		...
		public String saveAction() throws ParseException, SQLException{
			...
			if(mode.equalsIgnoreCase("A")){
							...
							int val=skipmasterDAO.insert(getTxtcode(), getTxtname(),getCmbtype(),getMode(),session,getFormdetailcode());
							if(val>0){
				...
				int Status=skipmasterDAO.edit(getTxtcode(), getTxtname(),getCmbtype(),getDocno(),getMode(),session,getFormdetailcode());
				if(Status>0){
					setTxtcode(getTxtcode());
					setTxtname(getTxtname());
					setCmbtype(getCmbtype());
				...
				boolean Status=skipmasterDAO.delete(getDocno(),session,getMode(),getFormdetailcode());
			if(Status){
				setTxtcode(getTxtcode());
				setTxtname(getTxtname());
				setCmbtype(getCmbtype());
