...
public class ClsClientAction  extends ActionSupport {
	...
	public String saveClientMaster() throws ParseException, SQLException {
		...
		try{
            ...
            if(getCmbsubcategory()>0)
            {
                String x=getCmbcategory()+"000"+getCmbsubcategory();
                setCmbcategory(Integer.parseInt(x));
			...
			if(mode.equalsIgnoreCase("A")){
				...
				setCmbsubcategory(clbean.getCmbsubcategory());
                setHidcmbsubcategory(clbean.getHidcmbsubcategory());
               // System.out.println("Subcategory==="+clbean.getHidcmbcategory());    
	...
	public void reloadData(int docno)
	{
		...
		setCmbsalesmanid(getCmbsalesmanid());
		  if(String.valueOf(getCmbcategory()).contains("000"))
		  {
		      String[] catarray=String.valueOf(getCmbcategory()).split("000");
		      setCmbcategory(Integer.parseInt(catarray[0]));
              setHidcmbcategory(Integer.parseInt(catarray[0]));
       ...
       // System.out.println("Subcat====="+getHidcmbcategory());
