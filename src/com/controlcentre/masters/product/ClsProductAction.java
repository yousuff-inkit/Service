...
public class ClsProductAction  {
	...
	// hsn code 
	private String cmbhsn;
	private String txthsn;

	private String hiddetachconfig,warranty,hidewarranty;


    private int specMastersGridlen;
    private int hiddocno;

	private int specGridlen,jqxsedinglength,alterGridlen;
	private int suitGridlen;
	private int uomGridlen;
	private int proGridlen,cmbstar,warrantydays,hidewarrantydays,hidecmbstar,cmbmastertype,hidcmbmastertype;
    ...
    public String getHidewarranty() {
        return hidewarranty;
    }

    public void setHidewarranty(String hidewarranty) {
    ...
    public int getHidewarrantydays() {
        return hidewarrantydays;
    }

    public void setHidewarrantydays(int hidewarrantydays) {
        this.hidewarrantydays = hidewarrantydays;
    }

    public String getHiddetachconfig() {
        return hiddetachconfig;
    }

    public void setHiddetachconfig(String hiddetachconfig) {
        this.hiddetachconfig = hiddetachconfig;
    }

    public String getCmbhsn() {
        return cmbhsn;
    }

    public void setCmbhsn(String cmbhsn) {
        this.cmbhsn = cmbhsn;
    }

    public String getTxthsn() {
        return txthsn;
    }

    public void setTxthsn(String txthsn) {
        this.txthsn = txthsn;
    }
	...
	public int getSpecMastersGridlen() {
        return specMastersGridlen;
    }

    public void setSpecMastersGridlen(int specMastersGridlen) {
        this.specMastersGridlen = specMastersGridlen;
    }
	...
	public ClsProductAction(String warranty, String hidewarranty,int warrantydays, int hidewarrantydays, String hiddetachconfig) {
        super();
        this.hiddetachconfig = hiddetachconfig;
        this.warranty = warranty;
        this.hidewarranty = hidewarranty;
    ...
    public String saveProductAction(){
        ClsProductAction clsProductAction=new ClsProductAction(getWarranty(), getHidewarranty(), getWarrantydays(), getHidewarrantydays(),getHiddetachconfig());
		...
		try{
			...
			ArrayList<String> specMastersarray = new ArrayList<>();
			...
			if(mode.equalsIgnoreCase("A")){
				...
				for(int i=0;i< getSpecMastersGridlen(); i++) {
                    String temp5 = requestParams.get("specMasters"+i)[0];
                    specMastersarray.add(temp5);
                }
				...
				val=DAO.insert(date,getTxtproductname(),getTxtproductcode(),getTxtbarcode(),getCmbproducttype(),getCmbbrand(),getCmbcategory(),
                        ...
                        prodarray,uomarray,specMastersarray,suitarray,specarray,session,getComorbranch(),pmgntarray,getCmbstar(),getCmbmastertype(),getTxtarbicprdname(),ssarray,getDesc1(),alterarray,getCmbhsn(),clsProductAction,request);
				...
				if(val>0){
					...
					setHidewarranty(getWarranty());
                    setHidewarrantydays(getWarrantydays());
				...
				for (int i = 0; i < getSpecMastersGridlen(); i++) {
                    String temp1 = requestParams.get("specMasters" + i)[0];
                    specMastersarray.add(temp1);
                }
				...
				val=DAO.update(getDocno(),date,getTxtproductname(),getTxtproductcode(),getTxtbarcode(),getCmbproducttype(),getCmbbrand(),getCmbcategory(),
						getCmbsubcategory(),getCmbunit(),getCmbdept(),getMode(),getFormdetailcode(),prodarray,uomarray,specMastersarray,suitarray,specarray,
						session,getComorbranch(),pmgntarray,getCmbstar(),getCmbmastertype(),getTxtarbicprdname(),ssarray,getDesc1(),alterarray,getCmbhsn(),clsProductAction,request);
				...
				val=DAO.delete(getDocno(),date,getTxtproductname(),getTxtproductcode(),getTxtbarcode(),getCmbproducttype(),getCmbbrand(),getCmbcategory(),
						getCmbsubcategory(),getCmbunit(),getCmbdept(),getMode(),getFormdetailcode(),prodarray,uomarray,suitarray,specarray,session,getTxthsn(),request);
			...
			if(mode.equalsIgnoreCase("view")){
				...
				setHidewarrantydays(bean.getWarrantydays());
				setHidewarranty(bean.getWarranty());
				...
				setTxthsn(bean.getTxthsn());
				setCmbhsn(bean.getCmbhsn());
