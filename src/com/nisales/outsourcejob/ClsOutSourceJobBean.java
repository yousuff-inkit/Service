...
public class ClsOutSourceJobBean {
	...
	private String  lblcompname,lblcompaddress,lblcomptel,lblcompfax,lblbranch,lbllocation,lblprintname,lbltrnno,lbltotqty;	
	...
	public String getLbltotqty() {
		return lbltotqty;
	}


	public void setLbltotqty(String lbltotqty) {
		this.lbltotqty = lbltotqty;
	}
