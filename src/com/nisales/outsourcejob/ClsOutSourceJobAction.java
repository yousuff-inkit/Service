...
import com.nisales.cuttingorder.ClsCuttingOrderDAO;

public class ClsOutSourceJobAction {
	private int itemtype,itemdocno,docno,accid,costtr_no,hideitemtype,gridlenght,masterdoc_no,salid,acno,currsid;
	...
	private String  hideacctype,hiddate, hidfixDate,hiddeliveryDate,hiddeliveryTime,mode,deleted,msg;
	
	
	private String  lblcompname,lblcompaddress,lblcomptel,lblcompfax,lblbranch,lbllocation,lblprintname,lbltrnno;	
...
//	
	 ...
	 private int logo;
	 private String lbltotsize,totsqm,totqty;
	 private Map<String, Object> param=null;
		...
		public String getTotsqm() {
			return totsqm;
		}
		public void setTotsqm(String totsqm) {
			this.totsqm = totsqm;
		}
		...
		private String url;
		private String curqry; 
	 
	 
	 public String getLbltotsize() {
			return lbltotsize;
		}
		public void setLbltotsize(String lbltotsize) {
			this.lbltotsize = lbltotsize;
		}
	...
	public String getCurqry() {
			return curqry;
		}
		public void setCurqry(String curqry) {
			this.curqry = curqry;
		}
	...
	public String saveAction () throws IOException,SQLException,NullPointerException
	 {
		...
		ClsOutSourceJobDAO ClsCuttingOrderDAO=new ClsOutSourceJobDAO();
		 ClsOutSourceJobBean ClsCuttingOrderBean= new ClsOutSourceJobBean();
		 if(mode.equalsIgnoreCase("A"))
		 {
            ...
            System.out.println("insert======"+masterdate+"::"+deldate+"::"+getDeliveryTime()+"::"+fixdate+"::"+getItemtype()+"::"+getCosttr_no()+"::"+getSalid()+"::"+
					getAcno()+"::"+getLpono()+"::"+getRemarks()+"::"+session+"::"+request+"::"+getFormdetailcode()+"::"+getMode()+"::"+getCurrsid()+"::"+getRatess());
			int val=ClsCuttingOrderDAO.insert(descarray,masterdate,deldate,getDeliveryTime(),fixdate,getItemtype(),getCosttr_no(),getSalid(),
					getAcno(),getLpono(),getRemarks(),session,request,getFormdetailcode(),getMode(),getCurrsid(),getRatess());
		 ...
		 else if(mode.equalsIgnoreCase("E"))
		 {
			...
			int val=ClsCuttingOrderDAO.update(descarray,masterdate,deldate,getDeliveryTime(),fixdate,getItemtype(),getCosttr_no(),getSalid(),
		 ...
		 else if(mode.equalsIgnoreCase("D"))
		 {
			...
			int val=ClsCuttingOrderDAO.delete(descarray,masterdate,deldate,getDeliveryTime(),fixdate,getItemtype(),getCosttr_no(),getSalid(),
					getAcno(),getLpono(),getRemarks(),session,request,getFormdetailcode(),getMode(),getCurrsid(),getRatess(),getMasterdoc_no());
		 ...
		 else if(mode.equalsIgnoreCase("view"))
		 {
			 ...
			 HttpServletRequest request=ServletActionContext.getRequest();
				HttpSession session=request.getSession();
				ClsOutSourceJobBean setbean=new ClsOutSourceJobBean();
				setbean=ClsCuttingOrderDAO.getviewDetails(session,getDocno());
				...
				setTotsqm(setbean.getTotsqm());
				setTotqty(setbean.getTotqty());
	...
	public String printAction() throws ParseException, SQLException{
		...
		ClsOutSourceJobBean pintbean=new ClsOutSourceJobBean();
		ClsOutSourceJobDAO ClsCuttingOrderDAO=new ClsOutSourceJobDAO();
		 pintbean=ClsCuttingOrderDAO.getPrint(doc,request);
	  
		 
		
		 
		 	setLogo(logo);
		    setLblprintname("Cutting Order");
    	   ...
    	   setLblSalseman(pintbean.getLblSalseman()); 
	        	  ...
	        	  // System.out.println("iside jrxml");
	        	   ...
	        	   try {
	        		   ...
	        		   param.put("remarks", pintbean.getLblRemarks());
	        		   param.put("project", pintbean.getLblProject());
	        		   param.put("curno", pintbean.getLblOrderNO());
	        		   param.put("curdate", pintbean.getLblDate());
	        		   param.put("pono", pintbean.getLblPoNo());
	        		   param.put("salesman", pintbean.getLblSalseman());
	        		   param.put("deldate", pintbean.getLblDeliveryDate());	        		   
	        		   param.put("totalsize", pintbean.getLbltotsize());
	        		   param.put("totqty", pintbean.getLbltotqty());
	        		   param.put("preparedby", session.getAttribute("USERNAME"));
	        		   
	        		   //param.put("complogo", pintbean.getLblcompname());
	        		   
	        		   JasperDesign design = JRXmlLoader.load(request.getSession().getServletContext().getRealPath("com/nisales/outsourcejob/outSourceJob.jrxml"));	      	     	 
