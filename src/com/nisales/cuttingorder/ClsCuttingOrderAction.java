package com.nisales.cuttingorder;
...
public class ClsCuttingOrderAction {
...
//	
	...
	public String saveAction () throws IOException,SQLException,NullPointerException
	 {
		ClsCommon ClsCommon=new ClsCommon();
		 ...
		 ClsCuttingOrderBean ClsCuttingOrderBean= new ClsCuttingOrderBean();
		 ...
		 else if(mode.equalsIgnoreCase("view"))
		 {
			 ...
			 HttpServletRequest request=ServletActionContext.getRequest();
				HttpSession session=request.getSession();
				ClsCuttingOrderBean setbean=new ClsCuttingOrderBean();
	...
	public String printAction() throws ParseException, SQLException{
		...
		ClsCuttingOrderBean pintbean=new ClsCuttingOrderBean();
		ClsCuttingOrderDAO ClsCuttingOrderDAO=new ClsCuttingOrderDAO();
    	   ...
    	   setLblSalseman(pintbean.getLblSalseman()); 
	        	  ...
	        	  // System.out.println("iside jrxml");
	        	   ...
	        	   try {
	        		   ...
	        		   JasperDesign design = JRXmlLoader.load(request.getSession().getServletContext().getRealPath("com/nisales/cuttingorder/cuttingOrder.jrxml"));	      	     	 
