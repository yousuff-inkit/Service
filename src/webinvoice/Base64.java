...
public class Base64 {
    ...
    public  String encodeToString(final byte[] input, final int flags) {
        try {
    ...
    public  String encodeToString(final byte[] input, final int offset, final int len, final int flags) {
        try {
